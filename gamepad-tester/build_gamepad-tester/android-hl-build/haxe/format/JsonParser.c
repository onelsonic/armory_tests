...
extern String $s_Invalid_escape_sequence_;
...
extern String $s_Unclosed_string;
String StringBuf_toString(StringBuf);
extern String $s_Invalid_char_;
extern String $s_Invalid_number_at_position_;
...
String haxe_format_JsonParser_parseString(haxe__format__JsonParser r0) {
	...
	r13 = (StringBuf)hl_alloc_obj(&$t_StringBuf);
	StringBuf_new(r13);
	r3 = r13;
	label$36f55b1_4_25:
	...
	switch(r7) {
		...
		case 113:
		case 115:
			r9 = (String)$s_Invalid_escape_sequence_;
			r17 = String_fromCharCode(r7);
			r9 = String___add__(r9,r17);
			r17 = (String)$s__at_position_;
			r9 = String___add__(r9,r17);
			r12 = r0->pos;
			r14 = 1;
			r12 = r12 - r14;
...
void haxe_format_JsonParser_invalidNumber(haxe__format__JsonParser r0,int r1) {
	...
	vbyte *r5;
	int r3, r7;
	r2 = (String)$s_Invalid_number_at_position_;
	r3 = r1;
	r4 = &r3;
	r5 = hl_itos(r3,r4);
