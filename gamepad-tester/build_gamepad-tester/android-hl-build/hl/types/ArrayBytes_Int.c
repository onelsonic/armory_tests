...
hl__types__ArrayBytes_Int hl_types_ArrayBytes_Int_concat(hl__types__ArrayBytes_Int r0,hl__types__ArrayBytes_Int r1) {
	...
	r2 = (hl__types__ArrayBytes_Int)hl_alloc_obj(&$t_hl_types_ArrayBytes_Int);
...
void hl_types_ArrayBytes_Int_blit(hl__types__ArrayBytes_Int r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r5 = (hl__types__ArrayBytes_Int)hl_dyn_castp(&r2,&$t_hl_types_ArrayAccess,&$t_hl_types_ArrayBytes_Int);
	r8 = 0;
...
hl__types__ArrayBase hl_types_ArrayBytes_Int_slice(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	r8 = (hl__types__ArrayBytes_Int)hl_alloc_obj(&$t_hl_types_ArrayBytes_Int);
...
void hl_types_ArrayBytes_Int_sort(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	...
	label$d0a53a9_11_14:
	r8 = hl_alloc_closure_ptr(&$t_fun_0223e89,hl_types_ArrayBytes_Int_sort__$1,r1);
	label$d0a53a9_11_15:
...
hl__types__ArrayBase hl_types_ArrayBytes_Int_splice(hl__types__ArrayBytes_Int r0,int r1,int r2) {
	...
	r6 = (hl__types__ArrayBytes_Int)hl_alloc_obj(&$t_hl_types_ArrayBytes_Int);
...
bool hl_types_ArrayBytes_Int_remove(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r6 = 0;
	if( r2 >= r6 ) goto label$d0a53a9_16_6;
	r7 = false;
	return r7;
	label$d0a53a9_16_6:
	r5 = r0->length;
...
int hl_types_ArrayBytes_Int_indexOf(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	if( r2 ) goto label$d0a53a9_17_3;
	r3 = 0;
	goto label$d0a53a9_17_4;
	label$d0a53a9_17_3:
	r3 = r2 ? r2->v.i : 0;
	label$d0a53a9_17_4:
	r5 = 0;
	if( r3 >= r5 ) goto label$d0a53a9_17_13;
	r5 = r0->length;
	r4 = r3 + r5;
	r3 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_17_13;
	r4 = 0;
	r3 = r4;
	label$d0a53a9_17_13:
	r4 = r3;
	r5 = r0->length;
	label$d0a53a9_17_15:
	if( r4 >= r5 ) goto label$d0a53a9_17_26;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 2;
	r9 = r6 << r9;
	r7 = *(int*)(r8 + r9);
	if( r7 != r1 ) goto label$d0a53a9_17_25;
	return r6;
	label$d0a53a9_17_25:
...
int hl_types_ArrayBytes_Int_lastIndexOf(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	int r3, r4, r5, r6;
	r3 = r0->length;
	if( !r2 ) goto label$d0a53a9_18_4;
	r4 = r2 ? r2->v.i : 0;
	goto label$d0a53a9_18_6;
	label$d0a53a9_18_4:
	r5 = 1;
	r4 = r3 - r5;
	label$d0a53a9_18_6:
	if( r4 < r3 ) goto label$d0a53a9_18_11;
	r6 = 1;
	r5 = r3 - r6;
	r4 = r5;
	...
	label$d0a53a9_18_11:
	r6 = 0;
	if( r4 >= r6 ) goto label$d0a53a9_18_15;
	r5 = r4 + r3;
	r4 = r5;
	label$d0a53a9_18_15:
	r6 = 0;
	if( r4 < r6 ) goto label$d0a53a9_18_26;
	r7 = r0->bytes;
	r6 = 2;
	r6 = r4 << r6;
	r5 = *(int*)(r7 + r6);
	if( r5 != r1 ) goto label$d0a53a9_18_24;
	return r4;
	label$d0a53a9_18_24:
	--r4;
	goto label$d0a53a9_18_15;
...
hl__types__ArrayBytes_Int hl_types_ArrayBytes_Int_copy(hl__types__ArrayBytes_Int r0) {
	...
	int r3, r6, r10, r11;
	r1 = (hl__types__ArrayBytes_Int)hl_alloc_obj(&$t_hl_types_ArrayBytes_Int);
...
vvirtual* hl_types_ArrayBytes_Int_iterator(hl__types__ArrayBytes_Int r0) {
	vvirtual *r3;
	hl__types__BytesIterator_Int r1;
	r1 = (hl__types__BytesIterator_Int)hl_alloc_obj(&$t_hl_types_BytesIterator_Int);
	hl_types_BytesIterator_Int_new(r1,r0);
	r3 = hl_to_virtual(&$t_vrt_738d39e,(vdynamic*)r1);
	return r3;
}
...
vdynamic* hl_types_ArrayBytes_Int_getDyn(hl__types__ArrayBytes_Int r0,int r1) {
	...
	int r3, r4;
	r4 = r0->length;
	if( r1 >= r4 ) goto label$d0a53a9_24_4;
	r2 = false;
	goto label$d0a53a9_24_5;
	label$d0a53a9_24_4:
	r2 = true;
	label$d0a53a9_24_5:
	if( !r2 ) goto label$d0a53a9_24_10;
	r5 = r0->bytes;
	r3 = 0;
...
void hl_types_ArrayBytes_Int_setDyn(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	int r5, r6, r8;
	r6 = r0->length;
	if( r1 >= r6 ) goto label$d0a53a9_25_4;
	r4 = false;
	goto label$d0a53a9_25_5;
	label$d0a53a9_25_4:
	r4 = true;
	label$d0a53a9_25_5:
	if( !r4 ) goto label$d0a53a9_25_7;
	hl_types_ArrayBytes_Int___expand(r0,r1);
	label$d0a53a9_25_7:
	r7 = r0->bytes;
	r5 = (int)hl_dyn_casti(&r2,&$t_dyn,&$t_i32);
	r8 = 2;
	r8 = r1 << r8;
	*(int*)(r7 + r8) = r5;
	return;
...
int hl_types_ArrayBytes_Int_pushDyn(hl__types__ArrayBytes_Int r0,vdynamic* r1) {
	int r2;
	r2 = (int)hl_dyn_casti(&r1,&$t_dyn,&$t_i32);
...
void hl_types_ArrayBytes_Int_unshiftDyn(hl__types__ArrayBytes_Int r0,vdynamic* r1) {
	int r3;
	r3 = (int)hl_dyn_casti(&r1,&$t_dyn,&$t_i32);
...
void hl_types_ArrayBytes_Int_insertDyn(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	int r4;
	r4 = (int)hl_dyn_casti(&r2,&$t_dyn,&$t_i32);
...
void hl_types_ArrayBytes_Int_sortDyn(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	vclosure *r3;
	if( r1 ) goto label$d0a53a9_32_3;
	r3 = NULL;
	goto label$d0a53a9_32_4;
	label$d0a53a9_32_3:
	r3 = hl_alloc_closure_ptr(&$t_fun_3a8cb27,hl_types_ArrayBytes_Int_sortDyn__$1,r1);
	label$d0a53a9_32_4:
...
void hl_types_ArrayBytes_Int___expand(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$d0a53a9_33_9;
	...
	r3 = r1 + r4;
	r9 = r0->size;
	if( r9 >= r3 ) goto label$d0a53a9_33_40;
	r4 = r0->size;
	r9 = 3;
	r4 = r4 * r9;
	r9 = 1;
	r4 = r4 >> r9;
	if( r4 >= r3 ) goto label$d0a53a9_33_20;
	r4 = r3;
	label$d0a53a9_33_20:
	r7 = r0->bytes;
	r10 = 2;
