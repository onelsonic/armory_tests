...
hl__types__ArrayBytes_Float hl_types_ArrayBytes_Float_concat(hl__types__ArrayBytes_Float r0,hl__types__ArrayBytes_Float r1) {
	...
	r2 = (hl__types__ArrayBytes_Float)hl_alloc_obj(&$t_hl_types_ArrayBytes_Float);
...
void hl_types_ArrayBytes_Float_blit(hl__types__ArrayBytes_Float r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r5 = (hl__types__ArrayBytes_Float)hl_dyn_castp(&r2,&$t_hl_types_ArrayAccess,&$t_hl_types_ArrayBytes_Float);
	r8 = 0;
...
hl__types__ArrayBase hl_types_ArrayBytes_Float_slice(hl__types__ArrayBytes_Float r0,int r1,vdynamic* r2) {
	...
	r8 = (hl__types__ArrayBytes_Float)hl_alloc_obj(&$t_hl_types_ArrayBytes_Float);
...
void hl_types_ArrayBytes_Float_sort(hl__types__ArrayBytes_Float r0,vclosure* r1) {
	...
	label$d05ef5b_11_9:
	r8 = hl_alloc_closure_ptr(&$t_fun_026a163,hl_types_ArrayBytes_Float_sort__$1,r1);
	label$d05ef5b_11_10:
...
hl__types__ArrayBase hl_types_ArrayBytes_Float_splice(hl__types__ArrayBytes_Float r0,int r1,int r2) {
	...
	r6 = (hl__types__ArrayBytes_Float)hl_alloc_obj(&$t_hl_types_ArrayBytes_Float);
...
hl__types__ArrayBytes_Float hl_types_ArrayBytes_Float_copy(hl__types__ArrayBytes_Float r0) {
	...
	int r3, r6, r10, r11;
	r1 = (hl__types__ArrayBytes_Float)hl_alloc_obj(&$t_hl_types_ArrayBytes_Float);
...
vvirtual* hl_types_ArrayBytes_Float_iterator(hl__types__ArrayBytes_Float r0) {
	hl__types__BytesIterator_Float r1;
	vvirtual *r3;
	r1 = (hl__types__BytesIterator_Float)hl_alloc_obj(&$t_hl_types_BytesIterator_Float);
	hl_types_BytesIterator_Float_new(r1,r0);
	r3 = hl_to_virtual(&$t_vrt_a31fa59,(vdynamic*)r1);
	return r3;
}
...
vdynamic* hl_types_ArrayBytes_Float_getDyn(hl__types__ArrayBytes_Float r0,int r1) {
	...
	int r3;
	r3 = r0->length;
	if( r1 >= r3 ) goto label$d05ef5b_24_4;
	r2 = false;
	goto label$d05ef5b_24_5;
	label$d05ef5b_24_4:
	r2 = true;
	label$d05ef5b_24_5:
	if( !r2 ) goto label$d05ef5b_24_10;
	r4 = r0->bytes;
	r5 = 0.;
	r6 = hl_alloc_dynamic(&$t_f64);
	r6->v.d = r5;
	return r6;
	label$d05ef5b_24_10:
	r4 = r0->bytes;
...
void hl_types_ArrayBytes_Float_setDyn(hl__types__ArrayBytes_Float r0,int r1,vdynamic* r2) {
	...
	int r5;
	r5 = r0->length;
	if( r1 >= r5 ) goto label$d05ef5b_25_4;
	r4 = false;
	goto label$d05ef5b_25_5;
	label$d05ef5b_25_4:
	r4 = true;
	label$d05ef5b_25_5:
	if( !r4 ) goto label$d05ef5b_25_7;
	hl_types_ArrayBytes_Float___expand(r0,r1);
	label$d05ef5b_25_7:
	r6 = r0->bytes;
	r7 = (double)hl_dyn_castd(&r2,&$t_dyn);
	r5 = 3;
	r5 = r1 << r5;
	*(double*)(r6 + r5) = r7;
	return;
...
int hl_types_ArrayBytes_Float_pushDyn(hl__types__ArrayBytes_Float r0,vdynamic* r1) {
	double r3;
	int r2;
	r3 = (double)hl_dyn_castd(&r1,&$t_dyn);
...
void hl_types_ArrayBytes_Float_insertDyn(hl__types__ArrayBytes_Float r0,int r1,vdynamic* r2) {
	double r4;
	r4 = (double)hl_dyn_castd(&r2,&$t_dyn);
...
void hl_types_ArrayBytes_Float_sortDyn(hl__types__ArrayBytes_Float r0,vclosure* r1) {
	vclosure *r3;
	if( r1 ) goto label$d05ef5b_32_3;
	r3 = NULL;
	goto label$d05ef5b_32_4;
	label$d05ef5b_32_3:
	r3 = hl_alloc_closure_ptr(&$t_fun_cae6940,hl_types_ArrayBytes_Float_sortDyn__$1,r1);
	label$d05ef5b_32_4:
...
void hl_types_ArrayBytes_Float___expand(hl__types__ArrayBytes_Float r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$d05ef5b_33_9;
	...
	r3 = r1 + r4;
	r9 = r0->size;
	if( r9 >= r3 ) goto label$d05ef5b_33_40;
	r4 = r0->size;
	r9 = 3;
	r4 = r4 * r9;
	r9 = 1;
	r4 = r4 >> r9;
	if( r4 >= r3 ) goto label$d05ef5b_33_20;
	r4 = r3;
	label$d05ef5b_33_20:
	r7 = r0->bytes;
	r10 = 3;
