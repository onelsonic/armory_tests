...
vvirtual* hl_types_ArrayDyn_iterator(hl__types__ArrayDyn r0) {
	...
	r1 = (hl__types__ArrayDynIterator)hl_alloc_obj(&$t_hl_types_ArrayDynIterator);
	r2 = r0->array;
	hl_types_ArrayDynIterator_new(r1,r2);
	r4 = hl_to_virtual(&$t_vrt_ef76930,(vdynamic*)r1);
	return r4;
}
...
vdynamic* hl_types_ArrayDyn___cast(hl__types__ArrayDyn r0,hl_type* r1) {
	...
	r11 = (int)hl_dyn_casti(&r4,&$t_dyn,&$t_i32);
	r13 = 2;
	r13 = r10 << r13;
	*(int*)(r6 + r13) = r11;
	...
	return ((vdynamic*)r14);
	label$a6944e8_28_43:
	r3 = &$t_hl_types_ArrayBytes_Float;
	...
	if( r2 == NULL ) hl_null_access();
	r4 = ((vdynamic* (*)(hl__types__ArrayBase,int))r2->$type->vobj_proto[0])(r2,r10);
	r15 = (double)hl_dyn_castd(&r4,&$t_dyn);
	r12 = 3;
	r12 = r10 << r12;
	*(double*)(r6 + r12) = r15;
...
hl__types__ArrayDyn hl_types_ArrayDyn_alloc(hl__types__ArrayBase r0,bool* r1) {
	...
	r2 = *r1;
	label$a6944e8_30_4:
	r3 = (hl__types__ArrayDyn)hl_alloc_obj(&$t_hl_types_ArrayDyn);
	r3->array = r0;
