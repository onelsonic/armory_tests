...
void kha_KravurImage_new(kha__KravurImage r0,int r1,int r2,int r3,int r4,int r5,int r6,hl__types__ArrayObj r7,kha__internal__BytesBlob r8) {
	...
	r12 = r7->length;
	if( r9 >= r12 ) goto label$5871e49_1_26;
	r12 = r7->length;
	if( ((unsigned)r9) < ((unsigned)r12) ) goto label$5871e49_1_16;
	r13 = NULL;
	goto label$5871e49_1_19;
	label$5871e49_1_16:
	r15 = r7->array;
	r14 = ((vdynamic**)(r15 + 1))[r9];
	r13 = (kha__graphics2__truetype__Stbtt_bakedchar)r14;
	label$5871e49_1_19:
	++r9;
	...
	r18 = kha_internal_BytesBlob_toBytes(r8);
	r12 = 1;
	r19 = hl_alloc_dynamic(&$t_i32);
	r19->v.i = r12;
	r20 = NULL;
	r17 = kha_Image_fromBytes(r18,r5,r6,r19,r20);
	r0->texture = r17;
	return;
}
...
double kha_KravurImage_getCharWidth(kha__KravurImage r0,int r1) {
	...
	return r5;
	label$5871e49_4_7:
	r8 = (kha__$KravurImage)$g__kha_KravurImage;
	r7 = r8->charBlocks;
	if( r7 == NULL ) hl_null_access();
	r2 = 0;
	r4 = r7->length;
