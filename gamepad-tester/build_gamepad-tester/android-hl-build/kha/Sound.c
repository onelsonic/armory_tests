...
void kha_Sound_uncompress(kha__Sound r0,vclosure* r1) {
	...
	return;
	label$f74786f_1_5:
	r4 = (haxe__io__BytesOutput)hl_alloc_obj(&$t_haxe_io_BytesOutput);
	...
	r12 = (double)r10;
	r15 = (kha__audio2__$Audio)$g__kha_audio2_Audio;
	...
	r14 = 2;
	r13 = r10 * r14;
	r3 = (kha__arrays__Float32ArrayPrivate)hl_alloc_obj(&$t_kha_arrays_Float32ArrayPrivate);
