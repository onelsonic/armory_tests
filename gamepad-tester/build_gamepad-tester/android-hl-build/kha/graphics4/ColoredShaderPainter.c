...
kha__graphics4__PipelineCache kha_graphics4_ColoredShaderPainter_set_pipeline(kha__graphics4__ColoredShaderPainter r0,kha__graphics4__PipelineCache r1) {
...
void kha_graphics4_ColoredShaderPainter_initBuffers(kha__graphics4__ColoredShaderPainter r0) {
	...
	if( r2 ) goto label$e7917a1_4_177;
	...
	label$e7917a1_4_33:
	r14 = 1000;
	if( r4 >= r14 ) goto label$e7917a1_4_106;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
	...
	label$e7917a1_4_140:
	r14 = 1000;
	if( r4 >= r14 ) goto label$e7917a1_4_173;
	r6 = r4;
	++r4;
	r15 = 3;
	r14 = r6 * r15;
...
void kha_graphics4_ColoredShaderPainter_drawBuffer(kha__graphics4__ColoredShaderPainter r0,bool r1) {
	...
	r5 = (kha__graphics4__$ColoredShaderPainter)$g_59e5fb3;
	r10 = r5->indexBuffer;
	if( hl_vfields(r9)[12] ) ((void (*)(vdynamic*,kha__graphics4__IndexBuffer))hl_vfields(r9)[12])(r9->value,r10); else {
		void *args[] = {r10};
	...
	if( r12 == NULL ) hl_null_access();
	r11 = r12->pipeline;
	if( hl_vfields(r9)[8] ) ((void (*)(vdynamic*,kha__graphics4__PipelineState))hl_vfields(r9)[8])(r9->value,r11); else {
		void *args[] = {r11};
	...
	if( hl_vfields(r9)[10] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r9)[10])(r9->value,r13,r14); else {
		void *args[] = {r13,r14};
	...
	r6 = r6 * r16;
	r17 = &r6;
	if( hl_vfields(r9)[27] ) ((void (*)(vdynamic*,int*,int*))hl_vfields(r9)[27])(r9->value,r15,r17); else {
		void *args[] = {r15,r17};
...
void kha_graphics4_ColoredShaderPainter_fillTriangle(kha__graphics4__ColoredShaderPainter r0,float r1,int r2,double r3,double r4,double r5,double r6,double r7,double r8) {
	...
	bool r13;
	int r10, r12;
	r11 = (kha__graphics4__$ColoredShaderPainter)$g_59e5fb3;
	r10 = r11->bufferIndex;
	r12 = 0;
