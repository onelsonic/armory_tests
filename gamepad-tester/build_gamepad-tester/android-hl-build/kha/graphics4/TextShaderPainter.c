...
kha__graphics4__PipelineCache kha_graphics4_TextShaderPainter_set_pipeline(kha__graphics4__TextShaderPainter r0,kha__graphics4__PipelineCache r1) {
	...
	label$cb73abe_1_3:
	r3 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
...
void kha_graphics4_TextShaderPainter_initShaders() {
	...
	r2 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r1 = r2->structure;
...
void kha_graphics4_TextShaderPainter_initBuffers(kha__graphics4__TextShaderPainter r0) {
	...
	if( r2 ) goto label$cb73abe_4_110;
	...
	label$cb73abe_4_33:
	r14 = 1000;
	if( r4 >= r14 ) goto label$cb73abe_4_106;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
...
void kha_graphics4_TextShaderPainter_setRectVertices(kha__graphics4__TextShaderPainter r0,double r1,double r2,double r3,double r4,double r5,double r6,double r7,double r8) {
	...
	vbyte *r13;
	int r9, r11, r17;
	r10 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r9 = r10->bufferIndex;
	r11 = 9;
	r9 = r9 * r11;
	r11 = 4;
...
void kha_graphics4_TextShaderPainter_setRectTexCoords(kha__graphics4__TextShaderPainter r0,double r1,double r2,double r3,double r4) {
	...
	vbyte *r9;
	int r5, r7, r11;
	r6 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r5 = r6->bufferIndex;
	r7 = 9;
	r5 = r5 * r7;
	r7 = 4;
...
void kha_graphics4_TextShaderPainter_setRectColors(kha__graphics4__TextShaderPainter r0,float r1,int r2) {
	...
	vbyte *r12;
	int r3, r5, r9;
	r4 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r3 = r4->bufferIndex;
	r5 = 9;
	r3 = r3 * r5;
	r5 = 4;
...
void kha_graphics4_TextShaderPainter_drawBuffer(kha__graphics4__TextShaderPainter r0) {
	...
	r3 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r8 = r3->indexBuffer;
	if( hl_vfields(r7)[12] ) ((void (*)(vdynamic*,kha__graphics4__IndexBuffer))hl_vfields(r7)[12])(r7->value,r8); else {
		void *args[] = {r8};
	...
	if( r10 == NULL ) hl_null_access();
	r9 = r10->pipeline;
	if( hl_vfields(r7)[8] ) ((void (*)(vdynamic*,kha__graphics4__PipelineState))hl_vfields(r7)[8])(r7->value,r9); else {
		void *args[] = {r9};
	...
	r3 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r12 = r3->lastTexture;
	if( hl_vfields(r7)[7] ) ((void (*)(vdynamic*,vvirtual*,kha__Image))hl_vfields(r7)[7])(r7->value,r11,r12); else {
		void *args[] = {r11,r12};
	...
	r13 = r0->projectionMatrix;
	if( hl_vfields(r7)[10] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r7)[10])(r7->value,r11,r13); else {
		void *args[] = {r11,r13};
	...
	r5 = 2;
	r15 = r0->bilinear;
	if( !r15 ) goto label$cb73abe_8_51;
	r14 = 1;
	goto label$cb73abe_8_52;
	label$cb73abe_8_51:
	r14 = 0;
	label$cb73abe_8_52:
	r15 = r0->bilinear;
	if( !r15 ) goto label$cb73abe_8_56;
	r16 = 1;
	goto label$cb73abe_8_57;
	label$cb73abe_8_56:
	r16 = 0;
	label$cb73abe_8_57:
	r17 = 0;
	if( hl_vfields(r7)[3] ) ((void (*)(vdynamic*,vvirtual*,int,int,int,int,int))hl_vfields(r7)[3])(r7->value,r11,r4,r5,r14,r16,r17); else {
		void *args[] = {r11,&r4,&r5,&r14,&r16,&r17};
	...
	r5 = r5 * r14;
	r19 = &r5;
	if( hl_vfields(r7)[27] ) ((void (*)(vdynamic*,int*,int*))hl_vfields(r7)[27])(r7->value,r18,r19); else {
		void *args[] = {r18,r19};
...
int kha_graphics4_TextShaderPainter_findIndex(int r0) {
	...
	r2 = (kha__graphics2__$Graphics)$g__kha_graphics2_Graphics;
	r1 = r2->fontGlyphs;
	r4 = (kha__$KravurImage)$g__kha_KravurImage;
	r3 = r4->charBlocks;
	r5 = 0;
	r6 = 0;
	...
	r8 = (int)r7;
	label$cb73abe_10_12:
	if( r6 >= r8 ) goto label$cb73abe_10_50;
	r10 = r6;
	++r6;
	if( r3 == NULL ) hl_null_access();
	r12 = 2;
	r11 = r10 * r12;
	r12 = r3->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$cb73abe_10_23;
	r11 = 0;
	goto label$cb73abe_10_27;
	label$cb73abe_10_23:
	r13 = r3->bytes;
	r12 = 2;
	r12 = r11 << r12;
	...
	r12 = r12 + r14;
	r14 = r3->length;
	if( ((unsigned)r12) < ((unsigned)r14) ) goto label$cb73abe_10_35;
	r12 = 0;
	goto label$cb73abe_10_39;
	label$cb73abe_10_35:
	r13 = r3->bytes;
	r14 = 2;
	r14 = r12 << r14;
	r12 = *(int*)(r13 + r14);
	label$cb73abe_10_39:
	if( r0 < r11 ) goto label$cb73abe_10_44;
	if( r12 < r0 ) goto label$cb73abe_10_44;
	r14 = r5 + r0;
	r14 = r14 - r11;
	return r14;
	label$cb73abe_10_44:
...
void kha_graphics4_TextShaderPainter_drawString(kha__graphics4__TextShaderPainter r0,String r1,float r2,int r3,double r4,double r5,kha__math__FastMatrix3 r6) {
	...
	r13 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r12 = r13->lastTexture;
	if( !r12 ) goto label$cb73abe_11_13;
	r13 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r14 = r13->lastTexture;
	if( r11 == r14 ) goto label$cb73abe_11_13;
	...
	r17 = r1->length;
	label$cb73abe_11_20:
	if( r9 >= r17 ) goto label$cb73abe_11_223;
	r18 = r9;
	++r9;
	if( r1 == NULL ) hl_null_access();
	r20 = r1->bytes;
	...
	if( !r22 ) goto label$cb73abe_11_222;
	r13 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r21 = r13->bufferIndex;
	r25 = 1;
	r21 = r21 + r25;
	r25 = 1000;
	if( r21 < r25 ) goto label$cb73abe_11_41;
	kha_graphics4_TextShaderPainter_drawBuffer(r0);
	label$cb73abe_11_41:
	...
	++r21;
	r13->bufferIndex = r21;
	label$cb73abe_11_222:
	goto label$cb73abe_11_20;
	label$cb73abe_11_223:
	return;
}
...
void kha_graphics4_TextShaderPainter_end(kha__graphics4__TextShaderPainter r0) {
	...
	r2 = r3->bufferIndex;
	r4 = 0;
	if( r4 >= r2 ) goto label$cb73abe_12_5;
	kha_graphics4_TextShaderPainter_drawBuffer(r0);
	label$cb73abe_12_5:
	r5 = NULL;
	r3 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
...
void kha_graphics4_TextShaderPainter_new(kha__graphics4__TextShaderPainter r0,vvirtual* r1) {
	...
	kha__AlignedQuad r2;
	bool r4;
	kha__graphics4__PipelineCache r5;
	int r6;
	r2 = (kha__AlignedQuad)hl_alloc_obj(&$t_kha_AlignedQuad);
	...
	r0->g = r1;
	r6 = 0;
	r7 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r7->bufferIndex = r6;
