...
kha__Image kha_Image_fromBytes(haxe__io__Bytes r0,int r1,int r2,vdynamic* r3,vdynamic* r4) {
	...
	r8 = r3 ? r3->v.i : 0;
	r7->format = r8;
	r9 = (haxe__io__BytesDataImpl)hl_alloc_obj(&$t_haxe_io_BytesDataImpl);
...
kha__Image kha_Image_create2(int r0,int r1,int r2,bool r3,bool r4,int r5,int r6) {
	...
	goto label$2991a06_13_15;
	label$2991a06_13_9:
	r10 = 0;
	if( r2 != r10 ) goto label$2991a06_13_13;
	r9 = 0;
...
kha__Image kha_Image_fromFile(String r0,bool r1) {
	...
	if( !r3 ) goto label$2991a06_18_7;
	r6 = 2;
	goto label$2991a06_18_8;
	label$2991a06_18_7:
	r6 = 0;
	label$2991a06_18_8:
	r2->format = r6;
...
kha__graphics2__Graphics kha_Image_get_g2(kha__Image r0) {
	...
	r2 = r0->graphics2;
	if( r2 ) goto label$2991a06_20_9;
	r3 = (kha__korehl__graphics4__Graphics2)hl_alloc_obj(&$t_kha_korehl_graphics4_Graphics2);
	r4 = r0->$_f14;
	if( r4 ) goto label$2991a06_20_7;
	r4 = hl_to_virtual(&$t_vrt_8a7100d,(vdynamic*)r0);
	r0->$_f14 = r4;
	label$2991a06_20_7:
...
vvirtual* kha_Image_get_g4(kha__Image r0) {
	...
	r2 = r0->graphics4;
	if( r2 ) goto label$2991a06_21_16;
	r3 = (kha__korehl__graphics4__Graphics)hl_alloc_obj(&$t_kha_korehl_graphics4_Graphics);
	r4 = r0->$_f14;
	if( r4 ) goto label$2991a06_21_7;
	r4 = hl_to_virtual(&$t_vrt_8a7100d,(vdynamic*)r0);
	r0->$_f14 = r4;
	label$2991a06_21_7:
	kha_korehl_graphics4_Graphics_new(r3,r4);
	if( r3 ) goto label$2991a06_21_11;
	r2 = NULL;
	goto label$2991a06_21_15;
	label$2991a06_21_11:
	r2 = r3->$_f1;
	if( r2 ) goto label$2991a06_21_15;
	r2 = hl_to_virtual(&$t_vrt_1288791,(vdynamic*)r3);
	r3->$_f1 = r2;
	label$2991a06_21_15:
	r0->graphics4 = r2;
	label$2991a06_21_16:
...
void kha_Image_generateMipmaps(kha__Image r0,int r1) {
	vbyte *r3;
	r3 = r0->_texture;
	if( !r3 ) goto label$2991a06_29_5;
	r3 = r0->_texture;
	hl_kore_generate_mipmaps_texture(r3,r1);
	goto label$2991a06_29_7;
	label$2991a06_29_5:
	r3 = r0->_renderTarget;
...
void kha_Image_setMipmaps(kha__Image r0,hl__types__ArrayObj r1) {
	...
	r4 = r1->length;
	label$2991a06_30_3:
	if( r2 >= r4 ) goto label$2991a06_30_22;
	r5 = r2;
	++r2;
	if( r1 == NULL ) hl_null_access();
	r7 = r1->length;
	if( ((unsigned)r5) < ((unsigned)r7) ) goto label$2991a06_30_12;
	r8 = NULL;
	goto label$2991a06_30_15;
	label$2991a06_30_12:
	r10 = r1->array;
