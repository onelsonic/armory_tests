...
void kha_input_Pen_notifyWindowed(kha__input__Pen r0,int r1,vclosure* r2,vclosure* r3,vclosure* r4) {
	...
	r6 = (hl__types__ArrayObj)hl_dyn_castp(&r12,&$t_dyn,&$t_hl_types_ArrayObj);
	label$5e97cd2_3_30:
	if( r6 == NULL ) hl_null_access();
...
void kha_input_Pen_new(kha__input__Pen r0) {
	kha__input__$Pen r1;
	r1 = (kha__input__$Pen)$g__kha_input_Pen;
	r1->instance = r0;
	return;
}
