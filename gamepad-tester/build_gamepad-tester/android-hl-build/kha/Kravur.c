...
kha__KravurImage kha_Kravur__get(kha__Kravur r0,int r1) {
	...
	vdynamic *r22;
	varray *r19;
	int r8, r9, r10, r13, r14, r15, r24, r25, r26;
	vbyte *r7, *r11;
	r3 = (kha__graphics2__$Graphics)$g__kha_graphics2_Graphics;
	r2 = r3->fontGlyphs;
	r6 = r0->oldGlyphs;
	...
	*(int*)(r7 + r10) = r9;
	...
	r12 = (kha__$KravurImage)$g__kha_KravurImage;
	r12->charBlocks = r5;
	r12 = (kha__$KravurImage)$g__kha_KravurImage;
	r5 = r12->charBlocks;
	...
	if( r16 ) goto label$6c4203c_1_207;
	r9 = 64;
	r10 = 32;
	r13 = r2->length;
	r20 = &$t_kha_graphics2_truetype_Stbtt_bakedchar;
	r14 = 0;
	r19 = hl_alloc_array(r20,r14);
	r18 = hl_types_ArrayObj_alloc(r19);
	r15 = 0;
	if( r15 >= r13 ) goto label$6c4203c_1_140;
	if( r18 == NULL ) hl_null_access();
	r15 = 1;
	r14 = r13 - r15;
	r22 = NULL;
	r23 = (kha__graphics2__truetype__Stbtt_bakedchar)hl_dyn_castp(&r22,&$t_dyn,&$t_kha_graphics2_truetype_Stbtt_bakedchar);
	r15 = r18->length;
	if( ((unsigned)r14) < ((unsigned)r15) ) goto label$6c4203c_1_138;
	...
	r15 = r18->length;
	label$6c4203c_1_144:
	if( r14 >= r15 ) goto label$6c4203c_1_157;
	r24 = r14;
	++r14;
	if( r21 == NULL ) hl_null_access();
	r23 = (kha__graphics2__truetype__Stbtt_bakedchar)hl_alloc_obj(&$t_kha_graphics2_truetype_Stbtt_bakedchar);
	kha_graphics2_truetype_Stbtt_bakedchar_new(r23);
	r26 = r21->length;
	if( ((unsigned)r24) < ((unsigned)r26) ) goto label$6c4203c_1_154;
	hl_types_ArrayObj___expand(r21,r24);
	label$6c4203c_1_154:
	r19 = r21->array;
	((kha__graphics2__truetype__Stbtt_bakedchar*)(r19 + 1))[r24] = r23;
	goto label$6c4203c_1_144;
	label$6c4203c_1_157:
	r27 = NULL;
	r14 = -1;
	label$6c4203c_1_159:
	r24 = 0;
	if( r24 < r14 ) goto label$6c4203c_1_179;
	if( r10 >= r9 ) goto label$6c4203c_1_167;
	r24 = 2;
	r15 = r10 * r24;
	r10 = r15;
	goto label$6c4203c_1_170;
	label$6c4203c_1_167:
	r24 = 2;
	r15 = r9 * r24;
	r9 = r15;
	label$6c4203c_1_170:
	r15 = r9 * r10;
	r28 = kha_internal_BytesBlob_alloc(r15);
	r27 = r28;
	r28 = r0->blob;
	r15 = 0;
	r29 = (double)r1;
	r15 = kha_graphics2_truetype_StbTruetype_stbtt_BakeFontBitmap(r28,r15,r29,r27,r9,r10,r2,r21);
	r14 = r15;
	goto label$6c4203c_1_159;
	label$6c4203c_1_179:
	r30 = (kha__graphics2__truetype__Stbtt_fontinfo)hl_alloc_obj(&$t_kha_graphics2_truetype_Stbtt_fontinfo);
	kha_graphics2_truetype_Stbtt_fontinfo_new(r30);
	r28 = r0->blob;
	r15 = 0;
	r16 = kha_graphics2_truetype_StbTruetype_stbtt_InitFont(r30,r28,r15);
	...
	r33 = (kha__KravurImage)hl_alloc_obj(&$t_kha_KravurImage);
	r26 = (int)r1;
	kha_KravurImage_new(r33,r26,r15,r24,r25,r9,r10,r21,r27);
	r17 = r0->images;
	if( r17 == NULL ) hl_null_access();
...
void kha_Kravur_new(kha__Kravur r0,kha__internal__BytesBlob r1) {
	haxe__ds__IntMap r2;
	r2 = (haxe__ds__IntMap)hl_alloc_obj(&$t_haxe_ds_IntMap);
