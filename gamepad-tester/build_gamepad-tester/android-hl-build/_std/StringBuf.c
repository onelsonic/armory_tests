...
void StringBuf_add(StringBuf r0,vdynamic* r1) {
	...
	r2 = 0;
	r4 = &r2;
	r5 = hl_value_to_string(r1,r4);
	r7 = 1;
	r6 = r2 << r7;
	r7 = r0->pos;
	r7 = r7 + r6;
	r8 = r0->size;
	if( r8 >= r7 ) goto label$d4ab3a5_2_26;
	r7 = r0->pos;
	r7 = r7 + r6;
	r8 = r0->size;
	r9 = 3;
	...
	r9 = 1;
	r8 = r8 >> r9;
	if( r8 >= r7 ) goto label$d4ab3a5_2_18;
	r8 = r7;
	label$d4ab3a5_2_18:
...
void StringBuf_addChar(StringBuf r0,int r1) {
	...
	r5 = (String)$s_Invalid_unicode_char_;
	r3 = r1;
	r6 = &r3;
	r7 = hl_itos(r3,r6);
