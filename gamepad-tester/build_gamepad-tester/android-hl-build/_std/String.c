...
extern String $s_Invalid_unicode_char_;
...
String String_charAt(String r0,int r1) {
	...
	int r3, r4;
	r4 = r0->length;
	if( ((unsigned)r1) >= ((unsigned)r4) ) goto label$306c77b_4_4;
	r2 = false;
	goto label$306c77b_4_5;
	label$306c77b_4_4:
	r2 = true;
	label$306c77b_4_5:
	if( !r2 ) goto label$306c77b_4_8;
	r5 = (String)$s_;
	return r5;
	label$306c77b_4_8:
	r3 = 4;
	...
	*(unsigned short*)(r6 + r3) = (unsigned short)r4;
	r5 = (String)hl_alloc_obj(&$t_String);
	r5->bytes = r6;
	r3 = 1;
	r5->length = r3;
	return r5;
...
vdynamic* String_charCodeAt(String r0,int r1) {
	...
	int r3, r4;
	r4 = r0->length;
	if( ((unsigned)r1) >= ((unsigned)r4) ) goto label$306c77b_5_4;
	r2 = false;
	goto label$306c77b_5_5;
	label$306c77b_5_4:
	r2 = true;
	label$306c77b_5_5:
	if( !r2 ) goto label$306c77b_5_8;
	r5 = NULL;
	return r5;
	label$306c77b_5_8:
	r6 = r0->bytes;
...
int String_indexOf(String r0,String r1,vdynamic* r2) {
	...
	r3 = 0;
	if( !r2 ) goto label$306c77b_7_14;
	r4 = r2 ? r2->v.i : 0;
	r5 = 0;
	if( r5 >= r4 ) goto label$306c77b_7_14;
	r4 = r2 ? r2->v.i : 0;
	r5 = r0->length;
	if( r4 < r5 ) goto label$306c77b_7_10;
	r4 = -1;
	return r4;
	label$306c77b_7_10:
	r4 = r2 ? r2->v.i : 0;
	...
	r8 = r10;
	r12 = 0;
	if( r10 < r12 ) goto label$306c77b_7_38;
	r12 = 1;
	r10 = r10 & r12;
	r12 = 0;
	if( r10 != r12 ) goto label$306c77b_7_39;
	label$306c77b_7_38:
	goto label$306c77b_7_43;
	label$306c77b_7_39:
	r12 = 1;
	r10 = r8 + r12;
	r4 = r10;
	goto label$306c77b_7_24;
	label$306c77b_7_43:
	r10 = r8;
	r13 = 0;
	if( r13 >= r8 ) goto label$306c77b_7_49;
	r13 = 1;
	r12 = r8 >> r13;
	r10 = r12;
	label$306c77b_7_49:
...
String String_substr(String r0,int r1,vdynamic* r2) {
	...
	r9 = false;
	goto label$306c77b_10_38;
	label$306c77b_10_37:
	r9 = true;
	label$306c77b_10_38:
	if( !r9 ) goto label$306c77b_10_41;
	r6 = r3 - r1;
	r5 = r6;
	label$306c77b_10_41:
	r7 = 0;
	if( r1 < r7 ) goto label$306c77b_10_45;
	r7 = 0;
	if( r7 < r5 ) goto label$306c77b_10_47;
	label$306c77b_10_45:
	r8 = (String)$s_;
	return r8;
	label$306c77b_10_47:
...
String String_fromCharCode(int r0) {
	...
	r3 = (String)$s_Invalid_unicode_char_;
	r1 = r0;
	r4 = &r1;
	r5 = hl_itos(r1,r4);
	...
	*(unsigned short*)(r5 + r1) = (unsigned short)r2;
	r3 = (String)hl_alloc_obj(&$t_String);
	r3->bytes = r5;
	r1 = 1;
	r3->length = r1;
	return r3;
...
String String___alloc__(vbyte* r0,int r1) {
	String r2;
	r2 = (String)hl_alloc_obj(&$t_String);
	r2->bytes = r0;
	r2->length = r1;
	return r2;
}
...
vbyte* String_call_toString(vdynamic* r0) {
	...
	r1 = (vdynamic*)hl_dyn_getp((vdynamic*)r0,409915697/*toString*/,&$t_dyn);
	if( r1 == NULL ) hl_null_access();
	{
		r1 = (vdynamic*)hl_dyn_call((vclosure*)r1,NULL,0);
	}
	if( r1 ) goto label$306c77b_18_7;
	r2 = NULL;
	goto label$306c77b_18_8;
	label$306c77b_18_7:
	r2 = Std_string(r1);
	label$306c77b_18_8:
	if( r2 == NULL ) hl_null_access();
...
String String_fromUCS2(vbyte* r0) {
	String r1;
	int r2;
	r1 = (String)hl_alloc_obj(&$t_String);
	r1->bytes = r0;
	r2 = 0;
