...
void iron_data_WorldData_new__$1(venum* r0,iron__data__Probe r1) {
	...
	vclosure *r4;
	r2 = ((Enum$t_ctx_a709584*)r0)->p1;
	if( r2 == NULL ) hl_null_access();
	r2->probe = r1;
	r2 = ((Enum$t_ctx_a709584*)r0)->p1;
	if( r2 == NULL ) hl_null_access();
	r4 = ((Enum$t_ctx_a709584*)r0)->p0;
...
void iron_data_WorldData_new(iron__data__WorldData r0,iron__data__TWorldData r1,vclosure* r2) {
	...
	r6 = (iron__data__Probe)hl_alloc_obj(&$t_iron_data_Probe);
	r5 = r1->probe;
	r8 = hl_alloc_enum(&$t_ctx_a709584,0);
	((Enum$t_ctx_a709584*)r8)->p0 = (vclosure*)r2;
	((Enum$t_ctx_a709584*)r8)->p1 = (iron__data__WorldData)r0;
	r7 = hl_alloc_closure_ptr(&$t_fun_b736949,iron_data_WorldData_new__$1,r8);
...
void iron_data_WorldData_loadEnvmap(iron__data__WorldData r0,vclosure* r1) {
	...
	if( r4 == NULL ) hl_null_access();
	r3 = r4->envmap;
	r6 = hl_alloc_enum(&$t_ctx_a709584,0);
	((Enum$t_ctx_a709584*)r6)->p0 = (vclosure*)r1;
	((Enum$t_ctx_a709584*)r6)->p1 = (iron__data__WorldData)r0;
	r5 = hl_alloc_closure_ptr(&$t_fun_e4cb2db,iron_data_WorldData_loadEnvmap__$1,r6);
	r7 = NULL;
	r8 = NULL;
...
void iron_data_WorldData_parse__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	r8 = (String)$s_iron_data_WorldData;
	...
	label$f835eeb_5_28:
	r13 = (iron__data__WorldData)hl_alloc_obj(&$t_iron_data_WorldData);
	r12 = ((Enum$t_ctx_13c528e*)r0)->p1;
...
void iron_data_WorldData_parse(String r0,String r1,vclosure* r2) {
	venum *r5;
	vclosure *r4;
	r5 = hl_alloc_enum(&$t_ctx_13c528e,0);
	((Enum$t_ctx_13c528e*)r5)->p0 = (String)r1;
	((Enum$t_ctx_13c528e*)r5)->p1 = (vclosure*)r2;
	r4 = hl_alloc_closure_ptr(&$t_fun_d5be1f3,iron_data_WorldData_parse__$1,r5);
	iron_data_Data_getSceneRaw(r0,r4);
	return;
}

kha__arrays__Float32ArrayPrivate iron_data_WorldData_getEmptyIrradiance() {
	iron__data__$WorldData r2;
	float r9;
	kha__arrays__Float32ArrayPrivate r1, r3;
	double r8;
	vbyte *r5;
	int r4, r6, r7;
	r2 = (iron__data__$WorldData)$g__iron_data_WorldData;
	r1 = r2->emptyIrr;
	if( r1 ) goto label$f835eeb_7_29;
	r1 = (kha__arrays__Float32ArrayPrivate)hl_alloc_obj(&$t_kha_arrays_Float32ArrayPrivate);
	kha_arrays_Float32ArrayPrivate_new(r1);
	r4 = 28;
	r1->length = r4;
	r4 = 28;
	r5 = hl_kore_float32array_alloc(r4);
	r1->self = r5;
	r2 = (iron__data__$WorldData)$g__iron_data_WorldData;
	r2->emptyIrr = r1;
	r4 = 0;
	...
	r6 = r3->length;
	label$f835eeb_7_17:
	if( r4 >= r6 ) goto label$f835eeb_7_29;
	r7 = r4;
	++r4;
	r2 = (iron__data__$WorldData)$g__iron_data_WorldData;
	r3 = r2->emptyIrr;
	...
	r8 = 0.;
	r9 = (float)r8;
	hl_kore_float32array_set(r5,r7,r9);
	goto label$f835eeb_7_17;
	label$f835eeb_7_29:
	r2 = (iron__data__$WorldData)$g__iron_data_WorldData;
	r1 = r2->emptyIrr;
	return r1;
