...
extern String $s_movie;
extern hl_type $t_ctx_bff41cf;
...
void iron_data_MaterialContext_new__$2(venum* r0,kha__Image r1) {
	...
	varray *r7;
	int r3, r5, r10;
	r2 = ((Enum$t_ctx_bc67316*)r0)->p6;
	if( r2 == NULL ) hl_null_access();
	r3 = ((Enum$t_ctx_bc67316*)r0)->p8;
	r5 = r2->length;
	...
	*(int*)(r9 + r5) = r10;
	...
	r3 = *(int*)(r9 + r5);
	label$28664a1_1_31:
	r11 = ((Enum$t_ctx_bc67316*)r0)->p3;
	if( r11 == NULL ) hl_null_access();
	r2 = r11->mipmaps;
	if( r2 == NULL ) hl_null_access();
	r5 = r2->length;
	if( r3 != r5 ) goto label$28664a1_1_71;
	r4 = ((Enum$t_ctx_bc67316*)r0)->p4;
	...
	r3 = *(int*)(r9 + r5);
	label$28664a1_1_61:
	r14 = ((Enum$t_ctx_bc67316*)r0)->p0;
	if( r14 == NULL ) hl_null_access();
	r2 = r14->bind_textures;
	if( r2 == NULL ) hl_null_access();
	r5 = r2->length;
	if( r3 != r5 ) goto label$28664a1_1_71;
	r15 = ((Enum$t_ctx_bc67316*)r0)->p1;
	if( r15 == NULL ) hl_null_access();
	r16 = ((Enum$t_ctx_bc67316*)r0)->p5;
...
void iron_data_MaterialContext_new__$1(venum* r0,kha__Image r1) {
	...
	varray *r8;
	int r4, r6, r11, r15;
	r3 = ((Enum$t_ctx_bff41cf*)r0)->p5;
	if( r3 == NULL ) hl_null_access();
	r2 = r3->textures;
	if( r2 == NULL ) hl_null_access();
	r4 = ((Enum$t_ctx_bff41cf*)r0)->p3;
	r6 = r2->length;
	...
	*(int*)(r10 + r11) = r6;
	...
	r16 = (String)r17;
	label$28664a1_2_73:
	r19 = hl_alloc_enum(&$t_ctx_bc67316,0);
	r20 = ((Enum$t_ctx_bff41cf*)r0)->p0;
	((Enum$t_ctx_bc67316*)r19)->p0 = (iron__data__TMaterialContext)r20;
	r21 = ((Enum$t_ctx_bff41cf*)r0)->p1;
	((Enum$t_ctx_bc67316*)r19)->p1 = (vclosure*)r21;
	r22 = ((Enum$t_ctx_bff41cf*)r0)->p2;
	((Enum$t_ctx_bc67316*)r19)->p2 = (hl__types__ArrayBytes_Int)r22;
	r12 = ((Enum$t_ctx_bff41cf*)r0)->p4;
	((Enum$t_ctx_bc67316*)r19)->p3 = (iron__data__TBindTexture)r12;
	((Enum$t_ctx_bc67316*)r19)->p4 = (kha__Image)r1;
	r3 = ((Enum$t_ctx_bff41cf*)r0)->p5;
	((Enum$t_ctx_bc67316*)r19)->p5 = (iron__data__MaterialContext)r3;
	((Enum$t_ctx_bc67316*)r19)->p6 = (hl__types__ArrayObj)r2;
	((Enum$t_ctx_bc67316*)r19)->p7 = (hl__types__ArrayBytes_Int)r9;
	((Enum$t_ctx_bc67316*)r19)->p8 = (int)r11;
	r18 = hl_alloc_closure_ptr(&$t_fun_29746a5,iron_data_MaterialContext_new__$2,r19);
	r23 = NULL;
	r24 = NULL;
...
void iron_data_MaterialContext_new(iron__data__MaterialContext r0,iron__data__TMaterialContext r1,vclosure* r2) {
	...
	r5 = r0;
	r0->raw = r1;
	r7 = (iron__data__$MaterialContext)$g__iron_data_MaterialContext;
	r3 = r7->num;
	r8 = r3;
	++r3;
	r7->num = r3;
	...
	r8 = r3 - r11;
	r13 = NULL;
	r14 = (kha__Image)hl_dyn_castp(&r13,&$t_dyn,&$t_kha_Image);
	r11 = r4->length;
	...
	*(int*)(r16 + r19) = r23;
	...
	label$28664a1_4_102:
	r21 = r20->file;
	r25 = hl_alloc_enum(&$t_ctx_bff41cf,0);
	((Enum$t_ctx_bff41cf*)r25)->p0 = (iron__data__TMaterialContext)r1;
	((Enum$t_ctx_bff41cf*)r25)->p1 = (vclosure*)r2;
	((Enum$t_ctx_bff41cf*)r25)->p2 = (hl__types__ArrayBytes_Int)r15;
	((Enum$t_ctx_bff41cf*)r25)->p3 = (int)r17;
	((Enum$t_ctx_bff41cf*)r25)->p4 = (iron__data__TBindTexture)r20;
	((Enum$t_ctx_bff41cf*)r25)->p5 = (iron__data__MaterialContext)r5;
	r24 = hl_alloc_closure_ptr(&$t_fun_c4af003,iron_data_MaterialContext_new__$1,r25);
	r26 = false;
	r27 = &r26;
	r22 = r20->format;
