...
void iron_data_MaterialData_new__$2(venum* r0,iron__data__MaterialContext r1) {
	...
	varray *r7;
	int r4, r5, r10;
	r3 = ((Enum$t_ctx_955f890*)r0)->p2;
	if( r3 == NULL ) hl_null_access();
	r2 = r3->contexts;
	if( r2 == NULL ) hl_null_access();
	r4 = ((Enum$t_ctx_955f890*)r0)->p4;
	r5 = r2->length;
	...
	*(int*)(r9 + r5) = r10;
	...
	r4 = *(int*)(r9 + r5);
	label$51bd30c_1_33:
	r11 = ((Enum$t_ctx_955f890*)r0)->p0;
	if( r11 == NULL ) hl_null_access();
	r2 = r11->contexts;
	if( r2 == NULL ) hl_null_access();
	r5 = r2->length;
	if( r4 != r5 ) goto label$51bd30c_1_43;
	r12 = ((Enum$t_ctx_955f890*)r0)->p1;
...
void iron_data_MaterialData_new__$1(venum* r0,iron__data__ShaderData r1) {
	...
	int r6, r7, r13, r14;
	varray *r4;
	r2 = ((Enum$t_ctx_0da146a*)r0)->p2;
	if( r2 == NULL ) hl_null_access();
	r2->shader = r1;
	r2 = ((Enum$t_ctx_0da146a*)r0)->p2;
	if( r2 == NULL ) hl_null_access();
	r5 = &$t_iron_data_MaterialContext;
	r6 = 0;
	...
	*(int*)(r12 + r13) = r7;
	...
	label$51bd30c_2_60:
	r9 = (iron__data__MaterialContext)hl_alloc_obj(&$t_iron_data_MaterialContext);
	r18 = hl_alloc_enum(&$t_ctx_955f890,0);
	r8 = ((Enum$t_ctx_0da146a*)r0)->p0;
	((Enum$t_ctx_955f890*)r18)->p0 = (iron__data__TMaterialData)r8;
	r19 = ((Enum$t_ctx_0da146a*)r0)->p1;
	((Enum$t_ctx_955f890*)r18)->p1 = (vclosure*)r19;
	r2 = ((Enum$t_ctx_0da146a*)r0)->p2;
	((Enum$t_ctx_955f890*)r18)->p2 = (iron__data__MaterialData)r2;
	((Enum$t_ctx_955f890*)r18)->p3 = (hl__types__ArrayBytes_Int)r11;
	((Enum$t_ctx_955f890*)r18)->p4 = (int)r13;
	r17 = hl_alloc_closure_ptr(&$t_fun_1916425,iron_data_MaterialData_new__$2,r18);
...
void iron_data_MaterialData_parse__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	r8 = (String)$s_iron_data_MaterialData;
	...
	label$51bd30c_3_28:
	r13 = (iron__data__MaterialData)hl_alloc_obj(&$t_iron_data_MaterialData);
	r12 = ((Enum$t_ctx_6e52869*)r0)->p2;
	r4 = ((Enum$t_ctx_6e52869*)r0)->p0;
...
void iron_data_MaterialData_parse(String r0,String r1,vclosure* r2) {
	venum *r5;
	vclosure *r4;
	r5 = hl_alloc_enum(&$t_ctx_6e52869,0);
	((Enum$t_ctx_6e52869*)r5)->p0 = (String)r0;
	((Enum$t_ctx_6e52869*)r5)->p1 = (String)r1;
	((Enum$t_ctx_6e52869*)r5)->p2 = (vclosure*)r2;
	r4 = hl_alloc_closure_ptr(&$t_fun_53d0d62,iron_data_MaterialData_parse__$1,r5);
...
void iron_data_MaterialData_new(iron__data__MaterialData r0,iron__data__TMaterialData r1,vclosure* r2,String r3) {
	...
	r5 = NULL;
	r0->contexts = r5;
	r7 = (iron__data__$MaterialData)$g__iron_data_MaterialData;
	r8 = r7->uidCounter;
	++r8;
	r7->uidCounter = r8;
	r9 = (double)r8;
	...
	r10 = r12;
	label$51bd30c_6_47:
	r16 = hl_alloc_enum(&$t_ctx_0da146a,0);
	((Enum$t_ctx_0da146a*)r16)->p0 = (iron__data__TMaterialData)r1;
	((Enum$t_ctx_0da146a*)r16)->p1 = (vclosure*)r2;
	((Enum$t_ctx_0da146a*)r16)->p2 = (iron__data__MaterialData)r0;
	r15 = hl_alloc_closure_ptr(&$t_fun_73968be,iron_data_MaterialData_new__$1,r16);
