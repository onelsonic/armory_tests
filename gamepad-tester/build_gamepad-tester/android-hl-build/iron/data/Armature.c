...
void iron_data_Armature_initMats(iron__data__Armature r0) {
	...
	float r18, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34;
	...
	r7 = r5->length;
	if( r4 >= r7 ) goto label$d4081f7_2_118;
	r7 = r5->length;
	...
	r9 = hl_to_virtual(&$t_vrt_7235b40,(vdynamic*)r3);
	label$d4081f7_2_18:
	++r4;
	if( r9 == NULL ) hl_null_access();
	r8 = hl_vfields(r9)[1] ? (*(hl__types__ArrayObj*)(hl_vfields(r9)[1])) : (hl__types__ArrayObj)hl_dyn_getp(r9->value,139870941/*mats*/,&$t_hl_types_ArrayObj);
	if( !r8 ) goto label$d4081f7_2_23;
	goto label$d4081f7_2_7;
	label$d4081f7_2_23:
	r11 = &$t_iron_math_Mat4;
	r6 = 0;
	r10 = hl_alloc_array(r11,r6);
	r8 = hl_types_ArrayObj_alloc(r10);
	if( hl_vfields(r9)[1] ) *(hl__types__ArrayObj*)(hl_vfields(r9)[1]) = (hl__types__ArrayObj)r8; else hl_dyn_setp(r9->value,139870941/*mats*/,&$t_hl_types_ArrayObj,r8);
	r6 = 0;
	r8 = hl_vfields(r9)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r9)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r9->value,-151562331/*bones*/,&$t_hl_types_ArrayObj);
	label$d4081f7_2_30:
	if( r8 == NULL ) hl_null_access();
	r12 = r8->length;
	if( r6 >= r12 ) goto label$d4081f7_2_117;
	r12 = r8->length;
	...
	r7 = 0;
	if( r9 == NULL ) hl_null_access();
	r13 = hl_vfields(r9)[1] ? (*(hl__types__ArrayObj*)(hl_vfields(r9)[1])) : (hl__types__ArrayObj)hl_dyn_getp(r9->value,139870941/*mats*/,&$t_hl_types_ArrayObj);
	if( r13 == NULL ) hl_null_access();
	r17 = (iron__math__Mat4)hl_alloc_obj(&$t_iron_math_Mat4);
	if( r15 == NULL ) hl_null_access();
	r19 = r15->self;
	r18 = hl_kore_float32array_get(r19,r7);
	r19 = r15->self;
	r12 = 1;
	r12 = r12 + r7;
	r20 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 2;
	r12 = r12 + r7;
	r21 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 3;
	r12 = r12 + r7;
	r22 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 4;
	r12 = r12 + r7;
	r23 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 5;
	r12 = r12 + r7;
	r24 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 6;
	r12 = r12 + r7;
	r25 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 7;
	r12 = r12 + r7;
	r26 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 8;
	r12 = r12 + r7;
	r27 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 9;
	r12 = r12 + r7;
	r28 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 10;
	r12 = r12 + r7;
	r29 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 11;
	r12 = r12 + r7;
	r30 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 12;
	r12 = r12 + r7;
	r31 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 13;
	r12 = r12 + r7;
	r32 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 14;
	r12 = r12 + r7;
	r33 = hl_kore_float32array_get(r19,r12);
	r19 = r15->self;
	r12 = 15;
	r12 = r12 + r7;
	r34 = hl_kore_float32array_get(r19,r12);
	iron_math_Mat4_new(r17,r18,r20,r21,r22,r23,r24,r25,r26,r27,r28,r29,r30,r31,r32,r33,r34);
...
vvirtual* iron_data_Armature_getAction(iron__data__Armature r0,String r1) {
	...
	r7 = r3->array;
	r6 = ((vdynamic**)(r7 + 1))[r2];
	r5 = hl_to_virtual(&$t_vrt_7235b40,(vdynamic*)r6);
	label$d4081f7_3_13:
	++r2;
	if( r5 == NULL ) hl_null_access();
	r8 = hl_vfields(r5)[2] ? (*(String*)(hl_vfields(r5)[2])) : (String)hl_dyn_getp(r5->value,150958933/*name*/,&$t_String);
...
void iron_data_Armature_new(iron__data__Armature r0,int r1,String r2,hl__types__ArrayObj r3) {
	...
	if( r13 == NULL ) hl_null_access();
	r16 = r13->objects;
	r18 = hl_alloc_closure_ptr(&$t_fun_633bba1,iron_data_Armature_new__$1,r5);
	iron_data_Armature_traverseBones(r16,r18);
	r16 = r0->actions;
	if( r16 == NULL ) hl_null_access();
	r19 = hl_alloc_virtual(&$t_vrt_7235b40);
	r9 = r13->name;
	if( hl_vfields(r19)[2] ) *(String*)(hl_vfields(r19)[2]) = (String)r9; else hl_dyn_setp(r19->value,150958933/*name*/,&$t_String,r9);
	if( hl_vfields(r19)[0] ) *(hl__types__ArrayObj*)(hl_vfields(r19)[0]) = (hl__types__ArrayObj)r5; else hl_dyn_setp(r19->value,-151562331/*bones*/,&$t_hl_types_ArrayObj,r5);
	r20 = NULL;
	if( hl_vfields(r19)[1] ) *(hl__types__ArrayObj*)(hl_vfields(r19)[1]) = (hl__types__ArrayObj)r20; else hl_dyn_setp(r19->value,139870941/*mats*/,&$t_hl_types_ArrayObj,r20);
