...
void iron_system_Gamepad_connect(iron__system__Gamepad r0) {
	...
	r6 = hl_alloc_closure_ptr(&$t_fun_3da2633,iron_system_Gamepad_axisListener,r0);
	r7 = hl_alloc_closure_ptr(&$t_fun_3da2633,iron_system_Gamepad_buttonListener,r0);
...
void iron_system_Gamepad_endFrame(iron__system__Gamepad r0) {
	...
	r3 = (hl__types__ArrayBytes_Int)hl_dyn_castp(&r13,&$t_hl_types_ArrayBase,&$t_hl_types_ArrayBytes_Int);
	label$cdaaaee_2_47:
	r14 = r0->leftStick;
...
int iron_system_Gamepad_buttonIndex(iron__system__Gamepad r0,String r1) {
	...
	int r2, r3, r6, r7;
	r2 = 0;
	r5 = (iron__system__$Gamepad)$g__iron_system_Gamepad;
	r4 = r5->buttons;
	if( r4 == NULL ) hl_null_access();
	r3 = r4->length;
	label$cdaaaee_4_5:
...
bool iron_system_Gamepad_released(iron__system__Gamepad r0,String r1) {
	hl__types__ArrayObj r2;
	bool r5;
	vdynamic *r6;
	varray *r7;
	int r3, r4;
	r2 = r0->buttonsReleased;
	if( r2 == NULL ) hl_null_access();
	r3 = iron_system_Gamepad_buttonIndex(r0,r1);
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$cdaaaee_6_7;
	r5 = false;
	goto label$cdaaaee_6_10;
	label$cdaaaee_6_7:
	r7 = r2->array;
	r6 = ((vdynamic**)(r7 + 1))[r3];
	r5 = (bool)hl_dyn_casti(&r6,&$t_dyn,&$t_bool);
	label$cdaaaee_6_10:
	return r5;
}
...
void iron_system_Gamepad_axisListener(iron__system__Gamepad r0,int r1,double r2) {
	...
	int r4;
	r4 = 1;
	if( r4 < r1 ) goto label$cdaaaee_7_4;
	r3 = r0->leftStick;
	goto label$cdaaaee_7_5;
	label$cdaaaee_7_4:
	r3 = r0->rightStick;
	label$cdaaaee_7_5:
	r4 = 0;
	if( r1 == r4 ) goto label$cdaaaee_7_9;
	r4 = 2;
	if( r1 != r4 ) goto label$cdaaaee_7_18;
	label$cdaaaee_7_9:
	if( r3 == NULL ) hl_null_access();
	r6 = r3->x;
	r3->lastX = r6;
	...
	r6 = r6 - r7;
	r3->movementX = r6;
	goto label$cdaaaee_7_30;
	label$cdaaaee_7_18:
	r4 = 1;
	if( r1 == r4 ) goto label$cdaaaee_7_22;
	r4 = 3;
	if( r1 != r4 ) goto label$cdaaaee_7_30;
	label$cdaaaee_7_22:
	if( r3 == NULL ) hl_null_access();
	r6 = r3->y;
	r3->lastY = r6;
...
void iron_system_Gamepad_buttonListener(iron__system__Gamepad r0,int r1,double r2) {
	...
	r6 = r5->length;
	if( ((unsigned)r1) < ((unsigned)r6) ) goto label$cdaaaee_8_8;
	...
	*(double*)(r8 + r6) = r2;
	r9 = 0.;
	if( !(r9 < r2) ) goto label$cdaaaee_8_24;
	r10 = r0->buttonsStarted;
	if( r10 == NULL ) hl_null_access();
	r11 = true;
	r6 = r10->length;
	if( ((unsigned)r1) < ((unsigned)r6) ) goto label$cdaaaee_8_20;
	hl_types_ArrayObj___expand(r10,r1);
	label$cdaaaee_8_20:
	r12 = r10->array;
	r13 = hl_alloc_dynbool(r11);
	((vdynamic**)(r12 + 1))[r1] = r13;
	goto label$cdaaaee_8_33;
	label$cdaaaee_8_24:
	r10 = r0->buttonsReleased;
	if( r10 == NULL ) hl_null_access();
	r11 = true;
	r6 = r10->length;
	if( ((unsigned)r1) < ((unsigned)r6) ) goto label$cdaaaee_8_30;
	hl_types_ArrayObj___expand(r10,r1);
	label$cdaaaee_8_30:
	r12 = r10->array;
	r13 = hl_alloc_dynbool(r11);
	...
	label$cdaaaee_8_33:
	r9 = 0.;
	if( r2 != r9 ) goto label$cdaaaee_8_47;
	r14 = (iron__system__$Gamepad)$g__iron_system_Gamepad;
	r10 = r14->buttons;
	if( r10 == NULL ) hl_null_access();
	r6 = r10->length;
	if( ((unsigned)r1) < ((unsigned)r6) ) goto label$cdaaaee_8_42;
	r15 = NULL;
	goto label$cdaaaee_8_45;
	label$cdaaaee_8_42:
	r12 = r10->array;
	...
	goto label$cdaaaee_8_60;
	label$cdaaaee_8_47:
	r9 = 1.;
	if( r2 != r9 ) goto label$cdaaaee_8_60;
	r14 = (iron__system__$Gamepad)$g__iron_system_Gamepad;
	r10 = r14->buttons;
	if( r10 == NULL ) hl_null_access();
	r6 = r10->length;
	if( ((unsigned)r1) < ((unsigned)r6) ) goto label$cdaaaee_8_56;
	r15 = NULL;
	goto label$cdaaaee_8_59;
	label$cdaaaee_8_56:
	r12 = r10->array;
	r13 = ((vdynamic**)(r12 + 1))[r1];
	r15 = (String)r13;
...
void iron_system_Gamepad_new(iron__system__Gamepad r0,int r1,bool* r2) {
	...
	vbyte *r9;
	int r4, r15, r16;
	if( r2 ) goto label$cdaaaee_9_3;
	r3 = false;
	goto label$cdaaaee_9_4;
	label$cdaaaee_9_3:
	r3 = *r2;
	label$cdaaaee_9_4:
	r4 = 0;
	...
	r5 = false;
	r0->connected = r5;
	r6 = (iron__system__GamepadStick)hl_alloc_obj(&$t_iron_system_GamepadStick);
	...
	if( r10 == NULL ) hl_null_access();
	r16 = r10->length;
	if( r4 >= r16 ) goto label$cdaaaee_9_67;
	r16 = r10->length;
	if( ((unsigned)r4) < ((unsigned)r16) ) goto label$cdaaaee_9_48;
	r18 = NULL;
	goto label$cdaaaee_9_51;
	label$cdaaaee_9_48:
	r11 = r10->array;
	...
	r19 = hl_alloc_dynbool(r5);
	r15 = hl_types_ArrayObj_push(r17,r19);
	goto label$cdaaaee_9_40;
	label$cdaaaee_9_67:
	r0->num = r1;
	iron_system_Gamepad_reset(r0);
	if( !r3 ) goto label$cdaaaee_9_73;
	r5 = true;
	r0->connected = r5;
	goto label$cdaaaee_9_74;
	label$cdaaaee_9_73:
