...
void iron_object_Tilesheet_new__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	r9 = r6->name;
	r10 = ((Enum$t_ctx_18cedd0*)r0)->p0;
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$cb9e570_1_32;
	r11 = ((Enum$t_ctx_18cedd0*)r0)->p2;
	if( r11 == NULL ) hl_null_access();
	r11->raw = r6;
	r11 = ((Enum$t_ctx_18cedd0*)r0)->p2;
	if( r11 == NULL ) hl_null_access();
	r9 = ((Enum$t_ctx_18cedd0*)r0)->p1;
	r12 = NULL;
...
void iron_object_Tilesheet_new(iron__object__Tilesheet r0,String r1,String r2,String r3) {
	...
	r7 = false;
	r0->ready = r7;
	r11 = hl_alloc_enum(&$t_ctx_18cedd0,0);
	((Enum$t_ctx_18cedd0*)r11)->p0 = (String)r2;
	((Enum$t_ctx_18cedd0*)r11)->p1 = (String)r3;
	((Enum$t_ctx_18cedd0*)r11)->p2 = (iron__object__Tilesheet)r0;
	r10 = hl_alloc_closure_ptr(&$t_fun_493cad1,iron_object_Tilesheet_new__$1,r11);
