...
void iron_object_MeshObject_render(iron__object__MeshObject r0,vvirtual* r1,String r2,hl__types__ArrayObj r3) {
	...
	r66 = r8->count;
	r67 = &r66;
	if( hl_vfields(r1)[26] ) ((void (*)(vdynamic*,int,int*,int*))hl_vfields(r1)[26])(r1->value,r36,r65,r67); else {
	...
	r68 = r8->count;
	r67 = &r68;
	if( hl_vfields(r1)[27] ) ((void (*)(vdynamic*,int*,int*))hl_vfields(r1)[27])(r1->value,r65,r67); else {
		void *args[] = {r65,r67};
