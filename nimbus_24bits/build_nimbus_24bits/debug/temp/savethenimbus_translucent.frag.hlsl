...
void frag_main()
{
    ...
    float3 _655 = pow(ImageTexture_008_texread_store.xyz, 2.2000000476837158203125f.xxx);
    ImageTexture_008_texread_store = float4(_655.x, _655.y, _655.z, ImageTexture_008_texread_store.w);
