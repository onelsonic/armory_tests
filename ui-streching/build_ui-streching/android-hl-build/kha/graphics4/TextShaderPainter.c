...
void kha_graphics4_TextShaderPainter_initShaders() {
	...
	r3 = (kha__graphics4__PipelineCache)hl_alloc_obj(&t$kha_graphics4_PipelineCache);
...
void kha_graphics4_TextShaderPainter_initBuffers(kha__graphics4__TextShaderPainter r0) {
	...
	if( r2 ) goto label$cb73abe_4_113;
	...
	label$cb73abe_4_35:
	r14 = 1000;
	if( r4 >= r14 ) goto label$cb73abe_4_108;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
...
void kha_graphics4_TextShaderPainter_drawBuffer(kha__graphics4__TextShaderPainter r0) {
	...
	if( hl_vfields(r7)[2] ) ((void (*)(vdynamic*,kha__graphics4__VertexBuffer))hl_vfields(r7)[2])(r7->value,r2); else {
		void *args[] = {r2};
		hl_dyn_call_obj(r7->value,&t$fun_a561c62,-278953801/*setVertexBuffer*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r3 = (kha__graphics4__$TextShaderPainter)g$_kha_graphics4_TextShaderPainter;
	...
	if( hl_vfields(r7)[12] ) ((void (*)(vdynamic*,kha__graphics4__IndexBuffer))hl_vfields(r7)[12])(r7->value,r8); else {
		void *args[] = {r8};
		hl_dyn_call_obj(r7->value,&t$fun_46c6b6e,-43737183/*setIndexBuffer*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r10 = r0->myPipeline;
	...
	if( hl_vfields(r7)[8] ) ((void (*)(vdynamic*,kha__graphics4__PipelineState))hl_vfields(r7)[8])(r7->value,r9); else {
		void *args[] = {r9};
		hl_dyn_call_obj(r7->value,&t$fun_c80ec77,467961459/*setPipeline*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r10 = r0->myPipeline;
	...
	if( hl_vfields(r7)[7] ) ((void (*)(vdynamic*,vvirtual*,kha__Image))hl_vfields(r7)[7])(r7->value,r11,r12); else {
		void *args[] = {r11,r12};
		hl_dyn_call_obj(r7->value,&t$fun_04e2896,-239080103/*setTexture*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r10 = r0->myPipeline;
	...
	if( hl_vfields(r7)[10] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r7)[10])(r7->value,r11,r13); else {
		void *args[] = {r11,r13};
		hl_dyn_call_obj(r7->value,&t$fun_896f717,460303235/*setMatrix*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r10 = r0->myPipeline;
	...
	if( hl_vfields(r7)[3] ) ((void (*)(vdynamic*,vvirtual*,int,int,int,int,int))hl_vfields(r7)[3])(r7->value,r11,r4,r5,r14,r16,r17); else {
		...
		hl_dyn_call_obj(r7->value,&t$fun_4ad9aaa,357382632/*setTextureParameters*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r4 = 0;
	...
	r5 = r5 * r14;
	r19 = &r5;
	if( hl_vfields(r7)[26] ) ((void (*)(vdynamic*,int*,int*))hl_vfields(r7)[26])(r7->value,r18,r19); else {
		void *args[] = {r18,r19};
		hl_dyn_call_obj(r7->value,&t$fun_8305be0,-519327652/*drawIndexedVertices*/,args,NULL);
	}
	r7 = r0->g;
	if( r7 == NULL ) hl_null_access();
	r10 = r0->myPipeline;
...
int kha_graphics4_TextShaderPainter_findIndex(int r0) {
	...
	r8 = (int)r7;
	label$cb73abe_11_12:
	if( r6 >= r8 ) goto label$cb73abe_11_50;
	r10 = r6;
	++r6;
	if( r3 == NULL ) hl_null_access();
	r12 = 2;
	r11 = r10 * r12;
	r12 = r3->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$cb73abe_11_23;
	r11 = 0;
	goto label$cb73abe_11_27;
	label$cb73abe_11_23:
	r13 = r3->bytes;
	r12 = 2;
	r12 = r11 << r12;
	...
	r12 = r12 + r14;
	r14 = r3->length;
	if( ((unsigned)r12) < ((unsigned)r14) ) goto label$cb73abe_11_35;
	r12 = 0;
	goto label$cb73abe_11_39;
	label$cb73abe_11_35:
	r13 = r3->bytes;
	r14 = 2;
	r14 = r12 << r14;
	r12 = *(int*)(r13 + r14);
	label$cb73abe_11_39:
	if( r0 < r11 ) goto label$cb73abe_11_44;
	if( r12 < r0 ) goto label$cb73abe_11_44;
	r14 = r5 + r0;
	r14 = r14 - r11;
	return r14;
	label$cb73abe_11_44:
