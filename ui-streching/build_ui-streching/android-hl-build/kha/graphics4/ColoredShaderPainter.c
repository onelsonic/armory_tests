...
void kha_graphics4_ColoredShaderPainter_initBuffers(kha__graphics4__ColoredShaderPainter r0) {
	...
	if( r2 ) goto label$e7917a1_4_183;
	...
	label$e7917a1_4_35:
	r14 = 1000;
	if( r4 >= r14 ) goto label$e7917a1_4_108;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
	...
	label$e7917a1_4_145:
	r14 = 1000;
	if( r4 >= r14 ) goto label$e7917a1_4_178;
	r6 = r4;
	++r4;
	r15 = 3;
	r14 = r6 * r15;
...
void kha_graphics4_ColoredShaderPainter_drawBuffer(kha__graphics4__ColoredShaderPainter r0,bool r1) {
	...
	if( hl_vfields(r9)[10] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r9)[10])(r9->value,r13,r14); else {
		void *args[] = {r13,r14};
		hl_dyn_call_obj(r9->value,&t$fun_896f717,460303235/*setMatrix*/,args,NULL);
	}
	r9 = r0->g;
	if( r9 == NULL ) hl_null_access();
	r4 = 0;
	...
	r6 = r6 * r16;
	r17 = &r6;
	if( hl_vfields(r9)[26] ) ((void (*)(vdynamic*,int*,int*))hl_vfields(r9)[26])(r9->value,r15,r17); else {
		void *args[] = {r15,r17};
