...
kha__graphics4__PipelineCache kha_graphics4_ImageShaderPainter_set_pipeline(kha__graphics4__ImageShaderPainter r0,kha__graphics4__PipelineCache r1) {
...
void kha_graphics4_ImageShaderPainter_initBuffers(kha__graphics4__ImageShaderPainter r0) {
	...
	if( r2 ) goto label$b78fc65_4_113;
	...
	label$b78fc65_4_35:
	r14 = 1500;
	if( r4 >= r14 ) goto label$b78fc65_4_108;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
...
void kha_graphics4_ImageShaderPainter_drawBuffer(kha__graphics4__ImageShaderPainter r0) {
	...
	r5 = 2;
	r14 = r0->bilinear;
	if( !r14 ) goto label$b78fc65_5_44;
	r13 = 1;
	goto label$b78fc65_5_45;
	label$b78fc65_5_44:
	r13 = 0;
	label$b78fc65_5_45:
	r14 = r0->bilinear;
	if( !r14 ) goto label$b78fc65_5_49;
	r15 = 1;
	goto label$b78fc65_5_50;
	label$b78fc65_5_49:
	r15 = 0;
	label$b78fc65_5_50:
	r14 = r0->bilinearMipmaps;
	if( !r14 ) goto label$b78fc65_5_54;
	r16 = 2;
	goto label$b78fc65_5_55;
	label$b78fc65_5_54:
	r16 = 0;
	label$b78fc65_5_55:
	...
	if( hl_vfields(r7)[10] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r7)[10])(r7->value,r11,r17); else {
		void *args[] = {r11,r17};
...
void kha_graphics4_ImageShaderPainter_setBilinearFilter(kha__graphics4__ImageShaderPainter r0,bool r1) {
	kha_graphics4_ImageShaderPainter_end(r0);
	r0->bilinear = r1;
	return;
}
...
void kha_graphics4_ImageShaderPainter_end(kha__graphics4__ImageShaderPainter r0) {
	...
	r2 = r3->bufferIndex;
	r4 = 0;
	if( r4 >= r2 ) goto label$b78fc65_7_5;
