...
void kha_graphics4_Graphics2_drawImage(kha__graphics4__Graphics2 r0,kha__Image r1,float r2,float r3) {
	...
	r8 = r8 + r42;
	r42 = 1500;
	if( r8 >= r42 ) goto label$30de1a7_3_201;
	r41 = (kha__graphics4__$ImageShaderPainter)g$a0efbdf;
	r43 = r41->lastTexture;
	if( !r43 ) goto label$30de1a7_3_203;
	r41 = (kha__graphics4__$ImageShaderPainter)g$a0efbdf;
	r44 = r41->lastTexture;
	if( r1 == r44 ) goto label$30de1a7_3_203;
	label$30de1a7_3_201:
	if( r39 == NULL ) hl_null_access();
	kha_graphics4_ImageShaderPainter_drawBuffer(r39);
	label$30de1a7_3_203:
	r42 = 16711680;
	r8 = r6 & r42;
	r42 = 16;
...
void kha_graphics4_Graphics2_drawScaledSubImage(kha__graphics4__Graphics2 r0,kha__Image r1,float r2,float r3,float r4,float r5,float r6,float r7,float r8,float r9) {
	...
	r14 = r14 + r49;
	r49 = 1500;
	if( r14 >= r49 ) goto label$30de1a7_4_198;
	r48 = (kha__graphics4__$ImageShaderPainter)g$a0efbdf;
	r50 = r48->lastTexture;
	if( !r50 ) goto label$30de1a7_4_200;
	r48 = (kha__graphics4__$ImageShaderPainter)g$a0efbdf;
	r51 = r48->lastTexture;
	if( r1 == r51 ) goto label$30de1a7_4_200;
	label$30de1a7_4_198:
...
void kha_graphics4_Graphics2_setPipeline(kha__graphics4__Graphics2 r0,kha__graphics4__PipelineState r1) {
	...
	goto label$30de1a7_15_39;
	label$30de1a7_15_19:
	r9 = r0->pipelineCache;
	if( r9 == NULL ) hl_null_access();
	r4 = haxe_ds_ObjectMap_get(r9,((vdynamic*)r1));
	r5 = (kha__graphics4__PipelineCache)r4;
	if( r5 ) goto label$30de1a7_15_30;
	r10 = (kha__graphics4__PipelineCache)hl_alloc_obj(&t$kha_graphics4_PipelineCache);
...
void kha_graphics4_Graphics2_begin(kha__graphics4__Graphics2 r0,bool* r1,vdynamic* r2) {
	...
	if( r1 ) goto label$30de1a7_16_3;
	r3 = true;
	goto label$30de1a7_16_4;
	label$30de1a7_16_3:
	r3 = *r1;
	label$30de1a7_16_4:
	r6 = (kha__graphics4__$Graphics2)g$_kha_graphics4_Graphics2;
	r5 = r6->current;
	if( r5 ) goto label$30de1a7_16_10;
	r6 = (kha__graphics4__$Graphics2)g$_kha_graphics4_Graphics2;
	r6->current = r0;
	goto label$30de1a7_16_12;
	label$30de1a7_16_10:
	r7 = (String)s$End_before_you_begin;
	hl_throw((vdynamic*)r7);
	label$30de1a7_16_12:
	r8 = r0->g;
	if( r8 == NULL ) hl_null_access();
	r9 = NULL;
	if( hl_vfields(r8)[30] ) ((void (*)(vdynamic*,hl__types__ArrayObj))hl_vfields(r8)[30])(r8->value,r9); else {
		void *args[] = {r9};
		hl_dyn_call_obj(r8->value,&t$fun_58e3acc,-262805217/*begin*/,args,NULL);
	}
	if( !r3 ) goto label$30de1a7_16_18;
...
void kha_graphics4_Graphics2_clear(kha__graphics4__Graphics2 r0,vdynamic* r1) {
	...
	r3 = r0->g;
	if( r3 == NULL ) hl_null_access();
	if( r1 ) goto label$30de1a7_17_7;
	r5 = -16777216;
	r4 = hl_alloc_dynamic(&t$_i32);
	r4->v.i = r5;
	goto label$30de1a7_17_8;
	label$30de1a7_17_7:
	r4 = r1;
	label$30de1a7_17_8:
	r6 = NULL;
...
void kha_graphics4_Graphics2_flush(kha__graphics4__Graphics2 r0) {
	...
	r7 = 0;
	if( r7 >= r5 ) goto label$30de1a7_18_14;
	if( r4 == NULL ) hl_null_access();
	r8 = false;
	...
	r5 = r6->bufferIndex;
	r7 = 0;
	if( r7 >= r5 ) goto label$30de1a7_18_21;
	if( r4 == NULL ) hl_null_access();
	r8 = false;
...
void kha_graphics4_Graphics2_end(kha__graphics4__Graphics2 r0) {
	...
	r3 = r4->current;
	if( r3 != r0 ) goto label$30de1a7_19_11;
	r3 = NULL;
	r4 = (kha__graphics4__$Graphics2)g$_kha_graphics4_Graphics2;
	r4->current = r3;
	goto label$30de1a7_19_13;
	label$30de1a7_19_11:
	r5 = (String)s$Begin_before_you_end;
...
void kha_graphics4_Graphics2_new(kha__graphics4__Graphics2 r0,vvirtual* r1) {
	...
	if( hl_vfields(r1)[4] ) r6 = ((vvirtual* (*)(vdynamic*))hl_vfields(r1)[4])(r1->value); else {
		r6 = (vvirtual*)hl_dyn_call_obj(r1->value,&t$fun_9afa644,-483397588/*get_g4*/,NULL,NULL);
	}
	r0->g = r6;
	r7 = (kha__graphics4__ImageShaderPainter)hl_alloc_obj(&t$kha_graphics4_ImageShaderPainter);
	r6 = r0->g;
	kha_graphics4_ImageShaderPainter_new(r7,r6);
	r0->imagePainter = r7;
	r8 = (kha__graphics4__ColoredShaderPainter)hl_alloc_obj(&t$kha_graphics4_ColoredShaderPainter);
	r6 = r0->g;
	kha_graphics4_ColoredShaderPainter_new(r8,r6);
	r0->coloredPainter = r8;
	r9 = (kha__graphics4__TextShaderPainter)hl_alloc_obj(&t$kha_graphics4_TextShaderPainter);
	r6 = r0->g;
	...
	r9->fontSize = r5;
	r10 = (kha__math__FastMatrix4)hl_alloc_obj(&t$kha_math_FastMatrix4);
	r5 = 1;
	r11 = (float)r5;
	r5 = 0;
	r12 = (float)r5;
	...
	kha_graphics4_Graphics2_setProjection(r0);
	r27 = (kha__graphics4__$Graphics2)g$_kha_graphics4_Graphics2;
	r2 = r27->videoPipeline;
	if( r2 ) goto label$30de1a7_26_89;
	...
	r2 = r27->videoPipeline;
	if( r2 == NULL ) hl_null_access();
	r30 = (kha__$Shaders)g$_kha_Shaders;
