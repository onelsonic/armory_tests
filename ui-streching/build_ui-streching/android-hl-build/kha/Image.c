...
kha__graphics2__Graphics kha_Image_get_g2(kha__Image r0) {
	...
	r4 = hl_to_virtual(&t$vrt_bf05379,(vdynamic*)r0);
	r0->f$14 = r4;
	label$2991a06_20_7:
...
vvirtual* kha_Image_get_g4(kha__Image r0) {
	...
	r2 = hl_to_virtual(&t$vrt_e7266b6,(vdynamic*)r3);
	r3->f$1 = r2;
	label$2991a06_21_15:
	r0->graphics4 = r2;
	label$2991a06_21_16:
...
void kha_Image_generateMipmaps(kha__Image r0,int r1) {
	vbyte *r3;
	r3 = r0->_texture;
	if( !r3 ) goto label$2991a06_30_5;
	r3 = r0->_texture;
	hl_kore_generate_mipmaps_texture(r3,r1);
	goto label$2991a06_30_7;
	label$2991a06_30_5:
	r3 = r0->_renderTarget;
...
void kha_Image_setMipmaps(kha__Image r0,hl__types__ArrayObj r1) {
	...
	r4 = r1->length;
	label$2991a06_31_3:
	if( r2 >= r4 ) goto label$2991a06_31_22;
	r5 = r2;
	++r2;
	if( r1 == NULL ) hl_null_access();
	r7 = r1->length;
	if( ((unsigned)r5) < ((unsigned)r7) ) goto label$2991a06_31_12;
	r8 = NULL;
	goto label$2991a06_31_15;
	label$2991a06_31_12:
	r10 = r1->array;
