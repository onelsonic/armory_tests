...
void kha_korehl_graphics4_Graphics_renderToTexture(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	...
	r3 = r1->length;
	r5 = r0->target;
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_bf05379,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r4 = r6->_renderTarget;
	r9 = 0;
	...
	r5 = hl_to_virtual(&t$vrt_bf05379,(vdynamic*)r10);
	label$cb1cbbc_30_17:
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_bf05379,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r7 = r6->_renderTarget;
...
void kha_korehl_graphics4_Graphics_beginFace(kha__korehl__graphics4__Graphics r0,int r1) {
	...
	vbyte *r3;
	r4 = r0->target;
	r5 = (kha__graphics4__CubeMap)hl_dyn_castp(&r4,&t$vrt_bf05379,&t$kha_graphics4_CubeMap);
	if( r5 == NULL ) hl_null_access();
	r3 = r5->_renderTarget;
