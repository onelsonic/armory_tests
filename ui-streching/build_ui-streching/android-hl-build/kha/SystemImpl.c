...
void kha_SystemImpl_init(kha__SystemOptions r0,vclosure* r1) {
	...
	r25 = hl_to_virtual(&t$vrt_e7266b6,(vdynamic*)r20);
	r20->f$1 = r25;
	label$fc555d2_2_45:
	...
	r21 = hl_to_virtual(&t$vrt_bf05379,(vdynamic*)r28);
	r28->f$6 = r21;
	label$fc555d2_2_61:
...
vbyte* kha_SystemImpl_cut() {
	...
	r1 = (kha__$System)g$_kha_System;
	r0 = r1->cutListener;
	if( !r0 ) goto label$fc555d2_45_17;
	r1 = (kha__$System)g$_kha_System;
	r0 = r1->cutListener;
	if( r0 == NULL ) hl_null_access();
	r2 = r0->hasValue ? ((String (*)(vdynamic*))r0->fun)((vdynamic*)r0->value) : ((String (*)(void))r0->fun)();
	if( r2 ) goto label$fc555d2_45_10;
	r3 = NULL;
	return r3;
	label$fc555d2_45_10:
	r4 = 0;
