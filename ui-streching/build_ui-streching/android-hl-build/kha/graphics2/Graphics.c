...
kha__math__FastMatrix3 kha_graphics2_Graphics_popTransformation(kha__graphics2__Graphics r0) {
	...
	r1 = r0->transformationIndex;
	r2 = r4->length;
	if( ((unsigned)r1) < ((unsigned)r2) ) goto label$521acff_18_10;
	r5 = NULL;
	goto label$521acff_18_13;
	label$521acff_18_10:
	r7 = r4->array;
	r6 = ((vdynamic**)(r7 + 1))[r1];
	...
	r1 = r1 + r2;
	r2 = r4->length;
	if( ((unsigned)r1) < ((unsigned)r2) ) goto label$521acff_18_23;
	r5 = NULL;
	goto label$521acff_18_26;
	label$521acff_18_23:
	r7 = r4->array;
	r6 = ((vdynamic**)(r7 + 1))[r1];
	r5 = (kha__math__FastMatrix3)r6;
...
kha__graphics4__PipelineState kha_graphics2_Graphics_set_pipeline(kha__graphics2__Graphics r0,kha__graphics4__PipelineState r1) {
	((void (*)(kha__graphics2__Graphics,kha__graphics4__PipelineState))r0->$type->vobj_proto[14])(r0,r1);
	r0->pipe = r1;
	return r1;
}
