...
void armory_renderpath_Inc_bindShadowMap() {
	...
	r17 = (armory__renderpath__$Inc)g$_armory_renderpath_Inc;
	r16 = r17->path;
...
String armory_renderpath_Inc_shadowMapName(iron__object__LightObject r0) {
	...
	r6 = (armory__renderpath__$Inc)g$_armory_renderpath_Inc;
	r5 = r6->pointIndex;
	r7 = &r5;
	r8 = hl_itos(r5,r7);
