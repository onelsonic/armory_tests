...
void armory_renderpath_RenderPathForward_setTargetMeshes() {
	...
	double *r5;
	iron__RenderPath r1;
	r2 = (armory__renderpath__$RenderPathForward)g$9924ae4;
	r1 = r2->path;
	if( r1 == NULL ) hl_null_access();
	r3 = (String)s$lbuffer0;
	r4 = NULL;
	r5 = NULL;
...
void armory_renderpath_RenderPathForward_init(iron__RenderPath r0) {
	...
	r1 = r2->path;
	if( r1 == NULL ) hl_null_access();
	r4 = (String)s$shader_datas_copy_pass_copy_pass;
...
void armory_renderpath_RenderPathForward_commands() {
	...
	r4 = (armory__renderpath__$RenderPathForward)g$9924ae4;
	r3 = r4->path;
	...
	r3 = r4->path;
	if( r3 == NULL ) hl_null_access();
	r11 = (String)s$lbuffer0;
	r14 = (String)s$tex;
	iron_RenderPath_bindTarget(r3,r11,r14);
	r4 = (armory__renderpath__$RenderPathForward)g$9924ae4;
	r3 = r4->path;
	if( r3 == NULL ) hl_null_access();
	r11 = (String)s$shader_datas_copy_pass_copy_pass;
