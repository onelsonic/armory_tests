...
void armory_system_Starter_main__$3(venum* r0) {
	...
	r9 = ((Enumt$ctx_7680ad9*)r0)->p0;
	r10 = hl_alloc_closure_ptr(&t$fun_eeac1a0,armory_system_Starter_main__$5,r0);
...
void armory_system_Starter_main__$2(venum* r0,kha__Window r1) {
	vclosure *r3;
	r3 = hl_alloc_closure_ptr(&t$fun_8a7a13f,armory_system_Starter_main__$3,r0);
	iron_App_init(r3);
	return;
}
...
void armory_system_Starter_main__$1(venum* r0) {
	...
	int r2, r4, r14, r15;
	r3 = (armory__system__$Starter)g$_armory_system_Starter;
	r2 = r3->tasks;
	r4 = 0;
	if( r4 >= r2 ) goto label$fb84227_5_5;
	return;
	label$fb84227_5_5:
	r6 = (armory__data__$Config)g$_armory_data_Config;
	r5 = r6->raw;
	if( r5 ) goto label$fb84227_5_12;
	r7 = hl_alloc_dynobj();
	r5 = hl_to_virtual(&t$vrt_9442311,(vdynamic*)r7);
	r6 = (armory__data__$Config)g$_armory_data_Config;
	r6->raw = r5;
	label$fb84227_5_12:
	r6 = (armory__data__$Config)g$_armory_data_Config;
	...
	r8 = hl_vfields(r5)[13] ? (*(vdynamic**)(hl_vfields(r5)[13])) : (vdynamic*)hl_dyn_getp(r5->value,420943452/*window_mode*/,&t$nul_i32);
	if( r8 ) goto label$fb84227_5_20;
	r2 = ((Enumt$ctx_7680ad9*)r0)->p1;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r2;
	if( hl_vfields(r5)[13] ) *(vdynamic**)(hl_vfields(r5)[13]) = (vdynamic*)r8; else hl_dyn_setp(r5->value,420943452/*window_mode*/,&t$nul_i32,r8);
	label$fb84227_5_20:
	r9 = hl_vfields(r5)[15] ? (*(vdynamic**)(hl_vfields(r5)[15])) : (vdynamic*)hl_dyn_getp(r5->value,110727964/*window_resizable*/,&t$nul_bool);
	if( r9 ) goto label$fb84227_5_25;
	r10 = ((Enumt$ctx_7680ad9*)r0)->p2;
	r9 = hl_alloc_dynbool(r10);
	if( hl_vfields(r5)[15] ) *(vdynamic**)(hl_vfields(r5)[15]) = (vdynamic*)r9; else hl_dyn_setp(r5->value,110727964/*window_resizable*/,&t$nul_bool,r9);
	label$fb84227_5_25:
	r9 = hl_vfields(r5)[12] ? (*(vdynamic**)(hl_vfields(r5)[12])) : (vdynamic*)hl_dyn_getp(r5->value,221172604/*window_minimizable*/,&t$nul_bool);
	if( r9 ) goto label$fb84227_5_30;
	r10 = ((Enumt$ctx_7680ad9*)r0)->p3;
	r9 = hl_alloc_dynbool(r10);
	if( hl_vfields(r5)[12] ) *(vdynamic**)(hl_vfields(r5)[12]) = (vdynamic*)r9; else hl_dyn_setp(r5->value,221172604/*window_minimizable*/,&t$nul_bool,r9);
	label$fb84227_5_30:
	r9 = hl_vfields(r5)[11] ? (*(vdynamic**)(hl_vfields(r5)[11])) : (vdynamic*)hl_dyn_getp(r5->value,-397857803/*window_maximizable*/,&t$nul_bool);
	if( r9 ) goto label$fb84227_5_35;
	r10 = ((Enumt$ctx_7680ad9*)r0)->p4;
	r9 = hl_alloc_dynbool(r10);
	if( hl_vfields(r5)[11] ) *(vdynamic**)(hl_vfields(r5)[11]) = (vdynamic*)r9; else hl_dyn_setp(r5->value,-397857803/*window_maximizable*/,&t$nul_bool,r9);
	label$fb84227_5_35:
	r8 = hl_vfields(r5)[18] ? (*(vdynamic**)(hl_vfields(r5)[18])) : (vdynamic*)hl_dyn_getp(r5->value,500024503/*window_w*/,&t$nul_i32);
	if( r8 ) goto label$fb84227_5_40;
	r2 = ((Enumt$ctx_7680ad9*)r0)->p5;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r2;
	if( hl_vfields(r5)[18] ) *(vdynamic**)(hl_vfields(r5)[18]) = (vdynamic*)r8; else hl_dyn_setp(r5->value,500024503/*window_w*/,&t$nul_i32,r8);
	label$fb84227_5_40:
	r8 = hl_vfields(r5)[10] ? (*(vdynamic**)(hl_vfields(r5)[10])) : (vdynamic*)hl_dyn_getp(r5->value,500024488/*window_h*/,&t$nul_i32);
	if( r8 ) goto label$fb84227_5_45;
	r2 = ((Enumt$ctx_7680ad9*)r0)->p6;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r2;
	if( hl_vfields(r5)[10] ) *(vdynamic**)(hl_vfields(r5)[10]) = (vdynamic*)r8; else hl_dyn_setp(r5->value,500024488/*window_h*/,&t$nul_i32,r8);
	label$fb84227_5_45:
	r11 = hl_vfields(r5)[16] ? (*(vdynamic**)(hl_vfields(r5)[16])) : (vdynamic*)hl_dyn_getp(r5->value,127024571/*window_scale*/,&t$nul_f64);
	if( r11 ) goto label$fb84227_5_50;
	r12 = 1.;
	r11 = hl_alloc_dynamic(&t$_f64);
	r11->v.d = r12;
	if( hl_vfields(r5)[16] ) *(vdynamic**)(hl_vfields(r5)[16]) = (vdynamic*)r11; else hl_dyn_setp(r5->value,127024571/*window_scale*/,&t$nul_f64,r11);
	label$fb84227_5_50:
	r8 = hl_vfields(r5)[14] ? (*(vdynamic**)(hl_vfields(r5)[14])) : (vdynamic*)hl_dyn_getp(r5->value,421141695/*window_msaa*/,&t$nul_i32);
	if( r8 ) goto label$fb84227_5_55;
	r2 = ((Enumt$ctx_7680ad9*)r0)->p7;
	r8 = hl_alloc_dynamic(&t$_i32);
	r8->v.i = r2;
	if( hl_vfields(r5)[14] ) *(vdynamic**)(hl_vfields(r5)[14]) = (vdynamic*)r8; else hl_dyn_setp(r5->value,421141695/*window_msaa*/,&t$nul_i32,r8);
	label$fb84227_5_55:
	r9 = hl_vfields(r5)[17] ? (*(vdynamic**)(hl_vfields(r5)[17])) : (vdynamic*)hl_dyn_getp(r5->value,-328491907/*window_vsync*/,&t$nul_bool);
	if( r9 ) goto label$fb84227_5_60;
	r10 = ((Enumt$ctx_7680ad9*)r0)->p8;
	r9 = hl_alloc_dynbool(r10);
	if( hl_vfields(r5)[17] ) *(vdynamic**)(hl_vfields(r5)[17]) = (vdynamic*)r9; else hl_dyn_setp(r5->value,-328491907/*window_vsync*/,&t$nul_bool,r9);
	label$fb84227_5_60:
	...
	r4 = r14;
	label$fb84227_5_87:
	r16 = (kha__SystemOptions)hl_alloc_obj(&t$kha_SystemOptions);
	r17 = (String)s$ui_streching;
	r8 = hl_vfields(r5)[18] ? (*(vdynamic**)(hl_vfields(r5)[18])) : (vdynamic*)hl_dyn_getp(r5->value,500024503/*window_w*/,&t$nul_i32);
	r13 = hl_vfields(r5)[10] ? (*(vdynamic**)(hl_vfields(r5)[10])) : (vdynamic*)hl_dyn_getp(r5->value,500024488/*window_h*/,&t$nul_i32);
	r18 = (kha__WindowOptions)hl_alloc_obj(&t$kha_WindowOptions);
	r19 = NULL;
	r20 = NULL;
	r21 = NULL;
	r22 = NULL;
	...
	r27 = (kha__FramebufferOptions)hl_alloc_obj(&t$kha_FramebufferOptions);
	r20 = NULL;
	r9 = hl_vfields(r5)[17] ? (*(vdynamic**)(hl_vfields(r5)[17])) : (vdynamic*)hl_dyn_getp(r5->value,-328491907/*window_vsync*/,&t$nul_bool);
	r21 = NULL;
	r22 = NULL;
	r23 = NULL;
	r24 = hl_vfields(r5)[14] ? (*(vdynamic**)(hl_vfields(r5)[14])) : (vdynamic*)hl_dyn_getp(r5->value,421141695/*window_msaa*/,&t$nul_i32);
	kha_FramebufferOptions_new(r27,r20,r9,r21,r22,r23,r24);
	kha_SystemOptions_new(r16,r17,r8,r13,r18,r27);
	r28 = hl_alloc_closure_ptr(&t$fun_9b04443,armory_system_Starter_main__$2,r0);
...
void armory_system_Starter_main(String r0,int r1,bool r2,bool r3,bool r4,int r5,int r6,int r7,bool r8,vclosure* r9) {
	...
	vclosure *r10;
	int r13;
	r11 = hl_alloc_enum(&t$ctx_7680ad9,0);
	((Enumt$ctx_7680ad9*)r11)->p0 = (String)r0;
	((Enumt$ctx_7680ad9*)r11)->p1 = (int)r1;
	((Enumt$ctx_7680ad9*)r11)->p2 = (bool)r2;
	((Enumt$ctx_7680ad9*)r11)->p3 = (bool)r3;
	((Enumt$ctx_7680ad9*)r11)->p4 = (bool)r4;
	((Enumt$ctx_7680ad9*)r11)->p5 = (int)r5;
	((Enumt$ctx_7680ad9*)r11)->p6 = (int)r6;
	((Enumt$ctx_7680ad9*)r11)->p7 = (int)r7;
	((Enumt$ctx_7680ad9*)r11)->p8 = (bool)r8;
	((Enumt$ctx_7680ad9*)r11)->p9 = (vclosure*)r9;
	r10 = hl_alloc_closure_ptr(&t$fun_8a7a13f,armory_system_Starter_main__$1,r11);
	r13 = 1;
	r14 = (armory__system__$Starter)g$_armory_system_Starter;
	r14->tasks = r13;
	r14 = (armory__system__$Starter)g$_armory_system_Starter;
	r13 = r14->tasks;
	--r13;
