...
extern hl_type t$vrt_c48771a;
extern hl_type t$zui_Zui;
extern hl_type t$vrt_0444150;
...
void armory_trait_internal_CanvasScript_new__$2(venum* r0,kha__Kravur r1) {
	...
	vbyte *r18;
	int r15, r16, r19;
	armory__trait__internal__CanvasScript r8;
	r3 = (haxe__format__JsonParser)hl_alloc_obj(&t$haxe_format_JsonParser);
	r5 = ((Enumt$ctx_6313d79*)r0)->p0;
	if( r5 == NULL ) hl_null_access();
	r4 = kha_internal_BytesBlob_toString(r5);
	haxe_format_JsonParser_new(r3,r4);
	r2 = haxe_format_JsonParser_doParse(r3);
	r7 = hl_to_virtual(&t$vrt_c48771a,(vdynamic*)r2);
	r8 = ((Enumt$ctx_6313d79*)r0)->p1;
	if( r8 == NULL ) hl_null_access();
	r9 = (zui__Zui)hl_alloc_obj(&t$zui_Zui);
	r10 = hl_alloc_virtual(&t$vrt_0444150);
	if( hl_vfields(r10)[0] ) *(kha__Kravur*)(hl_vfields(r10)[0]) = (kha__Kravur)r1; else hl_dyn_setp(r10->value,62938841/*font*/,&t$kha_Kravur,r1);
	r12 = (zui__$Themes)g$_zui_Themes;
	r11 = r12->light;
	if( hl_vfields(r10)[1] ) *(vvirtual**)(hl_vfields(r10)[1]) = (vvirtual*)r11; else hl_dyn_setp(r10->value,260472329/*theme*/,&t$vrt_d94d4d4,r11);
	r13 = hl_to_virtual(&t$vrt_b430bc3,(vdynamic*)r10);
	zui_Zui_new(r9,r13);
	r8->cui = r9;
	if( r7 == NULL ) hl_null_access();
	r14 = hl_vfields(r7)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r7)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r7->value,201542029/*assets*/,&t$hl_types_ArrayObj);
	...
	*(int*)(r18 + r19) = r16;
	...
	label$64f856d_3_50:
	r21 = r14->array;
	r2 = ((vdynamic**)(r21 + 1))[r15];
	r20 = hl_to_virtual(&t$vrt_6bfdb92,(vdynamic*)r2);
	label$64f856d_3_53:
	++r15;
	if( r20 == NULL ) hl_null_access();
	r4 = hl_vfields(r20)[2] ? (*(String*)(hl_vfields(r20)[2])) : (String)hl_dyn_getp(r20->value,150958933/*name*/,&t$String);
	r23 = hl_alloc_enum(&t$ctx_1ecfa50,0);
	((Enumt$ctx_1ecfa50*)r23)->p0 = (vvirtual*)r7;
	r8 = ((Enumt$ctx_6313d79*)r0)->p1;
	((Enumt$ctx_1ecfa50*)r23)->p1 = (armory__trait__internal__CanvasScript)r8;
	((Enumt$ctx_1ecfa50*)r23)->p2 = (hl__types__ArrayBytes_Int)r17;
	((Enumt$ctx_1ecfa50*)r23)->p3 = (vvirtual*)r20;
	r22 = hl_alloc_closure_ptr(&t$fun_d124a3c,armory_trait_internal_CanvasScript_new__$3,r23);
	r24 = NULL;
	r25 = NULL;
	iron_data_Data_getImage(r4,r22,r24,r25);
...
void armory_trait_internal_CanvasScript_new__$1(venum* r0,kha__internal__BytesBlob r1) {
	...
	venum *r5;
	vclosure *r4;
	armory__trait__internal__CanvasScript r6;
	r3 = ((Enumt$ctx_cc7f9ad*)r0)->p0;
	r5 = hl_alloc_enum(&t$ctx_6313d79,0);
	((Enumt$ctx_6313d79*)r5)->p0 = (kha__internal__BytesBlob)r1;
	r6 = ((Enumt$ctx_cc7f9ad*)r0)->p1;
	((Enumt$ctx_6313d79*)r5)->p1 = (armory__trait__internal__CanvasScript)r6;
	r4 = hl_alloc_closure_ptr(&t$fun_8ecbc05,armory_trait_internal_CanvasScript_new__$2,r5);
...
void armory_trait_internal_CanvasScript_new__$4(armory__trait__internal__CanvasScript r0,kha__graphics2__Graphics r1) {
	...
	r14 = hl_to_virtual(&t$vrt_68dcaf9,(vdynamic*)r4);
	label$64f856d_5_34:
	++r8;
	if( r14 == NULL ) hl_null_access();
	r15 = hl_vfields(r14)[2] ? (*(vclosure**)(hl_vfields(r14)[2])) : (vclosure*)hl_dyn_getp(r14->value,201483899/*onEvent*/,&t$fun_7b48b4f);
...
vvirtual* armory_trait_internal_CanvasScript_getElement(armory__trait__internal__CanvasScript r0,String r1) {
	...
	++r2;
	if( r6 == NULL ) hl_null_access();
	r9 = hl_vfields(r6)[12] ? (*(String*)(hl_vfields(r6)[12])) : (String)hl_dyn_getp(r6->value,150958933/*name*/,&t$String);
...
void armory_trait_internal_CanvasScript_setCanvasVisibility(armory__trait__internal__CanvasScript r0,bool r1) {
	...
	r5 = r0->canvas;
	if( r5 == NULL ) hl_null_access();
	r4 = hl_vfields(r5)[1] ? (*(hl__types__ArrayObj*)(hl_vfields(r5)[1])) : (hl__types__ArrayObj)hl_dyn_getp(r5->value,-473680728/*elements*/,&t$hl_types_ArrayObj);
	label$64f856d_9_4:
	if( r4 == NULL ) hl_null_access();
	r6 = r4->length;
	if( r2 >= r6 ) goto label$64f856d_9_20;
	r6 = r4->length;
	if( ((unsigned)r2) < ((unsigned)r6) ) goto label$64f856d_9_12;
	r7 = NULL;
	goto label$64f856d_9_15;
	label$64f856d_9_12:
	r9 = r4->array;
	r8 = ((vdynamic**)(r9 + 1))[r2];
	r7 = hl_to_virtual(&t$vrt_47ee100,(vdynamic*)r8);
	label$64f856d_9_15:
	++r2;
	if( r7 == NULL ) hl_null_access();
	r10 = hl_alloc_dynbool(r1);
	if( hl_vfields(r7)[20] ) *(vdynamic**)(hl_vfields(r7)[20]) = (vdynamic*)r10; else hl_dyn_setp(r7->value,-484149400/*visible*/,&t$nul_bool,r10);
...
zui__Handle armory_trait_internal_CanvasScript_getHandle(armory__trait__internal__CanvasScript r0,String r1) {
	...
	if( r7 == NULL ) hl_null_access();
	r6 = hl_vfields(r7)[11] ? (*(int*)(hl_vfields(r7)[11])) : (int)hl_dyn_geti(r7->value,23515/*id*/,&t$_i32);
...
void armory_trait_internal_CanvasScript_new(armory__trait__internal__CanvasScript r0,String r1,String r2) {
	...
	r10 = hl_alloc_closure_ptr(&t$fun_3559b8d,armory_trait_internal_CanvasScript_new__$4,r0);
