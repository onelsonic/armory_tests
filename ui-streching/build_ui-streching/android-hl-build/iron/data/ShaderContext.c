...
void iron_data_ShaderContext_compile(iron__data__ShaderContext r0,vclosure* r1) {
	...
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r24 = (kha__$Shaders)g$_kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r11);
	r21 = (kha__graphics4__FragmentShader)hl_dyn_castp(&r18,&t$_dyn,&t$kha_graphics4_FragmentShader);
	r3->fragmentShader = r21;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	...
	r20 = (kha__graphics4__VertexShader)hl_dyn_castp(&r18,&t$_dyn,&t$kha_graphics4_VertexShader);
	r3->vertexShader = r20;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	...
	r27 = (kha__graphics4__GeometryShader)hl_dyn_castp(&r18,&t$_dyn,&t$kha_graphics4_GeometryShader);
	...
	r24 = (kha__$Shaders)g$_kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r23);
	r28 = (kha__graphics4__TessellationControlShader)hl_dyn_castp(&r18,&t$_dyn,&t$kha_graphics4_TessellationControlShader);
	...
	r24 = (kha__$Shaders)g$_kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r23);
	r29 = (kha__graphics4__TessellationEvaluationShader)hl_dyn_castp(&r18,&t$_dyn,&t$kha_graphics4_TessellationEvaluationShader);
