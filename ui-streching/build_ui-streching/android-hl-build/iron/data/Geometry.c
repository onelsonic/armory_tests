...
extern String s$nor;
extern String s$tex;
extern String s$tex1;
extern String s$col;
extern String s$tang;
...
kha__graphics4__VertexStructure iron_data_Geometry_getVertexStructure(bool* r0,bool* r1,bool* r2,bool* r3,bool* r4,bool* r5,bool* r6,bool* r7) {
	...
	r15 = *r7;
	label$b7ac406_1_32:
	r16 = (kha__graphics4__VertexStructure)hl_alloc_obj(&t$kha_graphics4_VertexStructure);
...
kha__graphics4__VertexBuffer iron_data_Geometry_get(iron__data__Geometry r0,hl__types__ArrayObj r1) {
	...
	r57 = (haxe__$Log)g$_haxe_Log;
	r56 = r57->trace;
	if( r56 == NULL ) hl_null_access();
	r10 = (String)s$Armory_Warning_Geometry_;
	r11 = r0->name;
	r10 = String___add__(r10,r11);
	r11 = (String)s$_is_missing_UV_map;
	r10 = String___add__(r10,r11);
	r58 = hl_alloc_virtual(&t$vrt_329ffa8);
	r11 = (String)s$Sources_iron_data_Geometry_hx;
	if( hl_vfields(r58)[1] ) *(String*)(hl_vfields(r58)[1]) = (String)r11; else hl_dyn_setp(r58->value,37969014/*fileName*/,&t$String,r11);
	r5 = 271;
	if( hl_vfields(r58)[2] ) *(int*)(hl_vfields(r58)[2]) = (int)r5; else hl_dyn_seti(r58->value,371360620/*lineNumber*/,&t$_i32,r5);
	r11 = (String)s$iron_data_Geometry;
	if( hl_vfields(r58)[0] ) *(String*)(hl_vfields(r58)[0]) = (String)r11; else hl_dyn_setp(r58->value,-63073762/*className*/,&t$String,r11);
	r11 = (String)s$get;
	if( hl_vfields(r58)[3] ) *(String*)(hl_vfields(r58)[3]) = (String)r11; else hl_dyn_setp(r58->value,302979532/*methodName*/,&t$String,r11);
	r59 = hl_to_virtual(&t$vrt_eaa6a3b,(vdynamic*)r58);
	...
	r11 = r0->name;
	r10 = String___add__(r10,r11);
	r11 = (String)s$_is_missing_vertex_colors;
	r10 = String___add__(r10,r11);
	r58 = hl_alloc_virtual(&t$vrt_329ffa8);
	r11 = (String)s$Sources_iron_data_Geometry_hx;
	if( hl_vfields(r58)[1] ) *(String*)(hl_vfields(r58)[1]) = (String)r11; else hl_dyn_setp(r58->value,37969014/*fileName*/,&t$String,r11);
...
void iron_data_Geometry_build(iron__data__Geometry r0) {
	...
	r7 = 4.;
	r4 = r4 / r7;
	r8 = (kha__graphics4__VertexBuffer)hl_alloc_obj(&t$kha_graphics4_VertexBuffer);
	r5 = (int)r4;
	r9 = r0->_struct;
	r10 = r0->usage;
	r11 = NULL;
	...
	r27 = &t$kha_graphics4_IndexBuffer;
	r5 = 0;
	...
	r28 = r25->length;
	if( r5 >= r28 ) goto label$b7ac406_7_105;
	r28 = r25->length;
	...
	label$b7ac406_7_68:
	r32 = (kha__graphics4__IndexBuffer)hl_alloc_obj(&t$kha_graphics4_IndexBuffer);
	r10 = r30->length;
	r28 = r0->usage;
	r12 = NULL;
	...
	r13 = NULL;
	r14 = NULL;
	r31 = kha_graphics4_IndexBuffer_lock(r32,r13,r14);
	r10 = 0;
	if( r31 == NULL ) hl_null_access();
	r28 = r31->length;
	label$b7ac406_7_87:
	if( r10 >= r28 ) goto label$b7ac406_7_98;
	r34 = r10;
	++r10;
	if( r30 == NULL ) hl_null_access();
	r36 = r30->self;
	...
	goto label$b7ac406_7_87;
	label$b7ac406_7_98:
	if( r32 == NULL ) hl_null_access();
	r13 = NULL;
	kha_graphics4_IndexBuffer_unlock(r32,r13);
	r29 = r0->indexBuffers;
	...
	if( !r37 ) goto label$b7ac406_7_124;
	r39 = r0->data;
	if( r39 == NULL ) hl_null_access();
	r38 = r39->raw;
	if( r38 == NULL ) hl_null_access();
