...
void iron_RenderPath_renderFrame(iron__RenderPath r0,vvirtual* r1) {
	...
	r4 = r0->lastW;
	r6 = 0;
	if( r6 >= r4 ) goto label$80733c3_3_25;
	r4 = r0->lastW;
	r5 = NULL;
	r6 = kha_System_windowWidth(r5);
	if( r4 != r6 ) goto label$80733c3_3_24;
	r4 = r0->lastH;
	r5 = NULL;
	r6 = kha_System_windowHeight(r5);
	if( r4 == r6 ) goto label$80733c3_3_25;
	label$80733c3_3_24:
	...
	r10 = r11->camera;
	if( !r10 ) goto label$80733c3_3_47;
	if( r10 == NULL ) hl_null_access();
	r14 = r10->renderTarget;
	if( !r14 ) goto label$80733c3_3_47;
	r3 = true;
	goto label$80733c3_3_48;
	label$80733c3_3_47:
	r3 = false;
	label$80733c3_3_48:
	r0->isProbePlanar = r3;
	if( !r10 ) goto label$80733c3_3_55;
	if( r10 == NULL ) hl_null_access();
	r15 = r10->renderTargetCube;
	if( !r15 ) goto label$80733c3_3_55;
	r3 = true;
	goto label$80733c3_3_56;
	label$80733c3_3_55:
	r3 = false;
	label$80733c3_3_56:
	r0->isProbeCube = r3;
	...
	r0->isProbe = r3;
	r3 = r0->isProbePlanar;
	if( !r3 ) goto label$80733c3_3_73;
	if( r10 == NULL ) hl_null_access();
	r14 = r10->renderTarget;
	if( r14 == NULL ) hl_null_access();
	r16 = kha_Image_get_g4(r14);
	r0->frameG = r16;
	goto label$80733c3_3_82;
	label$80733c3_3_73:
	r3 = r0->isProbeCube;
	if( !r3 ) goto label$80733c3_3_81;
	if( r10 == NULL ) hl_null_access();
	r15 = r10->renderTargetCube;
	...
	r18 = r17->length;
	if( r4 >= r18 ) goto label$80733c3_3_130;
	r18 = r17->length;
	if( ((unsigned)r4) < ((unsigned)r18) ) goto label$80733c3_3_107;
	r19 = NULL;
	goto label$80733c3_3_110;
	label$80733c3_3_107:
	r20 = r17->array;
	...
	r3 = r19->visible;
	if( !r3 ) goto label$80733c3_3_119;
	r12 = (iron__$Scene)g$_iron_Scene;
	r11 = r12->active;
	if( r11 == NULL ) hl_null_access();
	r13 = r11->camera;
	...
	r21 = r22->type;
	r24 = (String)s$sun;
	if( r21 != r24 && (!r21 || !r24 || String___compare(r21,(vdynamic*)r24) != 0) ) goto label$80733c3_3_128;
	r0->sun = r19;
	goto label$80733c3_3_129;
	label$80733c3_3_128:
	r0->point = r19;
	label$80733c3_3_129:
	goto label$80733c3_3_99;
	label$80733c3_3_130:
	r12 = (iron__$Scene)g$_iron_Scene;
	r11 = r12->active;
	if( r11 == NULL ) hl_null_access();
	...
	r4 = 0;
	r6 = r17->length;
	if( ((unsigned)r4) < ((unsigned)r6) ) goto label$80733c3_3_140;
	r19 = NULL;
	goto label$80733c3_3_143;
	label$80733c3_3_140:
	r20 = r17->array;
	r7 = ((vdynamic**)(r20 + 1))[r4];
	r19 = (iron__object__LightObject)r7;
	...
	r3 = r0->isProbe;
	if( r3 ) goto label$80733c3_3_152;
	r4 = r0->frame;
	++r4;
	r0->frame = r4;
	label$80733c3_3_152:
...
void iron_RenderPath_setTarget(iron__RenderPath r0,String r1,hl__types__ArrayObj r2,double* r3) {
	...
	if( hl_vfields(r16)[27] ) ((void (*)(vdynamic*))hl_vfields(r16)[27])(r16->value); else {
		hl_dyn_call_obj(r16->value,&t$fun_4c7a70a,40268564/*disableScissor*/,NULL,NULL);
	}
	r10 = false;
	r0->scissorSet = r10;
	label$80733c3_4_48:
	r16 = r0->currentG;
	if( r16 == NULL ) hl_null_access();
	if( hl_vfields(r16)[24] ) ((void (*)(vdynamic*))hl_vfields(r16)[24])(r16->value); else {
		hl_dyn_call_obj(r16->value,&t$fun_4c7a70a,5047259/*end*/,NULL,NULL);
	}
	r16 = NULL;
	r0->currentG = r16;
	r17 = NULL;
	...
	if( r15 == NULL ) hl_null_access();
	r17 = NULL;
	if( hl_vfields(r15)[30] ) ((void (*)(vdynamic*,hl__types__ArrayObj))hl_vfields(r15)[30])(r15->value,r17); else {
		void *args[] = {r17};
...
void iron_RenderPath_clearTarget(iron__RenderPath r0,vdynamic* r1,vdynamic* r2) {
	...
	r6 = NULL;
	if( hl_vfields(r20)[28] ) ((void (*)(vdynamic*,vdynamic*,vdynamic*,vdynamic*))hl_vfields(r20)[28])(r20->value,r1,r2,r6); else {
		void *args[] = {r1,r2,r6};
		hl_dyn_call_obj(r20->value,&t$fun_5967954,140210839/*clear*/,args,NULL);
	}
	return;
}
...
void iron_RenderPath_drawMeshes(iron__RenderPath r0,String r1) {
	...
	if( hl_vfields(r18)[27] ) ((void (*)(vdynamic*))hl_vfields(r18)[27])(r18->value); else {
		hl_dyn_call_obj(r18->value,&t$fun_4c7a70a,40268564/*disableScissor*/,NULL,NULL);
	}
	r17 = false;
	r0->scissorSet = r17;
	label$80733c3_13_55:
	r18 = r0->currentG;
	if( r18 == NULL ) hl_null_access();
	if( hl_vfields(r18)[24] ) ((void (*)(vdynamic*))hl_vfields(r18)[24])(r18->value); else {
		hl_dyn_call_obj(r18->value,&t$fun_4c7a70a,5047259/*end*/,NULL,NULL);
	}
	r18 = NULL;
	r0->currentG = r18;
	r19 = NULL;
...
void iron_RenderPath_loadShader__$1(venum* r0,iron__data__ShaderData r1) {
	...
	varray *r9;
	int r5, r6;
	r2 = ((Enumt$ctx_a363d40*)r0)->p0;
	if( r2 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r4 = ((Enumt$ctx_a363d40*)r0)->p1;
	if( r4 == NULL ) hl_null_access();
	r5 = 2;
	r6 = r4->length;
...
void iron_RenderPath_loadShader(iron__RenderPath r0,String r1) {
	...
	return;
	label$80733c3_18_12:
	r9 = (iron__CachedShaderContext)hl_alloc_obj(&t$iron_CachedShaderContext);
	...
	r11 = (String)r5;
	label$80733c3_18_37:
	r14 = hl_alloc_enum(&t$ctx_a363d40,0);
	((Enumt$ctx_a363d40*)r14)->p0 = (iron__CachedShaderContext)r9;
	((Enumt$ctx_a363d40*)r14)->p1 = (hl__types__ArrayObj)r10;
	((Enumt$ctx_a363d40*)r14)->p2 = (iron__RenderPath)r0;
	r13 = hl_alloc_closure_ptr(&t$fun_0f246dc,iron_RenderPath_loadShader__$1,r14);
	r15 = NULL;
...
void iron_RenderPath_resize(iron__RenderPath r0) {
	...
	vvirtual *r6, *r8, *r10;
	iron__RenderTargetRaw r12;
	bool r9;
	iron__RenderTarget r11, r13, r16, r17;
	vdynamic *r5;
	int *r3;
	int r2, r4;
	r3 = NULL;
	...
	r4 = 0;
	if( r2 == r4 ) goto label$80733c3_19_8;
	r3 = NULL;
	r2 = kha_System_windowHeight(r3);
	r4 = 0;
	if( r2 != r4 ) goto label$80733c3_19_9;
	label$80733c3_19_8:
	return;
	label$80733c3_19_9:
	r7 = r0->renderTargets;
	...
	if( !r9 ) goto label$80733c3_19_71;
	...
	r2 = r12->width;
	r4 = 0;
	if( r4 < r2 ) goto label$80733c3_19_33;
	r14 = r11->depthStencilFrom;
	r15 = (String)s$;
	if( r14 == r15 || (r14 && r15 && String___compare(r14,(vdynamic*)r15) == 0) ) goto label$80733c3_19_33;
	r7 = r0->depthToRenderTarget;
	if( r7 == NULL ) hl_null_access();
	r14 = r11->depthStencilFrom;
	r5 = haxe_ds_StringMap_get(r7,r14);
	r16 = (iron__RenderTarget)r5;
	if( r11 != r16 ) goto label$80733c3_19_34;
	label$80733c3_19_33:
	goto label$80733c3_19_13;
	label$80733c3_19_34:
	r13 = NULL;
	r7 = r0->renderTargets;
	if( r7 == NULL ) hl_null_access();
	...
	if( !r9 ) goto label$80733c3_19_63;
	...
	r2 = r12->width;
	r4 = 0;
	if( r4 < r2 ) goto label$80733c3_19_61;
	r14 = r16->depthStencilFrom;
	r15 = (String)s$;
	if( r14 != r15 && (!r14 || !r15 || String___compare(r14,(vdynamic*)r15) != 0) ) goto label$80733c3_19_61;
	r7 = r0->depthToRenderTarget;
	if( r7 == NULL ) hl_null_access();
	r12 = r16->raw;
	if( r12 == NULL ) hl_null_access();
	r14 = r12->depth_buffer;
	r5 = haxe_ds_StringMap_get(r7,r14);
	r17 = (iron__RenderTarget)r5;
	if( !r17 ) goto label$80733c3_19_62;
	label$80733c3_19_61:
	goto label$80733c3_19_39;
	label$80733c3_19_62:
	r13 = r16;
	label$80733c3_19_63:
	if( !r13 ) goto label$80733c3_19_70;
	if( r11 == NULL ) hl_null_access();
	r18 = r11->image;
	if( r18 == NULL ) hl_null_access();
	if( r13 == NULL ) hl_null_access();
	...
	if( !r9 ) goto label$80733c3_19_94;
	if( hl_vfields(r8)[1] ) r11 = ((iron__RenderTarget (*)(vdynamic*))hl_vfields(r8)[1])(r8->value); else {
		r11 = (iron__RenderTarget)hl_dyn_call_obj(r8->value,&t$fun_c699427,151160317/*next*/,NULL,NULL);
	}
	if( r11 == NULL ) hl_null_access();
	...
	r2 = r12->width;
	r4 = 0;
	if( r2 != r4 ) goto label$80733c3_19_93;
	r18 = r11->image;
	if( r18 == NULL ) hl_null_access();
	kha_Image_unload(r18);
	r12 = r11->raw;
	r2 = r11->depthStencil;
	r18 = iron_RenderPath_createImage(r0,r12,r2);
	r11->image = r18;
	label$80733c3_19_93:
	goto label$80733c3_19_75;
	label$80733c3_19_94:
	r7 = r0->renderTargets;
	if( r7 == NULL ) hl_null_access();
	r6 = haxe_ds_StringMap_iterator(r7);
	...
	if( !r9 ) goto label$80733c3_19_118;
	if( hl_vfields(r8)[1] ) r11 = ((iron__RenderTarget (*)(vdynamic*))hl_vfields(r8)[1])(r8->value); else {
		r11 = (iron__RenderTarget)hl_dyn_call_obj(r8->value,&t$fun_c699427,151160317/*next*/,NULL,NULL);
	}
	if( r11 == NULL ) hl_null_access();
	r14 = r11->depthStencilFrom;
	r15 = (String)s$;
	if( r14 == r15 || (r14 && r15 && String___compare(r14,(vdynamic*)r15) == 0) ) goto label$80733c3_19_117;
	r18 = r11->image;
	if( r18 == NULL ) hl_null_access();
	r7 = r0->depthToRenderTarget;
	if( r7 == NULL ) hl_null_access();
	r14 = r11->depthStencilFrom;
	r5 = haxe_ds_StringMap_get(r7,r14);
	r13 = (iron__RenderTarget)r5;
	if( r13 == NULL ) hl_null_access();
	r19 = r13->image;
	kha_Image_setDepthStencilFrom(r18,r19);
	label$80733c3_19_117:
	goto label$80733c3_19_98;
	label$80733c3_19_118:
	return;
}
