...
void iron_App_update() {
	...
	r9 = r5->lastw;
	r10 = -1;
	if( r9 != r10 ) goto label$8db8d29_3_158;
	r16 = NULL;
	r9 = kha_System_windowWidth(r16);
	r5 = (iron__$App)g$_iron_App;
	r5->lastw = r9;
	r16 = NULL;
	r9 = kha_System_windowHeight(r16);
	r5 = (iron__$App)g$_iron_App;
	r5->lasth = r9;
	label$8db8d29_3_158:
	r5 = (iron__$App)g$_iron_App;
	r9 = r5->lastw;
	r16 = NULL;
	r10 = kha_System_windowWidth(r16);
	if( r9 != r10 ) goto label$8db8d29_3_168;
	r5 = (iron__$App)g$_iron_App;
	r9 = r5->lasth;
	r16 = NULL;
	r10 = kha_System_windowHeight(r16);
	if( r9 == r10 ) goto label$8db8d29_3_191;
	label$8db8d29_3_168:
	r5 = (iron__$App)g$_iron_App;
	r13 = r5->onResize;
	if( !r13 ) goto label$8db8d29_3_176;
	r5 = (iron__$App)g$_iron_App;
	r13 = r5->onResize;
	if( r13 == NULL ) hl_null_access();
	r13->hasValue ? ((void (*)(vdynamic*))r13->fun)((vdynamic*)r13->value) : ((void (*)(void))r13->fun)();
	goto label$8db8d29_3_191;
	label$8db8d29_3_176:
	r2 = (iron__$Scene)g$_iron_Scene;
	r1 = r2->active;
	if( !r1 ) goto label$8db8d29_3_191;
	r2 = (iron__$Scene)g$_iron_Scene;
	r1 = r2->active;
	if( r1 == NULL ) hl_null_access();
	r17 = r1->camera;
	if( !r17 ) goto label$8db8d29_3_191;
	r2 = (iron__$Scene)g$_iron_Scene;
	r1 = r2->active;
	if( r1 == NULL ) hl_null_access();
	r17 = r1->camera;
