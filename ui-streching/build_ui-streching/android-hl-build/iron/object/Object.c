...
iron__object__BoneAnimation iron_object_Object_getParentArmature(iron__object__Object r0,String r1) {
	...
	if( r3 == NULL ) hl_null_access();
	r6 = r3->length;
	if( r2 >= r6 ) goto label$f9f94e9_6_27;
	r6 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r6) ) goto label$f9f94e9_6_13;
	r7 = NULL;
	...
	if( r7 == NULL ) hl_null_access();
	r10 = r7->armature;
	if( !r10 ) goto label$f9f94e9_6_26;
	r10 = r7->armature;
	if( r10 == NULL ) hl_null_access();
	r11 = r10->name;
	if( r11 != r1 && (!r11 || !r1 || String___compare(r11,(vdynamic*)r1) != 0) ) goto label$f9f94e9_6_26;
...
void iron_object_Object_new(iron__object__Object r0) {
	...
	r11 = (iron__object__$Object)g$_iron_object_Object;
	if( r16 == ((hl__Class)r11) ) goto label$f9f94e9_10_54;
	r1 = false;
	goto label$f9f94e9_10_55;
	label$f9f94e9_10_54:
	r1 = true;
	label$f9f94e9_10_55:
	r0->isEmpty = r1;
	r1 = r0->isEmpty;
	if( !r1 ) goto label$f9f94e9_10_67;
	r18 = (iron__$Scene)g$_iron_Scene;
	r17 = r18->active;
	if( !r17 ) goto label$f9f94e9_10_67;
	r18 = (iron__$Scene)g$_iron_Scene;
	r17 = r18->active;
