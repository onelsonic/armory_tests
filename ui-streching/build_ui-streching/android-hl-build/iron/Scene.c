...
void iron_Scene_create__$2(venum* r0,iron__object__Object r1) {
	...
	r10 = (String)s$No_camera_found_for_scene_;
	r12 = ((Enumt$ctx_b88e235*)r0)->p0;
...
void iron_Scene_setActive__$1(vclosure* r0,iron__data__TSceneFormat r1) {
	vclosure *r3;
	r3 = hl_alloc_closure_ptr(&t$fun_faf3c0d,iron_Scene_setActive__$2,r0);
...
void iron_Scene_setActive(String r0,vclosure* r1) {
	...
	label$996775c_7_14:
	r6 = hl_alloc_closure_ptr(&t$fun_1f578c9,iron_Scene_setActive__$1,r1);
...
void iron_Scene_updateFrame(iron__Scene r0) {
	...
	r11 = (iron__system__$Time)g$_iron_system_Time;
	r10 = r11->scale;
	r9 = r9 * r10;
	r12 = (float)r9;
...
iron__object__CameraObject iron_Scene_getCamera(iron__Scene r0,String r1) {
	...
	if( r3 == NULL ) hl_null_access();
	r4 = r3->length;
	if( r2 >= r4 ) goto label$996775c_12_19;
	r4 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r4) ) goto label$996775c_12_10;
	r5 = NULL;
	goto label$996775c_12_13;
	label$996775c_12_10:
	r7 = r3->array;
	r6 = ((vdynamic**)(r7 + 1))[r2];
	...
	if( r5 == NULL ) hl_null_access();
	r8 = r5->name;
	if( r8 != r1 && (!r8 || !r1 || String___compare(r8,(vdynamic*)r1) != 0) ) goto label$996775c_12_18;
	return r5;
	label$996775c_12_18:
	goto label$996775c_12_2;
	label$996775c_12_19:
	r5 = NULL;
	return r5;
}
...
void iron_Scene_addScene__$4(venum* r0,iron__object__Object r1) {
	...
	varray *r8;
	int r4, r5, r13;
	if( !r1 ) goto label$996775c_17_18;
	r3 = ((Enumt$ctx_7165f68*)r0)->p2;
	if( r3 == NULL ) hl_null_access();
	r4 = 0;
	r5 = r3->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$996775c_17_8;
	r6 = NULL;
	...
	r4 = 0;
	r5 = r11->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$996775c_17_24;
	...
	*(int*)(r12 + r5) = r13;
	...
	if( r13 != r4 ) goto label$996775c_17_35;
	r10 = ((Enumt$ctx_7165f68*)r0)->p3;
	if( r10 == NULL ) hl_null_access();
...
void iron_Scene_addScene__$3(venum* r0,iron__object__Object r1,hl__types__ArrayObj r2,iron__data__TObj r3,vclosure* r4) {
	...
	r9 = r2->length;
	label$996775c_18_5:
	if( r8 >= r9 ) goto label$996775c_18_56;
	r10 = r8;
	++r8;
	if( r2 == NULL ) hl_null_access();
	r12 = r2->length;
	if( ((unsigned)r10) < ((unsigned)r12) ) goto label$996775c_18_14;
	r13 = NULL;
	goto label$996775c_18_17;
	label$996775c_18_14:
	r14 = r2->array;
	...
	if( r13 == NULL ) hl_null_access();
	r15 = r13->spawn;
	if( !r15 ) goto label$996775c_18_41;
	r15 = r13->spawn;
	r16 = false;
	r17 = hl_alloc_dynbool(r16);
	if( r15 != r17 && (!r15 || !r17 || (r15->v.b != r17->v.b)) ) goto label$996775c_18_41;
	r18 = ((Enumt$ctx_4df65cd*)r0)->p2;
	if( r18 == NULL ) hl_null_access();
	r11 = 0;
	r12 = r18->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$996775c_18_30;
...
void iron_Scene_addScene__$5(venum* r0) {
	...
	r2 = ((Enumt$ctx_cdff214*)r0)->p1;
	if( r2 == NULL ) hl_null_access();
	r3 = ((Enumt$ctx_cdff214*)r0)->p0;
...
void iron_Scene_addScene__$2(venum* r0) {
	...
	*(int*)(r2 + r5) = r4;
	...
	r7 = ((Enumt$ctx_cdff214*)r0)->p3;
	if( r7 == NULL ) hl_null_access();
	r9 = ((Enumt$ctx_cdff214*)r0)->p2;
	if( r9 == NULL ) hl_null_access();
	r8 = r9->objects;
	r10 = NULL;
	...
	r5 = r8->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$996775c_20_38;
	...
	if( r9 == NULL ) hl_null_access();
	r14 = r9->objects;
	if( !r14 ) goto label$996775c_20_51;
	r9 = ((Enumt$ctx_cdff214*)r0)->p2;
	if( r9 == NULL ) hl_null_access();
	r14 = r9->objects;
	...
	r4 = r14->length;
	r5 = 0;
	if( r4 != r5 ) goto label$996775c_20_56;
	label$996775c_20_51:
	r16 = ((Enumt$ctx_cdff214*)r0)->p1;
	if( r16 == NULL ) hl_null_access();
	r17 = ((Enumt$ctx_cdff214*)r0)->p0;
	r16->hasValue ? ((void (*)(vdynamic*,iron__object__Object))r16->fun)((vdynamic*)r16->value,r17) : ((void (*)(iron__object__Object))r16->fun)(r17);
	goto label$996775c_20_72;
	label$996775c_20_56:
	r4 = 0;
	r5 = r8->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$996775c_20_61;
	r13 = NULL;
	goto label$996775c_20_64;
	label$996775c_20_61:
	r11 = r8->array;
	...
	r14 = r9->objects;
	r19 = NULL;
	r20 = hl_alloc_closure_ptr(&t$fun_3956bee,iron_Scene_addScene__$5,r0);
...
void iron_Scene_addScene__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->traits;
	r4 = ((Enumt$ctx_fbd2a35*)r0)->p0;
	iron_Scene_createTraits(r3,r4);
	r5 = ((Enumt$ctx_fbd2a35*)r0)->p2;
	if( r5 == NULL ) hl_null_access();
	r3 = r1->embedded_datas;
	r7 = hl_alloc_enum(&t$ctx_cdff214,0);
	r4 = ((Enumt$ctx_fbd2a35*)r0)->p0;
	((Enumt$ctx_cdff214*)r7)->p0 = (iron__object__Object)r4;
	r8 = ((Enumt$ctx_fbd2a35*)r0)->p1;
	((Enumt$ctx_cdff214*)r7)->p1 = (vclosure*)r8;
	((Enumt$ctx_cdff214*)r7)->p2 = (iron__data__TSceneFormat)r1;
	r9 = ((Enumt$ctx_fbd2a35*)r0)->p2;
	((Enumt$ctx_cdff214*)r7)->p3 = (iron__Scene)r9;
	r6 = hl_alloc_closure_ptr(&t$fun_3956bee,iron_Scene_addScene__$2,r7);
...
void iron_Scene_addScene(iron__Scene r0,String r1,iron__object__Object r2,vclosure* r3) {
	...
	r5->name = r1;
	label$996775c_22_6:
	r7 = hl_alloc_enum(&t$ctx_fbd2a35,0);
	((Enumt$ctx_fbd2a35*)r7)->p0 = (iron__object__Object)r2;
	((Enumt$ctx_fbd2a35*)r7)->p1 = (vclosure*)r3;
	((Enumt$ctx_fbd2a35*)r7)->p2 = (iron__Scene)r0;
	r6 = hl_alloc_closure_ptr(&t$fun_2dc7f4f,iron_Scene_addScene__$1,r7);
...
int iron_Scene_getObjectsCount(iron__Scene r0,hl__types__ArrayObj r1,bool* r2) {
	...
	varray *r11;
	int r5, r7, r8, r9;
	if( r2 ) goto label$996775c_23_3;
	r3 = true;
	goto label$996775c_23_4;
	label$996775c_23_3:
	r3 = *r2;
	label$996775c_23_4:
	if( r1 ) goto label$996775c_23_7;
	r5 = 0;
	return r5;
	label$996775c_23_7:
	if( r1 == NULL ) hl_null_access();
	...
	if( r1 == NULL ) hl_null_access();
	r9 = r1->length;
	if( r7 >= r9 ) goto label$996775c_23_40;
	r9 = r1->length;
	if( ((unsigned)r7) < ((unsigned)r9) ) goto label$996775c_23_18;
	r10 = NULL;
	goto label$996775c_23_21;
	label$996775c_23_18:
	r11 = r1->array;
	...
	label$996775c_23_21:
	++r7;
	if( !r3 ) goto label$996775c_23_31;
	if( r10 == NULL ) hl_null_access();
	r13 = r10->spawn;
	if( !r13 ) goto label$996775c_23_31;
	r13 = r10->spawn;
	r12 = false;
	r14 = hl_alloc_dynbool(r12);
	if( r13 != r14 && (!r13 || !r14 || (r13->v.b != r14->v.b)) ) goto label$996775c_23_31;
	goto label$996775c_23_10;
	label$996775c_23_31:
	if( r10 == NULL ) hl_null_access();
	r4 = r10->children;
	if( !r4 ) goto label$996775c_23_39;
	r4 = r10->children;
	r2 = NULL;
...
void iron_Scene_spawnObject__$2(venum* r0,iron__object__Object r1) {
	...
	varray *r11;
	int r6, r7, r8;
	r3 = ((Enumt$ctx_162fc66*)r0)->p0;
	if( !r3 ) goto label$996775c_24_37;
	r5 = ((Enumt$ctx_162fc66*)r0)->p4;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->children;
	if( !r4 ) goto label$996775c_24_37;
	r6 = 0;
	r5 = ((Enumt$ctx_162fc66*)r0)->p4;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->children;
	...
	if( r4 == NULL ) hl_null_access();
	r8 = r4->length;
	if( r6 >= r8 ) goto label$996775c_24_37;
	r8 = r4->length;
	if( ((unsigned)r6) < ((unsigned)r8) ) goto label$996775c_24_18;
	r5 = NULL;
	...
	label$996775c_24_21:
	++r6;
	r9 = ((Enumt$ctx_162fc66*)r0)->p3;
	if( r9 == NULL ) hl_null_access();
	r7 = 0;
	r8 = r9->length;
	if( ((unsigned)r7) < ((unsigned)r8) ) goto label$996775c_24_29;
	r12 = NULL;
	...
	label$996775c_24_32:
	if( r12 == NULL ) hl_null_access();
	r13 = ((Enumt$ctx_162fc66*)r0)->p4;
	r14 = ((Enumt$ctx_162fc66*)r0)->p5;
	...
	label$996775c_24_37:
	r15 = ((Enumt$ctx_162fc66*)r0)->p1;
	if( r15 == NULL ) hl_null_access();
	r6 = 0;
	r7 = r15->length;
	if( ((unsigned)r6) < ((unsigned)r7) ) goto label$996775c_24_43;
	...
	++r8;
	*(int*)(r16 + r7) = r8;
	r6 = ((Enumt$ctx_162fc66*)r0)->p2;
	if( r8 != r6 ) goto label$996775c_24_56;
	r14 = ((Enumt$ctx_162fc66*)r0)->p5;
	if( !r14 ) goto label$996775c_24_56;
	r14 = ((Enumt$ctx_162fc66*)r0)->p5;
	if( r14 == NULL ) hl_null_access();
...
void iron_Scene_spawnObject__$1(venum* r0,iron__data__TObj r1,iron__object__Object r2,iron__data__TObj r3,vclosure* r4) {
	...
	vclosure *r9;
	int r13;
	r6 = ((Enumt$ctx_5de6072*)r0)->p4;
	if( r6 == NULL ) hl_null_access();
	r8 = ((Enumt$ctx_5de6072*)r0)->p4;
	if( r8 == NULL ) hl_null_access();
	r7 = r8->raw;
	r10 = hl_alloc_enum(&t$ctx_162fc66,0);
	r11 = ((Enumt$ctx_5de6072*)r0)->p0;
	((Enumt$ctx_162fc66*)r10)->p0 = (bool)r11;
	r12 = ((Enumt$ctx_5de6072*)r0)->p1;
	((Enumt$ctx_162fc66*)r10)->p1 = (hl__types__ArrayBytes_Int)r12;
	r13 = ((Enumt$ctx_5de6072*)r0)->p2;
	((Enumt$ctx_162fc66*)r10)->p2 = (int)r13;
	r14 = ((Enumt$ctx_5de6072*)r0)->p3;
	((Enumt$ctx_162fc66*)r10)->p3 = (hl__types__ArrayObj)r14;
	((Enumt$ctx_162fc66*)r10)->p4 = (iron__data__TObj)r1;
	((Enumt$ctx_162fc66*)r10)->p5 = (vclosure*)r4;
	r9 = hl_alloc_closure_ptr(&t$fun_8ffff2e,iron_Scene_spawnObject__$2,r10);
...
void iron_Scene_spawnObject(iron__Scene r0,String r1,iron__object__Object r2,vclosure* r3,bool* r4) {
	...
	int r9, r10, r11;
	vbyte *r8;
	if( r4 ) goto label$996775c_26_3;
	r5 = true;
	goto label$996775c_26_4;
	label$996775c_26_3:
	r5 = *r4;
	label$996775c_26_4:
	r9 = 4;
	...
	*(int*)(r8 + r11) = r10;
	...
	if( !r5 ) goto label$996775c_26_27;
	r17 = &t$iron_data_TObj;
	r9 = 1;
	...
	if( r15 == NULL ) hl_null_access();
	r10 = 0;
	r19 = hl_alloc_enum(&t$ctx_5de6072,0);
	((Enumt$ctx_5de6072*)r19)->p0 = (bool)r5;
	((Enumt$ctx_5de6072*)r19)->p1 = (hl__types__ArrayBytes_Int)r7;
	((Enumt$ctx_5de6072*)r19)->p2 = (int)r9;
	((Enumt$ctx_5de6072*)r19)->p3 = (hl__types__ArrayObj)r15;
	((Enumt$ctx_5de6072*)r19)->p4 = (iron__Scene)r0;
	r18 = hl_alloc_closure_ptr(&t$fun_033c1e3,iron_Scene_spawnObject__$1,r19);
	r11 = r15->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$996775c_26_47;
	...
	r10 = 0;
	r11 = r15->length;
	if( ((unsigned)r10) < ((unsigned)r11) ) goto label$996775c_26_54;
	r18 = NULL;
...
iron__data__TObj iron_Scene_traverseObjs(hl__types__ArrayObj r0,String r1) {
	...
	if( r0 == NULL ) hl_null_access();
	r3 = r0->length;
	if( r2 >= r3 ) goto label$996775c_28_24;
	r3 = r0->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$996775c_28_9;
	r5 = NULL;
	goto label$996775c_28_12;
	label$996775c_28_9:
	r7 = r0->array;
	r6 = ((vdynamic**)(r7 + 1))[r2];
	...
	if( r5 == NULL ) hl_null_access();
	r8 = r5->name;
	if( r8 != r1 && (!r8 || !r1 || String___compare(r8,(vdynamic*)r1) != 0) ) goto label$996775c_28_17;
	return r5;
	label$996775c_28_17:
	r4 = r5->children;
	if( !r4 ) goto label$996775c_28_23;
	r4 = r5->children;
	r9 = iron_Scene_traverseObjs(r4,r1);
	if( !r9 ) goto label$996775c_28_23;
	return r9;
	label$996775c_28_23:
	goto label$996775c_28_1;
	label$996775c_28_24:
	r5 = NULL;
	return r5;
}
...
void iron_Scene_createObject__$4(venum* r0,iron__data__TSceneFormat r1) {
	...
	varray *r12;
	int r2, r5, r9;
	r3 = ((Enumt$ctx_08ff263*)r0)->p9;
	if( r3 == NULL ) hl_null_access();
	r2 = hl_types_ArrayObj_push(r3,((vdynamic*)r1));
	r3 = ((Enumt$ctx_08ff263*)r0)->p9;
	if( r3 == NULL ) hl_null_access();
	r2 = r3->length;
	r6 = ((Enumt$ctx_08ff263*)r0)->p2;
	if( r6 == NULL ) hl_null_access();
	r3 = r6->bone_actions;
	if( r3 == NULL ) hl_null_access();
	r5 = r3->length;
	if( r2 != r5 ) goto label$996775c_31_101;
	r7 = NULL;
	r2 = 0;
	r8 = ((Enumt$ctx_08ff263*)r0)->p5;
	if( r8 == NULL ) hl_null_access();
	r3 = r8->armatures;
	label$996775c_31_17:
	if( r3 == NULL ) hl_null_access();
	r9 = r3->length;
	if( r2 >= r9 ) goto label$996775c_31_38;
	r9 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r9) ) goto label$996775c_31_25;
	r10 = NULL;
	goto label$996775c_31_28;
	label$996775c_31_25:
	r12 = r3->array;
	...
	if( r10 == NULL ) hl_null_access();
	r5 = r10->uid;
	r13 = ((Enumt$ctx_08ff263*)r0)->p1;
	if( r13 == NULL ) hl_null_access();
	r9 = r13->uid;
	if( r5 != r9 ) goto label$996775c_31_37;
	r7 = r10;
	goto label$996775c_31_38;
	label$996775c_31_37:
	goto label$996775c_31_17;
	label$996775c_31_38:
	if( r7 ) goto label$996775c_31_91;
	r2 = 0;
	r8 = ((Enumt$ctx_08ff263*)r0)->p5;
	if( r8 == NULL ) hl_null_access();
	r3 = r8->armatures;
	...
	if( r3 == NULL ) hl_null_access();
	r9 = r3->length;
	if( r2 >= r9 ) goto label$996775c_31_76;
	r9 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r9) ) goto label$996775c_31_51;
	r10 = NULL;
	goto label$996775c_31_54;
	label$996775c_31_51:
	r12 = r3->array;
	r11 = ((vdynamic**)(r12 + 1))[r2];
	r10 = (iron__data__Armature)r11;
	...
	if( r13 == NULL ) hl_null_access();
	r15 = r13->name;
	if( r14 != r15 && (!r14 || !r15 || String___compare(r14,(vdynamic*)r15) != 0) ) goto label$996775c_31_75;
	r13 = ((Enumt$ctx_08ff263*)r0)->p1;
	if( r13 == NULL ) hl_null_access();
	r14 = r13->name;
	r15 = (String)s$5058f1a;
	r16 = ((Enumt$ctx_08ff263*)r0)->p1;
	if( r16 == NULL ) hl_null_access();
	r5 = r16->uid;
	r17 = &r5;
	r18 = hl_itos(r5,r17);
	...
	r13->name = r14;
	goto label$996775c_31_76;
	label$996775c_31_75:
	goto label$996775c_31_43;
	label$996775c_31_76:
	...
	r8 = ((Enumt$ctx_08ff263*)r0)->p5;
	if( r8 == NULL ) hl_null_access();
	r14 = ((Enumt$ctx_08ff263*)r0)->p7;
	r15 = ((Enumt$ctx_08ff263*)r0)->p8;
	r19 = ((Enumt$ctx_08ff263*)r0)->p4;
	r3 = ((Enumt$ctx_08ff263*)r0)->p6;
	r13 = ((Enumt$ctx_08ff263*)r0)->p1;
	r6 = ((Enumt$ctx_08ff263*)r0)->p0;
	r20 = ((Enumt$ctx_08ff263*)r0)->p3;
	iron_Scene_returnMeshObject(r8,r14,r15,r19,r7,r3,r13,r6,r20);
	label$996775c_31_101:
	return;
}
...
void iron_Scene_createObject__$3(venum* r0,iron__data__MaterialData r1) {
	...
	varray *r6;
	int r3, r4, r9;
	r2 = ((Enumt$ctx_a0cb5a1*)r0)->p6;
	if( r2 == NULL ) hl_null_access();
	r3 = ((Enumt$ctx_a0cb5a1*)r0)->p8;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_32_6;
	hl_types_ArrayObj___expand(r2,r3);
	label$996775c_32_6:
	r6 = r2->array;
	((iron__data__MaterialData*)(r6 + 1))[r3] = r1;
	r7 = ((Enumt$ctx_a0cb5a1*)r0)->p7;
	if( r7 == NULL ) hl_null_access();
	r3 = 0;
	r4 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_32_14;
	...
	*(int*)(r8 + r4) = r9;
	...
	r3 = 0;
	r4 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_32_27;
	r3 = 0;
	goto label$996775c_32_31;
	label$996775c_32_27:
	r8 = r7->bytes;
	r4 = 2;
	r4 = r3 << r4;
	r3 = *(int*)(r8 + r4);
	label$996775c_32_31:
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p0;
	if( r10 == NULL ) hl_null_access();
	r2 = r10->material_refs;
	if( r2 == NULL ) hl_null_access();
	r4 = r2->length;
	if( r3 != r4 ) goto label$996775c_32_131;
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p0;
	if( r10 == NULL ) hl_null_access();
	r11 = r10->data_ref;
	if( r11 == NULL ) hl_null_access();
	...
	r3 = r2->length;
	r4 = 2;
	if( r3 != r4 ) goto label$996775c_32_68;
	r3 = 0;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_32_54;
	r14 = NULL;
	goto label$996775c_32_57;
	label$996775c_32_54:
	r6 = r2->array;
	...
	r3 = 1;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_32_63;
	r14 = NULL;
	goto label$996775c_32_66;
	label$996775c_32_63:
	r6 = r2->array;
	r15 = ((vdynamic**)(r6 + 1))[r3];
	r14 = (String)r15;
	label$996775c_32_66:
	r12 = r14;
	goto label$996775c_32_74;
	label$996775c_32_68:
	r14 = ((Enumt$ctx_a0cb5a1*)r0)->p4;
	r11 = r14;
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p0;
	if( r10 == NULL ) hl_null_access();
	r14 = r10->data_ref;
	r12 = r14;
	label$996775c_32_74:
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p2;
	if( !r10 ) goto label$996775c_32_122;
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p2;
	if( r10 == NULL ) hl_null_access();
	r13 = r10->bone_actions;
	if( !r13 ) goto label$996775c_32_122;
	r16 = &t$iron_data_TSceneFormat;
	r3 = 0;
	...
	if( r17 == NULL ) hl_null_access();
	r9 = r17->length;
	if( r3 >= r9 ) goto label$996775c_32_121;
	r9 = r17->length;
	if( ((unsigned)r3) < ((unsigned)r9) ) goto label$996775c_32_96;
	r14 = NULL;
	goto label$996775c_32_99;
	label$996775c_32_96:
	r6 = r17->array;
	r15 = ((vdynamic**)(r6 + 1))[r3];
	r14 = (String)r15;
	label$996775c_32_99:
	++r3;
	r20 = hl_alloc_enum(&t$ctx_08ff263,0);
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p0;
	((Enumt$ctx_08ff263*)r20)->p0 = (iron__data__TObj)r10;
	r21 = ((Enumt$ctx_a0cb5a1*)r0)->p1;
	((Enumt$ctx_08ff263*)r20)->p1 = (iron__object__Object)r21;
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p2;
	((Enumt$ctx_08ff263*)r20)->p2 = (iron__data__TObj)r10;
	r22 = ((Enumt$ctx_a0cb5a1*)r0)->p3;
	((Enumt$ctx_08ff263*)r20)->p3 = (vclosure*)r22;
	r23 = ((Enumt$ctx_a0cb5a1*)r0)->p4;
	((Enumt$ctx_08ff263*)r20)->p4 = (String)r23;
	r24 = ((Enumt$ctx_a0cb5a1*)r0)->p5;
	((Enumt$ctx_08ff263*)r20)->p5 = (iron__Scene)r24;
	r18 = ((Enumt$ctx_a0cb5a1*)r0)->p6;
	((Enumt$ctx_08ff263*)r20)->p6 = (hl__types__ArrayObj)r18;
	((Enumt$ctx_08ff263*)r20)->p7 = (String)r11;
	((Enumt$ctx_08ff263*)r20)->p8 = (String)r12;
	((Enumt$ctx_08ff263*)r20)->p9 = (hl__types__ArrayObj)r13;
	r19 = hl_alloc_closure_ptr(&t$fun_de865c1,iron_Scene_createObject__$4,r20);
	iron_data_Data_getSceneRaw(r14,r19);
	goto label$996775c_32_88;
	label$996775c_32_121:
	goto label$996775c_32_131;
	label$996775c_32_122:
	r24 = ((Enumt$ctx_a0cb5a1*)r0)->p5;
	if( r24 == NULL ) hl_null_access();
	r23 = ((Enumt$ctx_a0cb5a1*)r0)->p4;
	r25 = NULL;
	r13 = ((Enumt$ctx_a0cb5a1*)r0)->p6;
	r21 = ((Enumt$ctx_a0cb5a1*)r0)->p1;
	r10 = ((Enumt$ctx_a0cb5a1*)r0)->p0;
	r22 = ((Enumt$ctx_a0cb5a1*)r0)->p3;
	iron_Scene_returnMeshObject(r24,r11,r12,r23,r25,r13,r21,r10,r22);
	label$996775c_32_131:
	return;
}
...
void iron_Scene_createObject__$6(venum* r0,iron__object__Object r1) {
	...
	vbyte *r6;
	int r4, r5, r7;
	r3 = ((Enumt$ctx_a5ec823*)r0)->p2;
	if( r3 == NULL ) hl_null_access();
	r4 = 0;
	r5 = r3->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$996775c_33_6;
	...
	++r7;
	*(int*)(r6 + r5) = r7;
	r8 = ((Enumt$ctx_a5ec823*)r0)->p3;
	if( r8 == NULL ) hl_null_access();
	r4 = r8->length;
	if( r7 != r4 ) goto label$996775c_33_20;
	r9 = ((Enumt$ctx_a5ec823*)r0)->p0;
	if( r9 == NULL ) hl_null_access();
	r10 = ((Enumt$ctx_a5ec823*)r0)->p1;
...
void iron_Scene_createObject__$5(venum* r0,iron__object__Object r1) {
	...
	int r7, r8, r9;
	vbyte *r6;
	r4 = ((Enumt$ctx_1b2e85d*)r0)->p0;
	if( r4 == NULL ) hl_null_access();
	r3 = r4->group_ref;
	if( !r3 ) goto label$996775c_34_54;
	r7 = 4;
	...
	*(int*)(r6 + r9) = r8;
	...
	r7 = r10->length;
	r8 = 0;
	if( r7 != r8 ) goto label$996775c_34_28;
	r12 = ((Enumt$ctx_1b2e85d*)r0)->p1;
	if( r12 == NULL ) hl_null_access();
	r12->hasValue ? ((void (*)(vdynamic*,iron__object__Object))r12->fun)((vdynamic*)r12->value,r1) : ((void (*)(iron__object__Object))r12->fun)(r1);
	goto label$996775c_34_53;
	label$996775c_34_28:
	r7 = 0;
	label$996775c_34_29:
	if( r10 == NULL ) hl_null_access();
	r9 = r10->length;
	if( r7 >= r9 ) goto label$996775c_34_53;
	r9 = r10->length;
	if( ((unsigned)r7) < ((unsigned)r9) ) goto label$996775c_34_37;
	r3 = NULL;
	goto label$996775c_34_40;
	label$996775c_34_37:
	r14 = r10->array;
	...
	r11 = ((Enumt$ctx_1b2e85d*)r0)->p2;
	if( r11 == NULL ) hl_null_access();
	r15 = hl_alloc_enum(&t$ctx_a5ec823,0);
	r12 = ((Enumt$ctx_1b2e85d*)r0)->p1;
	((Enumt$ctx_a5ec823*)r15)->p0 = (vclosure*)r12;
	((Enumt$ctx_a5ec823*)r15)->p1 = (iron__object__Object)r1;
	((Enumt$ctx_a5ec823*)r15)->p2 = (hl__types__ArrayBytes_Int)r5;
	((Enumt$ctx_a5ec823*)r15)->p3 = (hl__types__ArrayObj)r10;
	r12 = hl_alloc_closure_ptr(&t$fun_2e84d18,iron_Scene_createObject__$6,r15);
	r16 = NULL;
	iron_Scene_spawnObject(r11,r3,r1,r12,r16);
	goto label$996775c_34_29;
	label$996775c_34_53:
	goto label$996775c_34_57;
	label$996775c_34_54:
	r12 = ((Enumt$ctx_1b2e85d*)r0)->p1;
	if( r12 == NULL ) hl_null_access();
	r12->hasValue ? ((void (*)(vdynamic*,iron__object__Object))r12->fun)((vdynamic*)r12->value,r1) : ((void (*)(iron__object__Object))r12->fun)(r1);
...
void iron_Scene_createObject(iron__Scene r0,iron__data__TObj r1,iron__data__TSceneFormat r2,iron__object__Object r3,iron__data__TObj r4,vclosure* r5) {
	...
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$996775c_35_16;
	r10 = r1->data_ref;
	...
	goto label$996775c_35_126;
	label$996775c_35_16:
	r9 = r1->type;
	r10 = (String)s$light_object;
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$996775c_35_28;
	r10 = r1->data_ref;
	r12 = hl_alloc_enum(&t$ctx_a119f26,0);
	((Enumt$ctx_a119f26*)r12)->p0 = (iron__data__TObj)r1;
	((Enumt$ctx_a119f26*)r12)->p1 = (iron__object__Object)r3;
	...
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$996775c_35_103;
	r14 = r1->material_refs;
	if( !r14 ) goto label$996775c_35_38;
	r14 = r1->material_refs;
	if( r14 == NULL ) hl_null_access();
	r15 = r14->length;
	r16 = 0;
	if( r15 != r16 ) goto label$996775c_35_41;
	label$996775c_35_38:
	r17 = iron_Scene_addObject(r0,r3);
	iron_Scene_returnObject(r0,r17,r1,r5);
	goto label$996775c_35_102;
	label$996775c_35_41:
	r14 = r1->material_refs;
	if( r14 == NULL ) hl_null_access();
	r15 = r14->length;
	...
	r21 = 0;
	if( r21 >= r15 ) goto label$996775c_35_60;
	if( r14 == NULL ) hl_null_access();
	r21 = 1;
	r16 = r15 - r21;
	r23 = NULL;
	...
	r21 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r21) ) goto label$996775c_35_58;
	...
	*(int*)(r26 + r27) = r21;
	...
	r21 = r28->length;
	label$996775c_35_75:
	if( r16 >= r21 ) goto label$996775c_35_102;
	r27 = r16;
	++r16;
	if( r1 == NULL ) hl_null_access();
	r28 = r1->material_refs;
	if( r28 == NULL ) hl_null_access();
	r29 = r28->length;
	if( ((unsigned)r27) < ((unsigned)r29) ) goto label$996775c_35_86;
	r9 = NULL;
	goto label$996775c_35_89;
	label$996775c_35_86:
	r19 = r28->array;
	r23 = ((vdynamic**)(r19 + 1))[r27];
	r9 = (String)r23;
	label$996775c_35_89:
	r31 = hl_alloc_enum(&t$ctx_a0cb5a1,0);
	((Enumt$ctx_a0cb5a1*)r31)->p0 = (iron__data__TObj)r1;
	((Enumt$ctx_a0cb5a1*)r31)->p1 = (iron__object__Object)r3;
	((Enumt$ctx_a0cb5a1*)r31)->p2 = (iron__data__TObj)r4;
	((Enumt$ctx_a0cb5a1*)r31)->p3 = (vclosure*)r5;
	((Enumt$ctx_a0cb5a1*)r31)->p4 = (String)r8;
	((Enumt$ctx_a0cb5a1*)r31)->p5 = (iron__Scene)r6;
	((Enumt$ctx_a0cb5a1*)r31)->p6 = (hl__types__ArrayObj)r22;
	((Enumt$ctx_a0cb5a1*)r31)->p7 = (hl__types__ArrayBytes_Int)r25;
	((Enumt$ctx_a0cb5a1*)r31)->p8 = (int)r27;
	r30 = hl_alloc_closure_ptr(&t$fun_5027319,iron_Scene_createObject__$3,r31);
	iron_data_Data_getMaterial(r8,r9,r30);
	goto label$996775c_35_75;
	label$996775c_35_102:
	goto label$996775c_35_126;
	label$996775c_35_103:
	r9 = r1->type;
	r10 = (String)s$speaker_object;
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$996775c_35_112;
	...
	goto label$996775c_35_126;
	label$996775c_35_112:
	r9 = r1->type;
	r10 = (String)s$object;
	if( r9 != r10 && (!r9 || !r10 || String___compare(r9,(vdynamic*)r10) != 0) ) goto label$996775c_35_123;
	r17 = iron_Scene_addObject(r0,r3);
	r34 = hl_alloc_enum(&t$ctx_1b2e85d,0);
	((Enumt$ctx_1b2e85d*)r34)->p0 = (iron__data__TObj)r1;
	((Enumt$ctx_1b2e85d*)r34)->p1 = (vclosure*)r5;
	((Enumt$ctx_1b2e85d*)r34)->p2 = (iron__Scene)r0;
	r18 = hl_alloc_closure_ptr(&t$fun_f2147dc,iron_Scene_createObject__$5,r34);
	iron_Scene_returnObject(r0,r17,r1,r18);
	goto label$996775c_35_126;
	label$996775c_35_123:
	if( r5 == NULL ) hl_null_access();
	r17 = NULL;
	r5->hasValue ? ((void (*)(vdynamic*,iron__object__Object))r5->fun)((vdynamic*)r5->value,r17) : ((void (*)(iron__object__Object))r5->fun)(r17);
	label$996775c_35_126:
	return;
}
...
hl__types__ArrayObj iron_Scene_getGroupObjectRefs(iron__Scene r0,String r1) {
	...
	if( r3 == NULL ) hl_null_access();
	r5 = r3->length;
	if( r2 >= r5 ) goto label$996775c_36_22;
	r5 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r5) ) goto label$996775c_36_12;
	r7 = NULL;
	goto label$996775c_36_15;
	label$996775c_36_12:
	r9 = r3->array;
	r8 = ((vdynamic**)(r9 + 1))[r2];
	...
	if( r7 == NULL ) hl_null_access();
	r10 = r7->name;
	if( r10 != r1 && (!r10 || !r1 || String___compare(r10,(vdynamic*)r1) != 0) ) goto label$996775c_36_21;
	r6 = r7->object_refs;
	return r6;
	label$996775c_36_21:
	goto label$996775c_36_4;
	label$996775c_36_22:
	r3 = NULL;
	return r3;
}
...
void iron_Scene_returnMeshObject__$1(venum* r0,iron__data__MeshData r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->isSkinned;
	if( !r3 ) goto label$996775c_37_16;
	r4 = r1->geom;
	r5 = ((Enumt$ctx_4787021*)r0)->p1;
	if( !r5 ) goto label$996775c_37_10;
	if( r4 == NULL ) hl_null_access();
	r5 = ((Enumt$ctx_4787021*)r0)->p1;
	iron_data_Geometry_addArmature(r4,r5);
	goto label$996775c_37_16;
	label$996775c_37_10:
	if( r4 == NULL ) hl_null_access();
	r7 = r1->format;
	if( r7 == NULL ) hl_null_access();
	...
	if( !r6 ) goto label$996775c_37_45;
	r13 = 0;
	r12 = ((Enumt$ctx_4787021*)r0)->p4;
	if( r12 == NULL ) hl_null_access();
	r6 = r12->particle_refs;
	...
	if( r6 == NULL ) hl_null_access();
	r14 = r6->length;
	if( r13 >= r14 ) goto label$996775c_37_45;
	r14 = r6->length;
	if( ((unsigned)r13) < ((unsigned)r14) ) goto label$996775c_37_37;
	r15 = NULL;
	goto label$996775c_37_40;
	label$996775c_37_37:
	r17 = r6->array;
	...
	goto label$996775c_37_29;
	label$996775c_37_45:
	r12 = ((Enumt$ctx_4787021*)r0)->p4;
	if( r12 == NULL ) hl_null_access();
	r8 = r12->tilesheet_ref;
	if( !r8 ) goto label$996775c_37_58;
	if( r9 == NULL ) hl_null_access();
	r8 = ((Enumt$ctx_4787021*)r0)->p0;
	r12 = ((Enumt$ctx_4787021*)r0)->p4;
	if( r12 == NULL ) hl_null_access();
...
void iron_Scene_returnMeshObject(iron__Scene r0,String r1,String r2,String r3,iron__data__Armature r4,hl__types__ArrayObj r5,iron__object__Object r6,iron__data__TObj r7,vclosure* r8) {
	venum *r11;
	vclosure *r10;
	r11 = hl_alloc_enum(&t$ctx_4787021,0);
	((Enumt$ctx_4787021*)r11)->p0 = (String)r3;
	((Enumt$ctx_4787021*)r11)->p1 = (iron__data__Armature)r4;
	((Enumt$ctx_4787021*)r11)->p2 = (hl__types__ArrayObj)r5;
	((Enumt$ctx_4787021*)r11)->p3 = (iron__object__Object)r6;
	((Enumt$ctx_4787021*)r11)->p4 = (iron__data__TObj)r7;
	((Enumt$ctx_4787021*)r11)->p5 = (vclosure*)r8;
	((Enumt$ctx_4787021*)r11)->p6 = (iron__Scene)r0;
	r10 = hl_alloc_closure_ptr(&t$fun_72bab18,iron_Scene_returnMeshObject__$1,r11);
...
void iron_Scene_returnObject__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_39_6;
	hl_types_ArrayObj___expand(r2,r3);
	label$996775c_39_6:
	r6 = r2->array;
	...
	r3 = 0;
	r4 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_39_14;
	hl_types_ArrayBytes_Int___expand(r7,r3);
	label$996775c_39_14:
	r8 = r7->bytes;
	r4 = 2;
	...
	*(int*)(r8 + r4) = r9;
	...
	r3 = 0;
	r4 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$996775c_39_27;
	r3 = 0;
	goto label$996775c_39_31;
	label$996775c_39_27:
	r8 = r7->bytes;
	r4 = 2;
	r4 = r3 << r4;
	...
	if( r2 == NULL ) hl_null_access();
	r4 = r2->length;
	if( r3 != r4 ) goto label$996775c_39_44;
...
void iron_Scene_returnObject(iron__Scene r0,iron__object__Object r1,iron__data__TObj r2,vclosure* r3) {
	...
	varray *r7;
	r4 = r0;
	if( !r1 ) goto label$996775c_40_74;
	if( r2 == NULL ) hl_null_access();
	r6 = r2->object_actions;
	if( !r6 ) goto label$996775c_40_74;
	...
	if( r10 == NULL ) hl_null_access();
	r11 = r10->length;
	if( r9 >= r11 ) goto label$996775c_40_20;
	r12 = NULL;
	r9 = hl_types_ArrayObj_push(r6,((vdynamic*)r12));
	goto label$996775c_40_9;
	label$996775c_40_20:
	r9 = 4;
	...
	*(int*)(r14 + r15) = r11;
	...
	r11 = r10->length;
	label$996775c_40_34:
	if( r9 >= r11 ) goto label$996775c_40_73;
	r15 = r9;
	++r9;
	if( r2 == NULL ) hl_null_access();
	r10 = r2->object_actions;
	if( r10 == NULL ) hl_null_access();
	r17 = r10->length;
	if( ((unsigned)r15) < ((unsigned)r17) ) goto label$996775c_40_45;
	r18 = NULL;
	goto label$996775c_40_48;
	label$996775c_40_45:
	r7 = r10->array;
	...
	label$996775c_40_48:
	r20 = (String)s$null;
	if( r18 != r20 && (!r18 || !r20 || String___compare(r18,(vdynamic*)r20) != 0) ) goto label$996775c_40_62;
	if( r13 == NULL ) hl_null_access();
	r16 = 0;
	r17 = r13->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$996775c_40_55;
...
void iron_Scene_returnObjectLoaded(iron__Scene r0,iron__object__Object r1,iron__data__TObj r2,hl__types__ArrayObj r3,vclosure* r4) {
	...
	varray *r16;
	int r12, r13;
	if( !r1 ) goto label$996775c_41_56;
	if( r1 == NULL ) hl_null_access();
	r1->raw = r2;
	if( r2 == NULL ) hl_null_access();
	r6 = r2->name;
	r1->name = r6;
	r7 = r2->visible;
	if( !r7 ) goto label$996775c_41_11;
	r7 = r2->visible;
	r8 = r7 ? r7->v.b : 0;
	r1->visible = r8;
	label$996775c_41_11:
	r7 = r2->visible_mesh;
	if( !r7 ) goto label$996775c_41_16;
	r7 = r2->visible_mesh;
	r8 = r7 ? r7->v.b : 0;
	r1->visibleMesh = r8;
	label$996775c_41_16:
	r7 = r2->visible_shadow;
	if( !r7 ) goto label$996775c_41_21;
	r7 = r2->visible_shadow;
	r8 = r7 ? r7->v.b : 0;
	r1->visibleShadow = r8;
	label$996775c_41_21:
	...
	r9 = r2->properties;
	if( !r9 ) goto label$996775c_41_53;
	...
	if( r9 == NULL ) hl_null_access();
	r13 = r9->length;
	if( r12 >= r13 ) goto label$996775c_41_53;
	r13 = r9->length;
	if( ((unsigned)r12) < ((unsigned)r13) ) goto label$996775c_41_41;
	r14 = NULL;
	goto label$996775c_41_44;
	label$996775c_41_41:
	r16 = r9->array;
...
void iron_Scene_generateTransform(iron__data__TObj r0,iron__object__Transform r1) {
	...
	if( r0 == NULL ) hl_null_access();
	r3 = r0->transform;
	if( !r3 ) goto label$996775c_42_73;
	r3 = r0->transform;
	if( r3 == NULL ) hl_null_access();
	r4 = r3->values;
	r5 = 0;
	...
	r7 = r30->_32;
	r26->z = r7;
	r32 = (iron__math__$Mat4)g$_iron_math_Mat4;
	r29 = r32->helpVec;
	...
	r25 = (double)r48;
	r52 = 0.;
	if( !(r25 < r52) ) goto label$996775c_42_338;
	r48 = r28->x;
	r48 = -r48;
	r28->x = r48;
	label$996775c_42_338:
	r25 = 1.;
	r48 = r28->x;
	r52 = (double)r48;
	r25 = r25 / r52;
	...
	r5 = 0;
	r62 = (float)r5;
	if( !(r62 < r60) ) goto label$996775c_42_524;
	r54 = 0.5;
	r63 = (double)r60;
	r64 = 1.;
	r63 = r63 + r64;
	...
	r61 = (float)r54;
	r27->z = r61;
	goto label$996775c_42_622;
	label$996775c_42_524:
	if( !(r55 < r48) ) goto label$996775c_42_558;
	if( !(r59 < r48) ) goto label$996775c_42_558;
	r54 = 2.;
	r63 = 1.;
	r64 = (double)r48;
	r63 = r63 + r64;
	...
	r27->z = r61;
	goto label$996775c_42_622;
	label$996775c_42_558:
	if( !(r59 < r55) ) goto label$996775c_42_591;
	r54 = 2.;
	r63 = 1.;
	r64 = (double)r55;
	r63 = r63 + r64;
	...
	r61 = (float)r54;
	r27->z = r61;
	label$996775c_42_622:
	r65 = r0->local_only;
	if( !r65 ) goto label$996775c_42_627;
	r65 = r0->local_only;
	r66 = r65 ? r65->v.b : 0;
	r1->localOnly = r66;
	label$996775c_42_627:
	r67 = r1->object;
	if( r67 == NULL ) hl_null_access();
	r67 = r67->parent;
	if( !r67 ) goto label$996775c_42_632;
	iron_object_Transform_update(r1);
	label$996775c_42_632:
	return;
}
...
void iron_Scene_createTraits(hl__types__ArrayObj r0,iron__object__Object r1) {
	...
	if( r0 == NULL ) hl_null_access();
	r7 = r0->length;
	if( r5 >= r7 ) goto label$996775c_43_123;
	r7 = r0->length;
	if( ((unsigned)r5) < ((unsigned)r7) ) goto label$996775c_43_11;
	r8 = NULL;
	goto label$996775c_43_14;
	label$996775c_43_11:
	r9 = r0->array;
	r4 = ((vdynamic**)(r9 + 1))[r5];
	...
	r10 = r8->type;
	r11 = (String)s$Script;
	if( r10 != r11 && (!r10 || !r11 || String___compare(r10,(vdynamic*)r11) != 0) ) goto label$996775c_43_122;
	r13 = &t$_dyn;
	r6 = 0;
	...
	r3 = r8->parameters;
	if( !r3 ) goto label$996775c_43_46;
	r6 = 0;
	r3 = r8->parameters;
	label$996775c_43_30:
	if( r3 == NULL ) hl_null_access();
	r16 = r3->length;
	if( r6 >= r16 ) goto label$996775c_43_46;
	r16 = r3->length;
	if( ((unsigned)r6) < ((unsigned)r16) ) goto label$996775c_43_38;
	r10 = NULL;
	goto label$996775c_43_41;
	label$996775c_43_38:
	r9 = r3->array;
	r4 = ((vdynamic**)(r9 + 1))[r6];
	r10 = (String)r4;
	...
	goto label$996775c_43_30;
	label$996775c_43_46:
	if( r8 == NULL ) hl_null_access();
	r10 = r8->class_name;
	r4 = iron_Scene_createTraitClassInstance(r10,r12);
	r17 = (iron__Trait)hl_dyn_castp(&r4,&t$_dyn,&t$iron_Trait);
	if( r17 ) goto label$996775c_43_76;
	...
	r11 = (String)s$Sources_iron_Scene_hx;
	if( hl_vfields(r20)[1] ) *(String*)(hl_vfields(r20)[1]) = (String)r11; else hl_dyn_setp(r20->value,37969014/*fileName*/,&t$String,r11);
	r6 = 673;
	if( hl_vfields(r20)[2] ) *(int*)(hl_vfields(r20)[2]) = (int)r6; else hl_dyn_seti(r20->value,371360620/*lineNumber*/,&t$_i32,r6);
	r11 = (String)s$iron_Scene;
	if( hl_vfields(r20)[0] ) *(String*)(hl_vfields(r20)[0]) = (String)r11; else hl_dyn_setp(r20->value,-63073762/*className*/,&t$String,r11);
	r11 = (String)s$createTraits;
	if( hl_vfields(r20)[3] ) *(String*)(hl_vfields(r20)[3]) = (String)r11; else hl_dyn_setp(r20->value,302979532/*methodName*/,&t$String,r11);
	...
	goto label$996775c_43_3;
	label$996775c_43_76:
	r3 = r8->props;
	if( !r3 ) goto label$996775c_43_120;
	r6 = 0;
	r3 = r8->props;
	if( r3 == NULL ) hl_null_access();
	r7 = r3->length;
	...
	r7 = (int)r22;
	label$996775c_43_86:
	if( r6 >= r7 ) goto label$996775c_43_120;
	r16 = r6;
	++r6;
	if( r8 == NULL ) hl_null_access();
	r3 = r8->props;
	...
	r24 = r16 * r25;
	r25 = r3->length;
	if( ((unsigned)r24) < ((unsigned)r25) ) goto label$996775c_43_99;
	r10 = NULL;
	goto label$996775c_43_102;
	label$996775c_43_99:
	r9 = r3->array;
	r4 = ((vdynamic**)(r9 + 1))[r24];
	r10 = (String)r4;
	label$996775c_43_102:
	r3 = r8->props;
	if( r3 == NULL ) hl_null_access();
	r25 = 2;
	r24 = r16 * r25;
	...
	r24 = r24 + r25;
	r25 = r3->length;
	if( ((unsigned)r24) < ((unsigned)r25) ) goto label$996775c_43_112;
	r11 = NULL;
	goto label$996775c_43_115;
	label$996775c_43_112:
	r9 = r3->array;
	r4 = ((vdynamic**)(r9 + 1))[r24];
	r11 = (String)r4;
	label$996775c_43_115:
	r26 = (String)s$;
	if( r11 == r26 || (r11 && r26 && String___compare(r11,(vdynamic*)r26) == 0) ) goto label$996775c_43_119;
	r4 = iron_Scene_parseArg(r11);
	Reflect_setProperty(((vdynamic*)r17),r10,r4);
	label$996775c_43_119:
	goto label$996775c_43_86;
	label$996775c_43_120:
	if( r1 == NULL ) hl_null_access();
	iron_object_Object_addTrait(r1,r17);
	label$996775c_43_122:
	goto label$996775c_43_3;
	label$996775c_43_123:
	return;
}
...
vdynamic* iron_Scene_parseArg(String r0) {
	...
	int r5, r12;
	r2 = (String)s$true;
	if( r0 != r2 && (!r0 || !r2 || String___compare(r0,(vdynamic*)r2) != 0) ) goto label$996775c_44_5;
	r3 = true;
	r4 = hl_alloc_dynbool(r3);
	return r4;
	label$996775c_44_5:
	r2 = (String)s$false;
	if( r0 != r2 && (!r0 || !r2 || String___compare(r0,(vdynamic*)r2) != 0) ) goto label$996775c_44_10;
	r3 = false;
	r4 = hl_alloc_dynbool(r3);
	return r4;
	label$996775c_44_10:
	r2 = (String)s$null;
	if( r0 != r2 && (!r0 || !r2 || String___compare(r0,(vdynamic*)r2) != 0) ) goto label$996775c_44_14;
	r4 = NULL;
	return r4;
	label$996775c_44_14:
	if( r0 == NULL ) hl_null_access();
	...
	r2 = (String)s$3590cb8;
	if( r1 != r2 && (!r1 || !r2 || String___compare(r1,(vdynamic*)r2) != 0) ) goto label$996775c_44_23;
	r2 = (String)s$3590cb8;
	r6 = (String)s$;
	...
	r1 = String_charAt(r0,r5);
	r2 = (String)s$b15835f;
	if( r1 != r2 && (!r1 || !r2 || String___compare(r1,(vdynamic*)r2) != 0) ) goto label$996775c_44_31;
	r2 = (String)s$b15835f;
	r6 = (String)s$;
	r1 = StringTools_replace(r0,r2,r6);
	return ((vdynamic*)r1);
	...
	r1 = String_charAt(r0,r5);
	r2 = (String)s$8154172;
	if( r1 != r2 && (!r1 || !r2 || String___compare(r1,(vdynamic*)r2) != 0) ) goto label$996775c_44_75;
	r2 = (String)s$8154172;
	r6 = (String)s$;
	r1 = StringTools_replace(r0,r2,r6);
	r2 = (String)s$0fbd177;
	...
	if( r10 == NULL ) hl_null_access();
	r12 = r10->length;
	if( r5 >= r12 ) goto label$996775c_44_74;
	r12 = r10->length;
	if( ((unsigned)r5) < ((unsigned)r12) ) goto label$996775c_44_64;
	r1 = NULL;
	goto label$996775c_44_67;
	label$996775c_44_64:
	r8 = r10->array;
	...
	r18->v.d = r15;
	if( !r16 ) goto label$996775c_44_83;
	r5 = r16 ? r16->v.i : 0;
	r17 = (double)r5;
	r19 = hl_alloc_dynamic(&t$_f64);
	r19->v.d = r17;
	goto label$996775c_44_84;
	label$996775c_44_83:
	r19 = NULL;
	label$996775c_44_84:
	if( r18 != r19 && (!r18 || !r19 || (r18->v.d != r19->v.d)) ) goto label$996775c_44_86;
	return ((vdynamic*)r16);
	label$996775c_44_86:
...
void iron_Scene_createConstraints(hl__types__ArrayObj r0,iron__object__Object r1) {
	...
	if( r0 == NULL ) hl_null_access();
	r9 = r0->length;
	if( r7 >= r9 ) goto label$996775c_45_28;
	r9 = r0->length;
	if( ((unsigned)r7) < ((unsigned)r9) ) goto label$996775c_45_17;
	r10 = NULL;
	goto label$996775c_45_20;
	label$996775c_45_17:
	r5 = r0->array;
	r4 = ((vdynamic**)(r5 + 1))[r7];
...
void iron_Scene_loadEmbeddedData__$1(venum* r0) {
	...
	r2 = 0;
	r3 = r1->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$996775c_47_6;
	...
	*(int*)(r5 + r3) = r6;
	...
	r2 = 0;
	r3 = r1->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$996775c_47_19;
	r2 = 0;
	goto label$996775c_47_23;
	label$996775c_47_19:
	r5 = r1->bytes;
	r3 = 2;
	r3 = r2 << r3;
	...
	if( r7 == NULL ) hl_null_access();
	r3 = r7->length;
	if( r2 != r3 ) goto label$996775c_47_30;
...
void iron_Scene_loadEmbeddedData(iron__Scene r0,hl__types__ArrayObj r1,vclosure* r2) {
	...
	*(int*)(r7 + r10) = r9;
	...
	if( r1 == NULL ) hl_null_access();
	r10 = r1->length;
	if( r8 >= r10 ) goto label$996775c_48_34;
	r10 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r10) ) goto label$996775c_48_23;
	r11 = NULL;
	goto label$996775c_48_26;
	label$996775c_48_23:
	r12 = r1->array;
...
void iron_Scene_embedData__$1(venum* r0,kha__internal__BytesBlob r1) {
	...
	r13 = ((Enumt$ctx_d0fbc4f*)r0)->p2;
	if( r13 == NULL ) hl_null_access();
	r12 = r13->embedded;
	if( r12 == NULL ) hl_null_access();
	r14 = ((Enumt$ctx_d0fbc4f*)r0)->p0;
	haxe_ds_StringMap_set(r12,r14,((vdynamic*)r8));
	r15 = ((Enumt$ctx_d0fbc4f*)r0)->p1;
	if( r15 == NULL ) hl_null_access();
...
void iron_Scene_embedData(iron__Scene r0,String r1,vclosure* r2) {
	...
	if( !r4 ) goto label$996775c_51_10;
...
void iron_Scene_new(iron__Scene r0) {
	...
	r6 = (iron__$Scene)g$_iron_Scene;
	r9 = r6->global;
	if( r9 ) goto label$996775c_53_80;
	r9 = (iron__object__Object)hl_alloc_obj(&t$iron_object_Object);
	iron_object_Object_new(r9);
	r6 = (iron__$Scene)g$_iron_Scene;
	r6->global = r9;
