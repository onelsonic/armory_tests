...
extern hl_type $t_ui16;
extern hl_type $t_hl_types_ArrayBytes_hl_UI16;
...
int hl_types_ArrayBytes_hl_UI16_sortDyn__$1(vclosure* r0,unsigned short r1,unsigned short r2) {
	vdynamic *r3, *r4;
	int r5;
	r3 = hl_alloc_dynamic(&$t_ui16);
	r3->v.i = r1;
	r4 = hl_alloc_dynamic(&$t_ui16);
	r4->v.i = r2;
...
hl__types__ArrayBytes_hl_UI16 hl_types_ArrayBytes_hl_UI16_concat(hl__types__ArrayBytes_hl_UI16 r0,hl__types__ArrayBytes_hl_UI16 r1) {
	...
	r2 = (hl__types__ArrayBytes_hl_UI16)hl_alloc_obj(&$t_hl_types_ArrayBytes_hl_UI16);
...
void hl_types_ArrayBytes_hl_UI16_blit(hl__types__ArrayBytes_hl_UI16 r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r5 = (hl__types__ArrayBytes_hl_UI16)hl_dyn_castp(&r2,&$t_hl_types_ArrayAccess,&$t_hl_types_ArrayBytes_hl_UI16);
	r8 = 0;
...
hl__types__ArrayBase hl_types_ArrayBytes_hl_UI16_slice(hl__types__ArrayBytes_hl_UI16 r0,int r1,vdynamic* r2) {
	...
	r8 = (hl__types__ArrayBytes_hl_UI16)hl_alloc_obj(&$t_hl_types_ArrayBytes_hl_UI16);
...
void hl_types_ArrayBytes_hl_UI16_sort(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	label$039cf2f_12_9:
	r8 = hl_alloc_closure_ptr(&$t_fun_f38af0d,hl_types_ArrayBytes_hl_UI16_sort__$1,r1);
	label$039cf2f_12_10:
	...
	label$039cf2f_12_18:
	r9 = hl_alloc_closure_ptr(&$t_fun_3193805,hl_types_ArrayBytes_hl_UI16_sort__$2,r1);
	label$039cf2f_12_19:
...
hl__types__ArrayBase hl_types_ArrayBytes_hl_UI16_splice(hl__types__ArrayBytes_hl_UI16 r0,int r1,int r2) {
	...
	r6 = (hl__types__ArrayBytes_hl_UI16)hl_alloc_obj(&$t_hl_types_ArrayBytes_hl_UI16);
...
bool hl_types_ArrayBytes_hl_UI16_remove(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1) {
	...
	r6 = 0;
	if( r2 >= r6 ) goto label$039cf2f_17_6;
	r7 = false;
	return r7;
	label$039cf2f_17_6:
	r5 = r0->length;
...
int hl_types_ArrayBytes_hl_UI16_indexOf(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1,vdynamic* r2) {
	...
	if( r2 ) goto label$039cf2f_18_3;
	r3 = 0;
	goto label$039cf2f_18_4;
	label$039cf2f_18_3:
	r3 = r2 ? r2->v.i : 0;
	label$039cf2f_18_4:
	r5 = 0;
	if( r3 >= r5 ) goto label$039cf2f_18_13;
	r5 = r0->length;
	r4 = r3 + r5;
	r3 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_18_13;
	r4 = 0;
	r3 = r4;
	label$039cf2f_18_13:
	r4 = r3;
	r5 = r0->length;
	label$039cf2f_18_15:
	if( r4 >= r5 ) goto label$039cf2f_18_27;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 1;
	...
	r10 = (int)r7;
	if( r10 != r1 ) goto label$039cf2f_18_26;
	return r6;
	label$039cf2f_18_26:
	goto label$039cf2f_18_15;
	label$039cf2f_18_27:
	r4 = -1;
	return r4;
}
...
int hl_types_ArrayBytes_hl_UI16_lastIndexOf(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1,vdynamic* r2) {
	...
	int r3, r4, r5, r6;
	r3 = r0->length;
	if( !r2 ) goto label$039cf2f_19_4;
	r4 = r2 ? r2->v.i : 0;
	goto label$039cf2f_19_6;
	label$039cf2f_19_4:
	r5 = 1;
	r4 = r3 - r5;
	label$039cf2f_19_6:
	if( r4 < r3 ) goto label$039cf2f_19_11;
	r6 = 1;
	r5 = r3 - r6;
	r4 = r5;
	...
	label$039cf2f_19_11:
	r6 = 0;
	if( r4 >= r6 ) goto label$039cf2f_19_15;
	r5 = r4 + r3;
	r4 = r5;
	label$039cf2f_19_15:
	r6 = 0;
	if( r4 < r6 ) goto label$039cf2f_19_27;
	r7 = r0->bytes;
	r6 = 1;
	r6 = r4 << r6;
	r5 = *(unsigned short*)(r7 + r6);
	r8 = (int)r5;
	if( r8 != r1 ) goto label$039cf2f_19_25;
	return r4;
	label$039cf2f_19_25:
	--r4;
	goto label$039cf2f_19_15;
...
hl__types__ArrayBytes_hl_UI16 hl_types_ArrayBytes_hl_UI16_copy(hl__types__ArrayBytes_hl_UI16 r0) {
	...
	int r3, r6, r10, r11;
	r1 = (hl__types__ArrayBytes_hl_UI16)hl_alloc_obj(&$t_hl_types_ArrayBytes_hl_UI16);
...
vvirtual* hl_types_ArrayBytes_hl_UI16_iterator(hl__types__ArrayBytes_hl_UI16 r0) {
	vvirtual *r3;
	hl__types__BytesIterator_hl_UI16 r1;
	r1 = (hl__types__BytesIterator_hl_UI16)hl_alloc_obj(&$t_hl_types_BytesIterator_hl_UI16);
	hl_types_BytesIterator_hl_UI16_new(r1,r0);
	r3 = hl_to_virtual(&$t_vrt_7931cce,(vdynamic*)r1);
	return r3;
}
...
hl__types__ArrayDyn hl_types_ArrayBytes_hl_UI16_map(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	r4 = r0->length;
	r5 = 0;
	if( r5 >= r4 ) goto label$039cf2f_22_9;
	r4 = r0->length;
	r5 = 1;
	r4 = r4 - r5;
	...
	r5 = r0->length;
	label$039cf2f_22_11:
	if( r4 >= r5 ) goto label$039cf2f_22_26;
	r6 = r4;
	++r4;
	if( r2 == NULL ) hl_null_access();
	r8 = r2->array;
...
hl__types__ArrayBytes_hl_UI16 hl_types_ArrayBytes_hl_UI16_filter(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	r5 = r0->length;
	label$039cf2f_23_4:
	if( r4 >= r5 ) goto label$039cf2f_23_19;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 1;
	...
	if( !r11 ) goto label$039cf2f_23_18;
	if( r2 == NULL ) hl_null_access();
	r7 = hl_types_ArrayBytes_hl_UI16_push(r2,r10);
	label$039cf2f_23_18:
	goto label$039cf2f_23_4;
	label$039cf2f_23_19:
	return r2;
}
...
void hl_types_ArrayBytes_hl_UI16_resize(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	int r3, r4, r8, r9;
	r3 = r0->length;
	if( r3 >= r1 ) goto label$039cf2f_24_6;
	r4 = 1;
	r3 = r1 - r4;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r3);
	goto label$039cf2f_24_20;
	label$039cf2f_24_6:
	r3 = r0->length;
	if( r1 >= r3 ) goto label$039cf2f_24_20;
	r5 = r0->bytes;
	r6 = r0->bytes;
	r4 = 1;
	r3 = r1 << r4;
...
vdynamic* hl_types_ArrayBytes_hl_UI16_getDyn(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	int r3, r4;
	r4 = r0->length;
	if( r1 >= r4 ) goto label$039cf2f_25_4;
	r2 = false;
	goto label$039cf2f_25_5;
	label$039cf2f_25_4:
	r2 = true;
	label$039cf2f_25_5:
	if( !r2 ) goto label$039cf2f_25_10;
	r5 = r0->bytes;
	r6 = 0;
	r7 = hl_alloc_dynamic(&$t_ui16);
	r7->v.i = r6;
	return r7;
	label$039cf2f_25_10:
	r5 = r0->bytes;
...
void hl_types_ArrayBytes_hl_UI16_setDyn(hl__types__ArrayBytes_hl_UI16 r0,int r1,vdynamic* r2) {
	...
	int r5, r8;
	r5 = r0->length;
	if( r1 >= r5 ) goto label$039cf2f_26_4;
	r4 = false;
	goto label$039cf2f_26_5;
	label$039cf2f_26_4:
	r4 = true;
	label$039cf2f_26_5:
	if( !r4 ) goto label$039cf2f_26_7;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r1);
	label$039cf2f_26_7:
	r6 = r0->bytes;
	r7 = (unsigned short)hl_dyn_casti(&r2,&$t_dyn,&$t_ui16);
	r5 = (int)r7;
	r8 = 1;
	r8 = r1 << r8;
...
int hl_types_ArrayBytes_hl_UI16_pushDyn(hl__types__ArrayBytes_hl_UI16 r0,vdynamic* r1) {
	unsigned short r3;
	int r2;
	r3 = (unsigned short)hl_dyn_casti(&r1,&$t_dyn,&$t_ui16);
...
void hl_types_ArrayBytes_hl_UI16_insertDyn(hl__types__ArrayBytes_hl_UI16 r0,int r1,vdynamic* r2) {
	unsigned short r4;
	r4 = (unsigned short)hl_dyn_casti(&r2,&$t_dyn,&$t_ui16);
...
void hl_types_ArrayBytes_hl_UI16_sortDyn(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	label$039cf2f_33_3:
	r3 = hl_alloc_closure_ptr(&$t_fun_63e5768,hl_types_ArrayBytes_hl_UI16_sortDyn__$1,r1);
	label$039cf2f_33_4:
...
void hl_types_ArrayBytes_hl_UI16___expand(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$039cf2f_34_9;
	...
	r3 = r1 + r4;
	r9 = r0->size;
	if( r9 >= r3 ) goto label$039cf2f_34_40;
	r4 = r0->size;
	r9 = 3;
	r4 = r4 * r9;
	r9 = 1;
	r4 = r4 >> r9;
	if( r4 >= r3 ) goto label$039cf2f_34_20;
	r4 = r3;
	label$039cf2f_34_20:
	r7 = r0->bytes;
	r10 = 1;
