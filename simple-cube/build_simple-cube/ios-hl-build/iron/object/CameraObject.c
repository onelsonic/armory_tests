...
void iron_object_CameraObject_buildProjection(iron__object__CameraObject r0,vdynamic* r1) {
	...
	float r6, r9, r10, r11, r12, r13, r14, r15, r16, r17, r19, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38;
	kha__arrays__Float32ArrayPrivate r3;
	double r18, r20, r21, r22, r24;
	int *r40;
	vdynamic *r39, *r41;
	int r8;
	vbyte *r7;
	...
	r3 = r4->ortho;
	if( !r3 ) goto label$25f1553_1_109;
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	...
	r7 = r3->self;
	r8 = 0;
	r6 = hl_kore_float32array_get(r7,r8);
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	...
	r7 = r3->self;
	r8 = 1;
	r9 = hl_kore_float32array_get(r7,r8);
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	...
	r7 = r3->self;
	r8 = 2;
	r10 = hl_kore_float32array_get(r7,r8);
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	...
	r7 = r3->self;
	r8 = 3;
	r11 = hl_kore_float32array_get(r7,r8);
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	...
	r8 = 1;
	r38 = (float)r8;
	iron_math_Mat4_new(r23,r17,r19,r25,r26,r27,r28,r29,r30,r31,r32,r33,r34,r35,r36,r37,r38);
	r0->P = r23;
	goto label$25f1553_1_205;
	label$25f1553_1_109:
	if( r1 ) goto label$25f1553_1_119;
	r40 = NULL;
	r8 = kha_System_windowWidth(r40);
	r18 = (double)r8;
	r40 = NULL;
	r8 = kha_System_windowHeight(r40);
	r20 = (double)r8;
	r18 = r18 / r20;
	r39 = hl_alloc_dynamic(&$t_f64);
	r39->v.d = r18;
	r1 = r39;
	label$25f1553_1_119:
	r5 = r0->data;
	...
	if( r4 == NULL ) hl_null_access();
	r41 = r4->aspect;
	if( !r41 ) goto label$25f1553_1_131;
	r5 = r0->data;
	if( r5 == NULL ) hl_null_access();
	r4 = r5->raw;
	if( r4 == NULL ) hl_null_access();
	r41 = r4->aspect;
	goto label$25f1553_1_137;
	label$25f1553_1_131:
	if( !r1 ) goto label$25f1553_1_136;
	r18 = r1 ? r1->v.d : 0;
	r6 = (float)r18;
	r41 = hl_alloc_dynamic(&$t_f32);
	r41->v.f = r6;
	goto label$25f1553_1_137;
	label$25f1553_1_136:
	r41 = NULL;
	...
	r8 = 0;
	r31 = (float)r8;
	iron_math_Mat4_new(r23,r10,r11,r12,r13,r14,r15,r16,r17,r19,r25,r26,r27,r28,r29,r30,r31);
	r0->P = r23;
	label$25f1553_1_205:
	return;
}
...
void iron_object_CameraObject_renderFrame(iron__object__CameraObject r0,vvirtual* r1) {
	iron__$RenderPath r25;
	kha__math__FastMatrix4 r22, r23;
	float r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20;
	iron__math__Mat4 r3, r21;
	double r4;
	iron__RenderPath r24;
	iron_object_CameraObject_buildMatrix(r0);
	r3 = r0->prevV;
	if( r3 ) goto label$25f1553_3_138;
	...
	r22->_33 = r5;
	label$25f1553_3_138:
	r25 = (iron__$RenderPath)$g__iron_RenderPath;
	r24 = r25->active;
	if( r24 == NULL ) hl_null_access();
	iron_RenderPath_renderFrame(r24,r1);
	r3 = r0->prevV;
	r21 = r0->V;
	if( r3 == NULL ) hl_null_access();
	r22 = r3->self;
...
void iron_object_CameraObject_buildMatrix(iron__object__CameraObject r0) {
	...
	label$25f1553_4_96:
	r14 = (iron__object__$CameraObject)$g__iron_object_CameraObject;
	r13 = r14->temp;
...
bool iron_object_CameraObject_sphereInFrustum(hl__types__ArrayObj r0,iron__object__Transform r1,double* r2,double* r3,double* r4,double* r5) {
	...
	label$25f1553_6_32:
	++r13;
	r19 = (iron__object__$CameraObject)$g__iron_object_CameraObject;
...
void iron_object_CameraObject_setCubeFace(iron__math__Mat4 r0,iron__math__Vec4 r1,int r2,bool* r3) {
	...
	r4 = *r3;
	label$25f1553_7_4:
	r6 = (iron__object__$CameraObject)$g__iron_object_CameraObject;
	r5 = r6->vcenter;
	if( r5 == NULL ) hl_null_access();
	if( r1 == NULL ) hl_null_access();
	r9 = r1->x;
...
void iron_object_CameraObject_new(iron__object__CameraObject r0,iron__data__CameraData r1) {
	...
	r30 = &$t_iron_object_FrustumPlane;
	r2 = 0;
	...
	r5 = r0->frustumPlanes;
	if( r5 == NULL ) hl_null_access();
	r31 = (iron__object__FrustumPlane)hl_alloc_obj(&$t_iron_object_FrustumPlane);
	...
	r2 = hl_types_ArrayObj_push(r5,((vdynamic*)r31));
	label$25f1553_8_125:
	r33 = (iron__$Scene)$g__iron_Scene;
	r32 = r33->active;
