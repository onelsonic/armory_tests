...
extern String $s_float1;
int String___compare(String,vdynamic*);
extern String $s_float2;
extern String $s_float3;
extern String $s_float4;
extern String $s_short2norm;
extern String $s_short4norm;
...
void iron_data_ShaderContext_compile(iron__data__ShaderContext r0,vclosure* r1) {
	String r11, r22, r23, r25, r26;
	kha__graphics4__FragmentShader r21;
	kha__graphics4__PipelineState r3;
	hl__types__ArrayObj r4, r15;
	hl_type *r6;
	kha__graphics4__TessellationControlShader r28;
	iron__data__TShaderContext r13;
	bool r12;
	kha__$Shaders r24;
	kha__graphics4__VertexShader r20;
	kha__graphics4__TessellationEvaluationShader r29;
	kha__graphics4__GeometryShader r27;
	vdynamic *r18, *r19;
	...
	label$b94d45c_1_5:
	r3 = (kha__graphics4__PipelineState)hl_alloc_obj(&$t_kha_graphics4_PipelineState);
	...
	r9 = (kha__graphics4__VertexStructure)hl_alloc_obj(&$t_kha_graphics4_VertexStructure);
	...
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r6 = &$t_kha_graphics4_VertexStructure;
	r7 = 2;
	r5 = hl_alloc_array(r6,r7);
	r10 = r0->structure;
	r7 = 0;
	...
	r12 = (bool)hl_dyn_casti(&r18,&$t_dyn,&$t_bool);
	label$b94d45c_1_184:
	r16 = r4->length;
	...
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r19 = r13->conservative_raster;
	if( !r19 ) goto label$b94d45c_1_310;
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r19 = r13->conservative_raster;
	r12 = r19 ? r19->v.b : 0;
	r3->conservativeRasterization = r12;
	label$b94d45c_1_310:
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r19 = r13->shader_from_source;
	r12 = r19 ? r19->v.b : 0;
	if( !r12 ) goto label$b94d45c_1_331;
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r11 = r13->vertex_shader;
	r20 = kha_graphics4_VertexShader_fromSource(r11);
	r3->vertexShader = r20;
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r13 = r0->raw;
	...
	r21 = kha_graphics4_FragmentShader_fromSource(r11);
	r3->fragmentShader = r21;
	iron_data_ShaderContext_finishCompile(r0,r1);
	goto label$b94d45c_1_404;
	label$b94d45c_1_331:
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r11 = r13->fragment_shader;
	r22 = (String)$s_5058f1a;
	r23 = (String)$s_b14a7b8;
	r11 = StringTools_replace(r11,r22,r23);
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r24 = (kha__$Shaders)$g__kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r11);
	r21 = (kha__graphics4__FragmentShader)hl_dyn_castp(&r18,&$t_dyn,&$t_kha_graphics4_FragmentShader);
	r3->fragmentShader = r21;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r22 = r13->vertex_shader;
	r23 = (String)$s_5058f1a;
	r25 = (String)$s_b14a7b8;
	r22 = StringTools_replace(r22,r23,r25);
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r24 = (kha__$Shaders)$g__kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r22);
	r20 = (kha__graphics4__VertexShader)hl_dyn_castp(&r18,&$t_dyn,&$t_kha_graphics4_VertexShader);
	r3->vertexShader = r20;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->geometry_shader;
	if( !r23 ) goto label$b94d45c_1_371;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->geometry_shader;
	r25 = (String)$s_5058f1a;
	r26 = (String)$s_b14a7b8;
	r23 = StringTools_replace(r23,r25,r26);
	r3 = r0->pipeState;
	if( r3 == NULL ) hl_null_access();
	r24 = (kha__$Shaders)$g__kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r23);
	r27 = (kha__graphics4__GeometryShader)hl_dyn_castp(&r18,&$t_dyn,&$t_kha_graphics4_GeometryShader);
	r3->geometryShader = r27;
	label$b94d45c_1_371:
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->tesscontrol_shader;
	if( !r23 ) goto label$b94d45c_1_387;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->tesscontrol_shader;
	r25 = (String)$s_5058f1a;
	...
	r24 = (kha__$Shaders)$g__kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r23);
	r28 = (kha__graphics4__TessellationControlShader)hl_dyn_castp(&r18,&$t_dyn,&$t_kha_graphics4_TessellationControlShader);
	r3->tessellationControlShader = r28;
	label$b94d45c_1_387:
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->tesseval_shader;
	if( !r23 ) goto label$b94d45c_1_403;
	r13 = r0->raw;
	if( r13 == NULL ) hl_null_access();
	r23 = r13->tesseval_shader;
	r25 = (String)$s_5058f1a;
	...
	r24 = (kha__$Shaders)$g__kha_Shaders;
	r18 = Reflect_field(((vdynamic*)r24),r23);
	r29 = (kha__graphics4__TessellationEvaluationShader)hl_dyn_castp(&r18,&$t_dyn,&$t_kha_graphics4_TessellationEvaluationShader);
	r3->tessellationEvaluationShader = r29;
	label$b94d45c_1_403:
	iron_data_ShaderContext_finishCompile(r0,r1);
	label$b94d45c_1_404:
	return;
...
void iron_data_ShaderContext_parseVertexStructure(iron__data__ShaderContext r0) {
	...
	r1 = (kha__graphics4__VertexStructure)hl_alloc_obj(&$t_kha_graphics4_VertexStructure);
...
void iron_data_ShaderContext_setTextureParameters(iron__data__ShaderContext r0,vvirtual* r1,int r2,iron__data__TBindTexture r3) {
	...
	if( r4 == NULL ) hl_null_access();
	r6 = r4->length;
	if( ((unsigned)r2) < ((unsigned)r6) ) goto label$b94d45c_14_6;
	r7 = NULL;
	goto label$b94d45c_14_9;
	label$b94d45c_14_6:
	r9 = r4->array;
	r8 = ((vdynamic**)(r9 + 1))[r2];
	r7 = hl_to_virtual(&$t_vrt_b840ca7,(vdynamic*)r8);
	label$b94d45c_14_9:
	if( r1 == NULL ) hl_null_access();
	if( r3 == NULL ) hl_null_access();
	r11 = r3->u_addressing;
	if( r11 ) goto label$b94d45c_14_15;
	r5 = 0;
	goto label$b94d45c_14_17;
	label$b94d45c_14_15:
	r11 = r3->u_addressing;
	r5 = iron_data_ShaderContext_getTextureAddresing(r0,r11);
	label$b94d45c_14_17:
	r11 = r3->v_addressing;
	if( r11 ) goto label$b94d45c_14_21;
	r6 = 0;
	goto label$b94d45c_14_23;
	label$b94d45c_14_21:
	r11 = r3->v_addressing;
	r6 = iron_data_ShaderContext_getTextureAddresing(r0,r11);
	label$b94d45c_14_23:
	r11 = r3->min_filter;
	if( r11 ) goto label$b94d45c_14_27;
	r12 = 1;
	goto label$b94d45c_14_29;
	label$b94d45c_14_27:
	r11 = r3->min_filter;
	r12 = iron_data_ShaderContext_getTextureFilter(r0,r11);
	label$b94d45c_14_29:
	r11 = r3->mag_filter;
	if( r11 ) goto label$b94d45c_14_33;
	r13 = 1;
	goto label$b94d45c_14_35;
	label$b94d45c_14_33:
	r11 = r3->mag_filter;
	r13 = iron_data_ShaderContext_getTextureFilter(r0,r11);
	label$b94d45c_14_35:
	r11 = r3->mipmap_filter;
	if( r11 ) goto label$b94d45c_14_39;
	r14 = 0;
	goto label$b94d45c_14_41;
	label$b94d45c_14_39:
	r11 = r3->mipmap_filter;
	...
	if( hl_vfields(r1)[3] ) ((void (*)(vdynamic*,vvirtual*,int,int,int,int,int))hl_vfields(r1)[3])(r1->value,r7,r5,r6,r12,r13,r14); else {
		...
		hl_dyn_call_obj(r1->value,&$t_fun_4ad9aaa,357382632/*setTextureParameters*/,args,NULL);
	}
	return;
}
