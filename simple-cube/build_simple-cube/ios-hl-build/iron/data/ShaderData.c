...
extern String $s_Shader_data_;
String String___add__(String,String);
extern String $s__not_found_;
extern hl_type $t_vrt_329ffa8;
extern String $s_Sources_iron_data_ShaderData_hx;
extern hl_type $t_String;
extern hl_type $t_i32;
extern String $s_iron_data_ShaderData;
...
void iron_data_ShaderData_new__$1(venum* r0,iron__data__ShaderContext r1) {
	...
	varray *r7;
	int r4, r5, r10;
	r3 = ((Enum$t_ctx_93df96f*)r0)->p4;
	if( r3 == NULL ) hl_null_access();
	r2 = r3->contexts;
	if( r2 == NULL ) hl_null_access();
	r4 = ((Enum$t_ctx_93df96f*)r0)->p3;
	r5 = r2->length;
	...
	*(int*)(r9 + r5) = r10;
	...
	r4 = *(int*)(r9 + r5);
	label$8acc9ae_1_33:
	r11 = ((Enum$t_ctx_93df96f*)r0)->p0;
	if( r11 == NULL ) hl_null_access();
	r2 = r11->contexts;
	if( r2 == NULL ) hl_null_access();
	r5 = r2->length;
	if( r4 != r5 ) goto label$8acc9ae_1_43;
	r12 = ((Enum$t_ctx_93df96f*)r0)->p1;
...
void iron_data_ShaderData_parse__$1(venum* r0,iron__data__TSceneFormat r1) {
	...
	r8 = (String)$s_iron_data_ShaderData;
...
void iron_data_ShaderData_parse(String r0,String r1,vclosure* r2,iron__data__TShaderOverride r3) {
	venum *r6;
	vclosure *r5;
	r6 = hl_alloc_enum(&$t_ctx_84ae9f9,0);
	((Enum$t_ctx_84ae9f9*)r6)->p0 = (String)r1;
	((Enum$t_ctx_84ae9f9*)r6)->p1 = (vclosure*)r2;
	((Enum$t_ctx_84ae9f9*)r6)->p2 = (iron__data__TShaderOverride)r3;
	r5 = hl_alloc_closure_ptr(&$t_fun_c45d6f8,iron_data_ShaderData_parse__$1,r6);
...
void iron_data_ShaderData_new(iron__data__ShaderData r0,iron__data__TShaderData r1,vclosure* r2,iron__data__TShaderOverride r3) {
	...
	*(int*)(r18 + r12) = r11;
	...
	r14 = (iron__data__TShaderContext)r15;
	label$8acc9ae_5_58:
	r16 = (iron__data__ShaderContext)hl_alloc_obj(&$t_iron_data_ShaderContext);
	r21 = hl_alloc_enum(&$t_ctx_93df96f,0);
	((Enum$t_ctx_93df96f*)r21)->p0 = (iron__data__TShaderData)r1;
	((Enum$t_ctx_93df96f*)r21)->p1 = (vclosure*)r2;
	((Enum$t_ctx_93df96f*)r21)->p2 = (hl__types__ArrayBytes_Int)r17;
	((Enum$t_ctx_93df96f*)r21)->p3 = (int)r12;
	((Enum$t_ctx_93df96f*)r21)->p4 = (iron__data__ShaderData)r8;
	r20 = hl_alloc_closure_ptr(&$t_fun_953fe85,iron_data_ShaderData_new__$1,r21);
