...
void kha_audio2_ogg_vorbis_VorbisTools_drawLine(hl__types__ArrayBytes_Float r0,int r1,int r2,int r3,int r4,int r5) {
	...
	varray *r9;
	r8 = (kha__audio2__ogg__vorbis__$VorbisTools)$g_84d8ab9;
	r7 = r8->integerDivideTable;
	if( r7 ) goto label$5a9200e_8_75;
	r10 = &$t_hl_types_ArrayBytes_Int;
	r11 = 0;
	...
	r11 = 31;
	r13 = NULL;
	r14 = (hl__types__ArrayBytes_Int)hl_dyn_castp(&r13,&$t_dyn,&$t_hl_types_ArrayBytes_Int);
	r15 = r7->length;
	...
	r16 = 63;
	r13 = NULL;
	r18 = (int)hl_dyn_casti(&r13,&$t_dyn,&$t_i32);
	r19 = r14->length;
