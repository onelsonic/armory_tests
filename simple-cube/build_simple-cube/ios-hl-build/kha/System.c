...
void kha_System_render(hl__types__ArrayObj r0) {
	...
	r5 = r3->length;
	if( r1 >= r5 ) goto label$f550790_3_18;
	r5 = r3->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$f550790_3_11;
	r6 = NULL;
	goto label$f550790_3_14;
	label$f550790_3_11:
	r8 = r3->array;
	r7 = ((vdynamic**)(r8 + 1))[r1];
	r6 = (vclosure*)r7;
...
void kha_System_foreground() {
	...
	if( r2 == NULL ) hl_null_access();
	r4 = r2->length;
	if( r0 >= r4 ) goto label$f550790_4_18;
	r4 = r2->length;
	if( ((unsigned)r0) < ((unsigned)r4) ) goto label$f550790_4_11;
	r5 = NULL;
...
void kha_System_dropFiles(String r0) {
	...
	if( r3 == NULL ) hl_null_access();
	r5 = r3->length;
	if( r1 >= r5 ) goto label$f550790_9_18;
	r5 = r3->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$f550790_9_11;
	r6 = NULL;
...
int kha_System_windowWidth(int* r0) {
	kha__Window r3;
	int r1, r2;
	if( r0 ) goto label$f550790_11_3;
	r1 = 0;
	goto label$f550790_11_4;
	label$f550790_11_3:
	r1 = *r0;
	label$f550790_11_4:
...
int kha_System_windowHeight(int* r0) {
	...
	if( r3 == NULL ) hl_null_access();
	r4 = r3->length;
	if( ((unsigned)r1) < ((unsigned)r4) ) goto label$f550790_12_10;
	r5 = NULL;
	goto label$f550790_12_13;
	label$f550790_12_10:
	r7 = r3->array;
	r6 = ((vdynamic**)(r7 + 1))[r1];
	r5 = (kha__Window)r6;
