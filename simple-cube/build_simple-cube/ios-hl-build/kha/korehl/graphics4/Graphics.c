...
void kha_korehl_graphics4_Graphics_setTexture(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__Image r2) {
	kha__korehl__graphics4__TextureUnit r5;
	vbyte *r4, *r6;
	if( r2 ) goto label$cb1cbbc_17_2;
	return;
	label$cb1cbbc_17_2:
	if( r2 == NULL ) hl_null_access();
	r4 = r2->_texture;
	if( !r4 ) goto label$cb1cbbc_17_11;
	r5 = (kha__korehl__graphics4__TextureUnit)hl_dyn_castp(&r1,&$t_vrt_b840ca7,&$t_kha_korehl_graphics4_TextureUnit);
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
	r6 = r2->_texture;
	hl_kore_graphics_set_texture(r4,r6);
	goto label$cb1cbbc_17_16;
	label$cb1cbbc_17_11:
	r5 = (kha__korehl__graphics4__TextureUnit)hl_dyn_castp(&r1,&$t_vrt_b840ca7,&$t_kha_korehl_graphics4_TextureUnit);
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
...
void kha_korehl_graphics4_Graphics_drawIndexedVertices(kha__korehl__graphics4__Graphics r0,int* r1,int* r2) {
	int r3, r4, r6;
	if( r1 ) goto label$cb1cbbc_30_3;
	r3 = 0;
	goto label$cb1cbbc_30_4;
	label$cb1cbbc_30_3:
	r3 = *r1;
	label$cb1cbbc_30_4:
	if( r2 ) goto label$cb1cbbc_30_7;
	r4 = -1;
	goto label$cb1cbbc_30_8;
	label$cb1cbbc_30_7:
	r4 = *r2;
	label$cb1cbbc_30_8:
	r6 = 0;
	if( r4 >= r6 ) goto label$cb1cbbc_30_12;
	hl_kore_graphics_draw_all_indexed_vertices();
	goto label$cb1cbbc_30_13;
	label$cb1cbbc_30_12:
...
void kha_korehl_graphics4_Graphics_drawIndexedVerticesInstanced(kha__korehl__graphics4__Graphics r0,int r1,int* r2,int* r3) {
	int r4, r5, r7;
	if( r2 ) goto label$cb1cbbc_31_3;
	r4 = 0;
	goto label$cb1cbbc_31_4;
	label$cb1cbbc_31_3:
	r4 = *r2;
	label$cb1cbbc_31_4:
	if( r3 ) goto label$cb1cbbc_31_7;
	r5 = -1;
	goto label$cb1cbbc_31_8;
	label$cb1cbbc_31_7:
	r5 = *r3;
	label$cb1cbbc_31_8:
	r7 = 0;
	if( r5 >= r7 ) goto label$cb1cbbc_31_12;
	hl_kore_graphics_draw_all_indexed_vertices_instanced(r1);
	goto label$cb1cbbc_31_13;
	label$cb1cbbc_31_12:
...
void kha_korehl_graphics4_Graphics_renderToTexture(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	...
	int r3, r8, r9;
	if( !r1 ) goto label$cb1cbbc_32_116;
	if( r1 == NULL ) hl_null_access();
	r3 = r1->length;
	r5 = r0->target;
	r6 = (kha__Image)hl_dyn_castp(&r5,&$t_vrt_d9847e3,&$t_kha_Image);
	if( r6 == NULL ) hl_null_access();
	r4 = r6->_renderTarget;
	r9 = 0;
	if( r9 >= r3 ) goto label$cb1cbbc_32_21;
	r8 = 0;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_14;
	r5 = NULL;
	goto label$cb1cbbc_32_17;
	label$cb1cbbc_32_14:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	label$cb1cbbc_32_17:
	r6 = (kha__Image)hl_dyn_castp(&r5,&$t_vrt_d9847e3,&$t_kha_Image);
	if( r6 == NULL ) hl_null_access();
	r7 = r6->_renderTarget;
	goto label$cb1cbbc_32_22;
	label$cb1cbbc_32_21:
	r7 = NULL;
	label$cb1cbbc_32_22:
	r9 = 1;
	if( r9 >= r3 ) goto label$cb1cbbc_32_36;
	r8 = 1;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_29;
	r5 = NULL;
	goto label$cb1cbbc_32_32;
	label$cb1cbbc_32_29:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	...
	goto label$cb1cbbc_32_37;
	label$cb1cbbc_32_36:
	r12 = NULL;
	label$cb1cbbc_32_37:
	r9 = 2;
	if( r9 >= r3 ) goto label$cb1cbbc_32_51;
	r8 = 2;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_44;
	r5 = NULL;
	goto label$cb1cbbc_32_47;
	label$cb1cbbc_32_44:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	...
	goto label$cb1cbbc_32_52;
	label$cb1cbbc_32_51:
	r13 = NULL;
	label$cb1cbbc_32_52:
	r9 = 3;
	if( r9 >= r3 ) goto label$cb1cbbc_32_66;
	r8 = 3;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_59;
	r5 = NULL;
	goto label$cb1cbbc_32_62;
	label$cb1cbbc_32_59:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	...
	goto label$cb1cbbc_32_67;
	label$cb1cbbc_32_66:
	r14 = NULL;
	label$cb1cbbc_32_67:
	r9 = 4;
	if( r9 >= r3 ) goto label$cb1cbbc_32_81;
	r8 = 4;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_74;
	r5 = NULL;
	goto label$cb1cbbc_32_77;
	label$cb1cbbc_32_74:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	...
	goto label$cb1cbbc_32_82;
	label$cb1cbbc_32_81:
	r15 = NULL;
	label$cb1cbbc_32_82:
	r9 = 5;
	if( r9 >= r3 ) goto label$cb1cbbc_32_96;
	r8 = 5;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_89;
	r5 = NULL;
	goto label$cb1cbbc_32_92;
	label$cb1cbbc_32_89:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	...
	goto label$cb1cbbc_32_97;
	label$cb1cbbc_32_96:
	r16 = NULL;
	label$cb1cbbc_32_97:
	r9 = 6;
	if( r9 >= r3 ) goto label$cb1cbbc_32_111;
	r8 = 6;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_32_104;
	r5 = NULL;
	goto label$cb1cbbc_32_107;
	label$cb1cbbc_32_104:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r10);
	label$cb1cbbc_32_107:
	r6 = (kha__Image)hl_dyn_castp(&r5,&$t_vrt_d9847e3,&$t_kha_Image);
	if( r6 == NULL ) hl_null_access();
	r17 = r6->_renderTarget;
	goto label$cb1cbbc_32_112;
	label$cb1cbbc_32_111:
	r17 = NULL;
	label$cb1cbbc_32_112:
	r9 = 1;
	r8 = r3 + r9;
	hl_kore_graphics_render_to_textures(r4,r7,r12,r13,r14,r15,r16,r17,r8);
	goto label$cb1cbbc_32_121;
	label$cb1cbbc_32_116:
	r5 = r0->target;
	r6 = (kha__Image)hl_dyn_castp(&r5,&$t_vrt_d9847e3,&$t_kha_Image);
	if( r6 == NULL ) hl_null_access();
	r4 = r6->_renderTarget;
	hl_kore_graphics_render_to_texture(r4);
	label$cb1cbbc_32_121:
	return;
}
...
void kha_korehl_graphics4_Graphics_begin(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	vvirtual *r3;
	r3 = r0->target;
	if( r3 ) goto label$cb1cbbc_33_4;
	hl_kore_graphics_restore_render_target();
	goto label$cb1cbbc_33_5;
	label$cb1cbbc_33_4:
...
void kha_korehl_graphics4_Graphics_beginFace(kha__korehl__graphics4__Graphics r0,int r1) {
	...
	vbyte *r3;
	r4 = r0->target;
	r5 = (kha__graphics4__CubeMap)hl_dyn_castp(&r4,&$t_vrt_d9847e3,&$t_kha_graphics4_CubeMap);
	if( r5 == NULL ) hl_null_access();
	r3 = r5->_renderTarget;
