...
void kha_SystemImpl_init__$1(vdynamic* r0,vvirtual* r1) {
	...
	r2 = hl_vfields(r1)[0] ? (*(String*)(hl_vfields(r1)[0])) : (String)hl_dyn_getp(r1->value,-63073762/*className*/,&$t_String);
	r3 = (String)$s_853ae90;
	r2 = String___add__(r2,r3);
	r4 = hl_vfields(r1)[3] ? (*(int*)(hl_vfields(r1)[3])) : (int)hl_dyn_geti(r1->value,371360620/*lineNumber*/,&$t_i32);
	r5 = &r4;
	r6 = hl_itos(r4,r5);
...
void kha_SystemImpl_init(kha__SystemOptions r0,vclosure* r1) {
	...
	kha__input__Pen r36;
	vclosure *r2, *r31, *r32, *r40, *r41, *r42, *r43, *r44, *r45, *r46, *r47, *r48, *r50, *r51, *r52, *r53, *r54, *r55, *r56, *r57, *r58, *r59, *r60, *r61, *r62, *r63, *r64;
	int *r8, *r11, *r33;
	kha__input__Keyboard r34;
	kha__WindowOptions r17;
	vbyte *r6, *r9;
	int r4, r10, r12, r13, r16, r18, r49;
	static vclosure cl$0 = { &$t_fun_439b121, kha_SystemImpl_init__$1, 0 };
	static vclosure cl$1 = { &$t_fun_8249ca6, kha_audio2_Audio__callCallback, 0 };
	static vclosure cl$2 = { &$t_fun_6ededf8, kha_audio2_Audio__readSample, 0 };
	static vclosure cl$3 = { &$t_fun_8249ca6, kha_SystemImpl_keyDown, 0 };
	static vclosure cl$4 = { &$t_fun_8249ca6, kha_SystemImpl_keyUp, 0 };
	static vclosure cl$5 = { &$t_fun_8249ca6, kha_SystemImpl_keyPress, 0 };
	static vclosure cl$6 = { &$t_fun_b6373da, kha_SystemImpl_mouseDown, 0 };
	static vclosure cl$7 = { &$t_fun_b6373da, kha_SystemImpl_mouseUp, 0 };
	static vclosure cl$8 = { &$t_fun_8ffe477, kha_SystemImpl_mouseMove, 0 };
	static vclosure cl$9 = { &$t_fun_efca04c, kha_SystemImpl_mouseWheel, 0 };
	static vclosure cl$10 = { &$t_fun_c33199c, kha_SystemImpl_penDown, 0 };
	static vclosure cl$11 = { &$t_fun_c33199c, kha_SystemImpl_penUp, 0 };
	static vclosure cl$12 = { &$t_fun_c33199c, kha_SystemImpl_penMove, 0 };
	static vclosure cl$13 = { &$t_fun_06455fc, kha_SystemImpl_gamepad1Axis, 0 };
	static vclosure cl$14 = { &$t_fun_06455fc, kha_SystemImpl_gamepad1Button, 0 };
	static vclosure cl$15 = { &$t_fun_06455fc, kha_SystemImpl_gamepad2Axis, 0 };
	static vclosure cl$16 = { &$t_fun_06455fc, kha_SystemImpl_gamepad2Button, 0 };
	static vclosure cl$17 = { &$t_fun_06455fc, kha_SystemImpl_gamepad3Axis, 0 };
	static vclosure cl$18 = { &$t_fun_06455fc, kha_SystemImpl_gamepad3Button, 0 };
	static vclosure cl$19 = { &$t_fun_06455fc, kha_SystemImpl_gamepad4Axis, 0 };
	static vclosure cl$20 = { &$t_fun_06455fc, kha_SystemImpl_gamepad4Button, 0 };
	static vclosure cl$21 = { &$t_fun_1e336b5, kha_SystemImpl_touchStart, 0 };
	static vclosure cl$22 = { &$t_fun_1e336b5, kha_SystemImpl_touchEnd, 0 };
	static vclosure cl$23 = { &$t_fun_1e336b5, kha_SystemImpl_touchMove, 0 };
	static vclosure cl$24 = { &$t_fun_7764b95, kha_input_Sensor__accelerometerChanged, 0 };
	static vclosure cl$25 = { &$t_fun_7764b95, kha_input_Sensor__gyroscopeChanged, 0 };
	static vclosure cl$26 = { &$t_fun_7b48b4f, kha_SystemImpl_foreground, 0 };
	static vclosure cl$27 = { &$t_fun_7b48b4f, kha_SystemImpl_resume, 0 };
	static vclosure cl$28 = { &$t_fun_7b48b4f, kha_SystemImpl_pause, 0 };
	static vclosure cl$29 = { &$t_fun_7b48b4f, kha_SystemImpl_background, 0 };
	static vclosure cl$30 = { &$t_fun_7b48b4f, kha_SystemImpl_shutdown, 0 };
	static vclosure cl$31 = { &$t_fun_6047e2e, kha_SystemImpl_dropFiles, 0 };
	static vclosure cl$32 = { &$t_fun_c8ddb77, kha_SystemImpl_copy, 0 };
	static vclosure cl$33 = { &$t_fun_c8ddb77, kha_SystemImpl_cut, 0 };
	static vclosure cl$34 = { &$t_fun_6047e2e, kha_SystemImpl_paste, 0 };
	r2 = &cl$0;
	r3 = (haxe__$Log)$g__haxe_Log;
	r3->trace = r2;
	r4 = 0;
	...
	r19 = (kha__Window)hl_alloc_obj(&$t_kha_Window);
	r10 = 0;
	kha_Window_new(r19,r10);
	kha_Scheduler_init();
	kha_Shaders_init();
	r20 = (kha__korehl__graphics4__Graphics)hl_alloc_obj(&$t_kha_korehl_graphics4_Graphics);
	r21 = NULL;
	kha_korehl_graphics4_Graphics_new(r20,r21);
	r22 = (kha__Framebuffer)hl_alloc_obj(&$t_kha_Framebuffer);
	r10 = 0;
	r23 = NULL;
	r24 = NULL;
	...
	r25 = hl_to_virtual(&$t_vrt_bc41d05,(vdynamic*)r20);
	r20->$_f1 = r25;
	label$fc555d2_2_45:
	kha_Framebuffer_new(r22,r10,r23,r24,r25);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->framebuffer = r22;
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r22 = r26->framebuffer;
	if( r22 == NULL ) hl_null_access();
	r27 = (kha__graphics2__Graphics1)hl_alloc_obj(&$t_kha_graphics2_Graphics1);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r28 = r26->framebuffer;
	...
	r21 = hl_to_virtual(&$t_vrt_d9847e3,(vdynamic*)r28);
	r28->$_f6 = r21;
	label$fc555d2_2_61:
	...
	r23 = hl_to_virtual(&$t_vrt_b840ca7,(vdynamic*)r27);
	r27->$_f1 = r23;
	label$fc555d2_2_69:
	r29 = (kha__korehl__graphics4__Graphics2)hl_alloc_obj(&$t_kha_korehl_graphics4_Graphics2);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r28 = r26->framebuffer;
	...
	r30 = (kha__audio2__$Audio)$g__kha_audio2_Audio;
	r10 = r30->samplesPerSecond;
	r11 = &r10;
	r31 = &cl$1;
	r32 = &cl$2;
	hl_kore_init_audio(r31,r32,r11);
	r34 = (kha__input__Keyboard)hl_alloc_obj(&$t_kha_input_Keyboard);
	kha_input_Keyboard_new(r34);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->keyboard = r34;
	r35 = (kha__input__MouseImpl)hl_alloc_obj(&$t_kha_input_MouseImpl);
	kha_input_MouseImpl_new(r35);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->mouse = ((kha__input__Mouse)r35);
	r36 = (kha__input__Pen)hl_alloc_obj(&$t_kha_input_Pen);
	kha_input_Pen_new(r36);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->pen = r36;
	r37 = (kha__input__Gamepad)hl_alloc_obj(&$t_kha_input_Gamepad);
	r12 = 0;
	r33 = &r12;
	r7 = NULL;
	...
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->gamepad4 = r37;
	r38 = (kha__input__Surface)hl_alloc_obj(&$t_kha_input_Surface);
	kha_input_Surface_new(r38);
	r26 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r26->surface = r38;
	r39 = (hl__types__ArrayObj)hl_alloc_obj(&$t_hl_types_ArrayObj);
	...
	r64 = &cl$33;
	r62 = &cl$34;
	hl_kore_register_copycutpaste(r63,r64,r62);
	r65 = NULL;
...
void kha_SystemImpl_frame() {
	...
	r3 = &$t_kha_Framebuffer;
	r4 = 1;
	r2 = hl_alloc_array(r3,r4);
	r6 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r5 = r6->framebuffer;
	r4 = 0;
...
kha__input__Mouse kha_SystemImpl_getMouse(int r0) {
	...
	return r2;
	label$fc555d2_7_4:
	r3 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r2 = r3->mouse;
	return r2;
}
...
void kha_SystemImpl_lockMouse(int* r0) {
	...
	varray *r10;
	int r1, r4, r7;
	if( r0 ) goto label$fc555d2_9_3;
	r1 = 0;
	goto label$fc555d2_9_4;
	label$fc555d2_9_3:
	r1 = *r0;
	label$fc555d2_9_4:
	r0 = NULL;
	r3 = kha_SystemImpl_isMouseLocked(r0);
	if( r3 ) goto label$fc555d2_9_26;
	...
	r7 = r5->length;
	if( r4 >= r7 ) goto label$fc555d2_9_26;
	r7 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r7) ) goto label$fc555d2_9_19;
	r8 = NULL;
	goto label$fc555d2_9_22;
	label$fc555d2_9_19:
	r10 = r5->array;
...
void kha_SystemImpl_notifyOfMouseLockChange(vclosure* r0,vclosure* r1) {
	...
	if( !r3 ) goto label$fc555d2_13_9;
	if( !r0 ) goto label$fc555d2_13_9;
	r8 = (kha__$SystemImpl)$g__kha_SystemImpl;
...
void kha_SystemImpl_removeFromMouseLockChange(vclosure* r0,vclosure* r1) {
	...
	r7 = (kha__$SystemImpl)$g__kha_SystemImpl;
...
void kha_SystemImpl_mouseWheel(int r0,int r1) {
	...
	kha__$SystemImpl r4;
	r4 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r3 = r4->mouse;
...
void kha_SystemImpl_touchStart(int r0,int r1,int r2) {
	...
	kha__$SystemImpl r5;
	r5 = (kha__$SystemImpl)$g__kha_SystemImpl;
	r4 = r5->surface;
...
String kha_SystemImpl_copy() {
	String r2;
	kha__$System r1;
	vclosure *r0;
	r1 = (kha__$System)$g__kha_System;
	r0 = r1->copyListener;
	if( !r0 ) goto label$fc555d2_44_8;
	r1 = (kha__$System)$g__kha_System;
	r0 = r1->copyListener;
	if( r0 == NULL ) hl_null_access();
...
String kha_SystemImpl_cut() {
	String r2;
	kha__$System r1;
	vclosure *r0;
	r1 = (kha__$System)$g__kha_System;
	r0 = r1->cutListener;
	if( !r0 ) goto label$fc555d2_45_8;
	r1 = (kha__$System)$g__kha_System;
	r0 = r1->cutListener;
	if( r0 == NULL ) hl_null_access();
	r2 = r0->hasValue ? ((String (*)(vdynamic*))r0->fun)((vdynamic*)r0->value) : ((String (*)(void))r0->fun)();
...
void kha_SystemImpl_paste(String r0) {
	kha__$System r3;
	vclosure *r2;
	r3 = (kha__$System)$g__kha_System;
	r2 = r3->pasteListener;
	if( !r2 ) goto label$fc555d2_46_7;
	r3 = (kha__$System)$g__kha_System;
	r2 = r3->pasteListener;
	if( r2 == NULL ) hl_null_access();
	r2->hasValue ? ((void (*)(vdynamic*,String))r2->fun)((vdynamic*)r2->value,r0) : ((void (*)(String))r2->fun)(r0);
	label$fc555d2_46_7:
	return;
}
