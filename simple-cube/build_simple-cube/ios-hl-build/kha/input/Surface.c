...
kha__input__Surface kha_input_Surface_get(int* r0) {
	...
	return r3;
	label$8b69b0c_1_8:
	r4 = (kha__input__$Surface)$g__kha_input_Surface;
	r3 = r4->instance;
	return r3;
}
...
void kha_input_Surface_new(kha__input__Surface r0) {
	...
	hl_types_ArrayObj_new(r1);
	r0->moveListeners = r1;
	r3 = (kha__input__$Surface)$g__kha_input_Surface;
	r3->instance = r0;
	return;
}
...
void kha_input_Surface_sendTouchStartEvent(kha__input__Surface r0,int r1,int r2,int r3) {
	...
	if( r6 == NULL ) hl_null_access();
	r7 = r6->length;
	if( r4 >= r7 ) goto label$8b69b0c_5_17;
	r7 = r6->length;
	if( ((unsigned)r4) < ((unsigned)r7) ) goto label$8b69b0c_5_10;
	r8 = NULL;
	goto label$8b69b0c_5_13;
	label$8b69b0c_5_10:
	r10 = r6->array;
