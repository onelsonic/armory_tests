...
kha__input__Gamepad kha_input_Gamepad_get(int* r0) {
	...
	r1 = *r0;
	label$818aeb4_1_4:
	r4 = (kha__input__$Gamepad)$g__kha_input_Gamepad;
	r3 = r4->instances;
...
void kha_input_Gamepad_notifyOnConnect(vclosure* r0,vclosure* r1) {
	...
	r5 = (kha__input__$Gamepad)$g__kha_input_Gamepad;
...
void kha_input_Gamepad_new(kha__input__Gamepad r0,int* r1,String r2) {
	...
	label$818aeb4_6_6:
	r0->index = r3;
	r5 = (hl__types__ArrayObj)hl_alloc_obj(&$t_hl_types_ArrayObj);
	hl_types_ArrayObj_new(r5);
	r0->axisListeners = r5;
	r5 = (hl__types__ArrayObj)hl_alloc_obj(&$t_hl_types_ArrayObj);
	hl_types_ArrayObj_new(r5);
	r0->buttonListeners = r5;
	r7 = (kha__input__$Gamepad)$g__kha_input_Gamepad;
	r5 = r7->instances;
	if( r5 == NULL ) hl_null_access();
	r8 = r5->length;
...
void kha_input_Gamepad_sendAxisEvent(kha__input__Gamepad r0,int r1,double r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r6 = r5->length;
	if( r3 >= r6 ) goto label$818aeb4_8_17;
	r6 = r5->length;
	if( ((unsigned)r3) < ((unsigned)r6) ) goto label$818aeb4_8_10;
	r7 = NULL;
	goto label$818aeb4_8_13;
	label$818aeb4_8_10:
	r9 = r5->array;
	r8 = ((vdynamic**)(r9 + 1))[r3];
	r7 = (vclosure*)r8;
...
void kha_input_Gamepad_sendConnectEvent(int r0) {
	...
	varray *r7;
	int r3, r4, r10;
	r2 = (kha__input__$Gamepad)$g__kha_input_Gamepad;
	r1 = r2->instances;
	if( r1 == NULL ) hl_null_access();
	r4 = r1->length;
	if( ((unsigned)r0) < ((unsigned)r4) ) goto label$818aeb4_10_7;
	r5 = NULL;
	goto label$818aeb4_10_10;
	label$818aeb4_10_7:
	r7 = r1->array;
	r6 = ((vdynamic**)(r7 + 1))[r0];
	r5 = (kha__input__Gamepad)r6;
	...
	if( r1 == NULL ) hl_null_access();
	r10 = r1->length;
	if( r3 >= r10 ) goto label$818aeb4_10_31;
	r10 = r1->length;
	if( ((unsigned)r3) < ((unsigned)r10) ) goto label$818aeb4_10_24;
	r11 = NULL;
	goto label$818aeb4_10_27;
	label$818aeb4_10_24:
	r7 = r1->array;
	r6 = ((vdynamic**)(r7 + 1))[r3];
	r11 = (vclosure*)r6;
