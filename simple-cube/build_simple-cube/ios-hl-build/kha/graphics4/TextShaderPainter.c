...
void kha_graphics4_TextShaderPainter_initBuffers(kha__graphics4__TextShaderPainter r0) {
	...
	if( r2 ) goto label$cb73abe_3_110;
	...
	label$cb73abe_3_33:
	r14 = 1000;
	if( r4 >= r14 ) goto label$cb73abe_3_106;
	r6 = r4;
	++r4;
	r15 = 4;
	r14 = r6 * r15;
...
void kha_graphics4_TextShaderPainter_drawBuffer(kha__graphics4__TextShaderPainter r0) {
	...
	if( hl_vfields(r7)[9] ) ((void (*)(vdynamic*,vvirtual*,kha__math__FastMatrix4))hl_vfields(r7)[9])(r7->value,r11,r13); else {
		void *args[] = {r11,r13};
	...
	r5 = 2;
	r15 = r0->bilinear;
	if( !r15 ) goto label$cb73abe_4_51;
	r14 = 1;
	goto label$cb73abe_4_52;
	label$cb73abe_4_51:
	r14 = 0;
	label$cb73abe_4_52:
	r15 = r0->bilinear;
	if( !r15 ) goto label$cb73abe_4_56;
	r16 = 1;
	goto label$cb73abe_4_57;
	label$cb73abe_4_56:
	r16 = 0;
	label$cb73abe_4_57:
	r17 = 0;
...
void kha_graphics4_TextShaderPainter_end(kha__graphics4__TextShaderPainter r0) {
	...
	r2 = r3->bufferIndex;
	r4 = 0;
	if( r4 >= r2 ) goto label$cb73abe_5_5;
...
void kha_graphics4_TextShaderPainter_new(kha__graphics4__TextShaderPainter r0,vvirtual* r1) {
	kha__graphics4__$TextShaderPainter r5;
	bool r2;
	kha__graphics4__PipelineCache r3;
	int r4;
	r2 = false;
	...
	r0->g = r1;
	r4 = 0;
	r5 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r5->bufferIndex = r4;
	kha_graphics4_TextShaderPainter_initShaders();
	r5 = (kha__graphics4__$TextShaderPainter)$g__kha_graphics4_TextShaderPainter;
	r3 = r5->standardTextPipeline;
	r0->myPipeline = r3;
