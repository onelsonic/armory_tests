static const float3 _196[3] = { float3(0.800000011920928955078125f, 0.699999988079071044921875f, 0.800000011920928955078125f), float3(0.800000011920928955078125f, 0.699999988079071044921875f, 0.800000011920928955078125f), float3(0.800000011920928955078125f, 0.699999988079071044921875f, 0.800000011920928955078125f) };
static const float _209[3] = { 0.0f, 1.0f, 1.0f };
...
void frag_main()
{
    ...
    float3 ColorRamp_Color_res = lerp(_196[ColorRamp_i], _196[ColorRamp_i + 1], ((ColorRamp_fac - _209[ColorRamp_i]) * (1.0f / (_209[ColorRamp_i + 1] - _209[ColorRamp_i]))).xxx);
    float3 basecol = ColorRamp_Color_res;
