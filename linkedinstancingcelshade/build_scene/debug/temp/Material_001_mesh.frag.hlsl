...
void frag_main()
{
    ...
    float3 basecol = float3(0.80000007152557373046875f, 0.2688041031360626220703125f, 0.008307459764182567596435546875f);
    ...
    float3 _221 = pow(fragColor.xyz, 0.4545454680919647216796875f.xxx);
    fragColor = float4(_221.x, _221.y, _221.z, fragColor.w);
}
