...
void frag_main()
{
    ...
    float3 basecol = float3(0.80000007152557373046875f, 0.0f, 0.02039285190403461456298828125f);
    ...
    float3 _220 = pow(fragColor.xyz, 0.4545454680919647216796875f.xxx);
    fragColor = float4(_220.x, _220.y, _220.z, fragColor.w);
}
